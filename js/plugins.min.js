!(function (b, a) {
  ...
  function h(a) {
    ...
    var b = f(a),
      ...
      d = b.overflowX,
      e = b.overflowY;
    return /(auto|scroll|overlay)/.test(c + e + d) ? a : h(g(a));
  }
  function i(a) {
    return a && a.referenceNode ? a.referenceNode : a;
  }
  function j(a) {
    return 11 === a ? ag : 10 === a ? ah : ag || ah;
  }
  function k(b) {
    if (!b) return document.documentElement;
    for (
      var d = j(10) ? document.body : null, a = b.offsetParent || null;
      a === d && b.nextElementSibling;
  ...
  function l(a) {
    var b = a.nodeName;
    return "BODY" !== b && ("HTML" === b || k(a.firstElementChild) === a);
  }
  function m(a) {
    return null === a.parentNode ? a : m(a.parentNode);
  }
  function n(a, b) {
    if (!a || !a.nodeType || !b || !b.nodeType) return document.documentElement;
    var e = a.compareDocumentPosition(b) & Node.DOCUMENT_POSITION_FOLLOWING,
      f = e ? a : b,
      g = e ? b : a,
      d = document.createRange();
    d.setStart(f, 0), d.setEnd(g, 0);
    var c = d.commonAncestorContainer;
    if ((a !== c && b !== c) || f.contains(g)) return l(c) ? c : k(c);
    var h = m(a);
    return h.host ? n(h.host, b) : n(a, m(b).host);
  }
  function o(a) {
    var d =
        1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "top",
      b = "top" === d ? "scrollTop" : "scrollLeft",
      c = a.nodeName;
    if ("BODY" === c || "HTML" === c) {
  ...
  function s(b) {
    var c = b.body,
      a = b.documentElement,
      d = j(10) && getComputedStyle(a);
    return { height: r("Height", c, a, d), width: r("Width", c, a, d) };
  }
  function t(a) {
    return al({}, a, { right: a.left + a.width, bottom: a.top + a.height });
  }
  function u(b) {
    var a = {};
    try {
      if (j(10)) {
        ...
        var g = o(b, "top"),
          h = o(b, "left");
        (a.top += g), (a.left += h), (a.bottom += g), (a.right += h);
      } else a = b.getBoundingClientRect();
    } catch (n) {}
    var c = {
        left: a.left,
        top: a.top,
      ...
      i = "HTML" === b.nodeName ? s(b.ownerDocument) : {},
      l = i.width || b.clientWidth || c.width,
      m = i.height || b.clientHeight || c.height,
      d = b.offsetWidth - l,
      e = b.offsetHeight - m;
    if (d || e) {
      var k = f(b);
      (d -= q(k, "x")), (e -= q(k, "y")), (c.width -= d), (c.height -= e);
    }
    return t(c);
  }
  function v(n, b) {
    var o = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
      ...
      k = parseFloat(e.borderLeftWidth);
    o && r && ((c.top = ad(c.top, 0)), (c.left = ad(c.left, 0)));
    var a = t({
      top: d.top - c.top - i,
      left: d.left - c.left - k,
      width: d.width,
      height: d.height,
    });
    if (((a.marginTop = 0), (a.marginLeft = 0), !q && r)) {
      var l = parseFloat(e.marginTop),
        m = parseFloat(e.marginLeft);
      (a.top -= i - l),
        (a.bottom -= i - l),
        (a.left -= k - m),
        (a.right -= k - m),
    ...
    return (
      (q && !o ? b.contains(g) : b === g && "BODY" !== g.nodeName) &&
        (a = p(a, b)),
      a
    );
  }
  function w(c) {
    var d = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
      ...
      b = v(c, a),
      e = ad(a.clientWidth, window.innerWidth || 0),
      f = ad(a.clientHeight, window.innerHeight || 0),
      g = d ? 0 : o(a),
      h = d ? 0 : o(a, "left"),
      i = {
        top: g - b.top + b.marginTop,
        left: h - b.left + b.marginLeft,
        width: e,
        height: f,
      };
    return t(i);
  ...
  function x(a) {
    ...
    if ("fixed" === f(a, "position")) return !0;
    var c = g(a);
    return !!c && x(c);
  }
  function y(b) {
    if (!b || !b.parentElement || j()) return document.documentElement;
    for (var a = b.parentElement; a && "none" === f(a, "transform"); )
      a = a.parentElement;
    return a || document.documentElement;
  }
  function z(d, l, b, e) {
    var j = 4 < arguments.length && void 0 !== arguments[4] && arguments[4],
      a = { top: 0, left: 0 },
      k = j ? y(d) : n(d, i(l));
    if ("viewport" === e) a = w(k, j);
    else {
      "scrollParent" === e
        ? "BODY" === (m = h(g(l))).nodeName &&
          (m = d.ownerDocument.documentElement)
        : (m = "window" === e ? d.ownerDocument.documentElement : e);
      var m,
        c = v(m, k, j);
      if ("HTML" !== m.nodeName || x(k)) a = c;
      else {
        var o = s(d.ownerDocument),
          p = o.height,
          q = o.width;
    ...
    var f = "number" == typeof (b = b || 0);
    return (
      (a.left += f ? b : b.left || 0),
      (a.top += f ? b : b.top || 0),
      (a.right -= f ? b : b.right || 0),
      (a.bottom -= f ? b : b.bottom || 0),
      a
    );
  }
  function A(a) {
  ...
  function B(c, b, g, h, i) {
    var j = 5 < arguments.length && void 0 !== arguments[5] ? arguments[5] : 0;
    if (-1 === c.indexOf("auto")) return c;
    var a = z(g, h, j, i),
      k = {
        top: { width: a.width, height: b.top - a.top },
        right: { width: a.right - b.right, height: a.height },
        bottom: { width: a.width, height: a.bottom - b.bottom },
        left: { width: b.left - a.left, height: a.height },
      },
      d = Object.keys(k)
        .map(function (a) {
          return al({ key: a }, k[a], { area: A(k[a]) });
        })
        .sort(function (a, b) {
  ...
  function I(a, c, b) {
    return (
      (void 0 === b ? a : a.slice(0, H(a, "name", b))).forEach(function (a) {
        a.function &&
          console.warn("`modifier.function` is deprecated, use `modifier.fn`!");
        var b = a.function || a.fn;
        a.enabled &&
          e(b) &&
          ((c.offsets.popper = t(c.offsets.popper)),
          (c.offsets.reference = t(c.offsets.reference)),
          (c = b(c, a)));
      }),
      c
    );
  ...
  function J() {
    if (!this.state.isDestroyed) {
      ...
      (a.offsets.reference = C(
        ...
        (a.offsets.popper = F(this.popper, a.offsets.reference, a.placement)),
        (a.offsets.popper.position = this.options.positionFixed
          ? "fixed"
          : "absolute"),
        (a = I(this.modifiers, a)),
  ...
  function L(a) {
    for (
      ...
      var d = c[b],
        e = d ? "" + d + f : a;
      if (void 0 !== document.body.style[e]) return e;
    }
    return null;
  }
  function M() {
  ...
  function O(a, c, d, e) {
    var f = "BODY" === a.nodeName,
      b = f ? a.ownerDocument.defaultView : a;
    b.addEventListener(c, d, { passive: !0 }),
      f || O(h(b.parentNode), c, d, e),
      e.push(b);
  }
  function P(b, e, a, d) {
    (a.updateBound = d),
      N(b).addEventListener("resize", a.updateBound, { passive: !0 });
    var c = h(b);
    return (
      O(c, "scroll", a.updateBound, a.scrollParents),
      (a.scrollElement = c),
      (a.eventsEnabled = !0),
      a
    );
  ...
  function R(b, a) {
    return (
      N(b).removeEventListener("resize", a.updateBound),
  ...
  function V(b, a) {
    Object.keys(a).forEach(function (c) {
      !1 === a[c] ? b.removeAttribute(c) : b.setAttribute(c, a[c]);
    });
  }
  function W(c, d) {
    var e = c.offsets,
      ...
      g = b(l.width),
      h = b(a.width),
      m = -1 !== ["left", "right"].indexOf(c.placement),
      i = -1 !== c.placement.indexOf("-"),
      j = d ? (m || i || g % 2 == h % 2 ? b : ac) : f,
      k = d ? b : f;
    return {
      left: j(1 == g % 2 && 1 == h % 2 && !i && d ? a.left - 1 : a.left),
      top: k(a.top),
      bottom: k(a.bottom),
      right: j(a.right),
    };
  ...
  function X(a, d, e) {
    var f = G(a, function (a) {
        return a.name === d;
      }),
      b =
        !!f &&
        a.some(function (a) {
          return a.name === e && a.enabled && a.order < f.order;
        });
    if (!b) {
      var c = "`" + d + "`";
      console.warn(
  ...
  function Z(c) {
    var d = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
      a = an.indexOf(c),
      b = an.slice(a + 1).concat(an.slice(0, a));
  ...
  function aa(e, h, i, f) {
    var g = [0, 0],
      j = -1 !== ["right", "left"].indexOf(f),
      a = e.split(/(\+|\-)/).map(function (a) {
        return a.trim();
      }),
      b = a.indexOf(
        G(a, function (a) {
    ...
    var c = /\s*,\s*|\s+/,
      d =
        -1 === b
          ? [a]
          : [
              a.slice(0, b).concat([a[b].split(c)[0]]),
              [a[b].split(c)[1]].concat(a.slice(b + 1)),
            ];
    return (
      (d = d.map(function (a, b) {
        var c = (1 === b ? !j : j) ? "height" : "width",
          d = !1;
        return a
          .reduce(function (a, b) {
            return "" === a[a.length - 1] && -1 !== ["+", "-"].indexOf(b)
              ? ((a[a.length - 1] = b), (d = !0), a)
              : d
              ? ((a[a.length - 1] += b), (d = !1), a)
              : a.concat(b);
          }, [])
          .map(function (a) {
            return _(a, c, h, i);
  ...
  function d(d, g) {
    var b,
      ...
      c = h.split("-")[0];
    return (
      (b = T(+e) ? [+e, 0] : aa(e, a, i, c)),
      "left" === c
        ? ((a.top += b[0]), (a.left -= b[1]))
        : "right" === c
        ? ((a.top += b[0]), (a.left += b[1]))
        : "top" === c
        ? ((a.left += b[0]), (a.top -= b[1]))
        : "bottom" === c && ((a.left += b[0]), (a.top += b[1])),
      (d.popper = a),
      d
    );
  }
  var ab = Math.min,
    ...
    ae = (function () {
      for (var c = ["Edge", "Trident", "Firefox"], b = 0; b < c.length; b += 1)
        if (a && 0 <= navigator.userAgent.indexOf(c[b])) return 1;
      return 0;
    })(),
    af =
      a && window.Promise
    ...
    ag = a && !!(window.MSInputMethodContext && document.documentMode),
    ah = a && /MSIE 10/.test(navigator.userAgent),
    ai = function (a, b) {
      if (!(a instanceof b))
    ...
    aj = (function () {
      function a(d, c) {
        for (var a, b = 0; b < c.length; b++)
          ((a = c[b]).enumerable = a.enumerable || !1),
            (a.configurable = !0),
    ...
    am = a && /Firefox/i.test(navigator.userAgent),
    c = [
      "auto-start",
      "auto",
      "auto-end",
    ...
    b = (function () {
      function a(b, c) {
        ...
        ai(this, a),
          ...
          (this.update = af(this.update.bind(this))),
          (this.options = al({}, a.Defaults, d)),
          (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
          (this.reference = b && b.jquery ? b[0] : b),
          (this.popper = c && c.jquery ? c[0] : c),
          (this.options.modifiers = {}),
          Object.keys(al({}, a.Defaults.modifiers, d.modifiers)).forEach(
            function (b) {
              g.options.modifiers[b] = al(
                {},
                a.Defaults.modifiers[b] || {},
                d.modifiers ? d.modifiers[b] : {}
              );
            }
          ),
          (this.modifiers = Object.keys(this.options.modifiers)
            .map(function (a) {
              return al({ name: a }, g.options.modifiers[a]);
            })
            .sort(function (a, b) {
  ...
  return (
    (b.Utils = ("undefined" == typeof window ? global : window).PopperUtils),
    (b.placements = c),
    (b.Defaults = {
      placement: "bottom",
      positionFixed: !1,
      ...
      modifiers: {
          ...
          fn: function (a) {
            ...
            if (e) {
              var f = a.offsets,
                c = f.reference,
                g = f.popper,
                h = -1 !== ["bottom", "top"].indexOf(j),
                b = h ? "left" : "top",
                i = h ? "width" : "height",
                k = {
                  start: ak({}, b, c[b]),
                  end: ak({}, b, c[b] + c[i] - g[i]),
                };
              a.offsets.popper = al({}, g, k[e]);
            }
            return a;
          },
        },
        offset: { order: 200, enabled: !0, fn: d, offset: 0 },
        preventOverflow: {
          order: 300,
          enabled: !0,
          fn: function (a, c) {
            var d = c.boundariesElement || k(a.instance.popper);
            a.instance.reference === d && (d = k(d));
            var e = L("transform"),
              b = a.instance.popper.style,
              f = b.top,
              g = b.left,
              h = b[e];
            (b.top = ""), (b.left = ""), (b[e] = "");
            ...
            (b.top = f), (b.left = g), (b[e] = h), (c.boundaries = i);
            var j = c.priority,
              l = a.offsets.popper,
              m = {
                primary: function (a) {
        ...
        keepTogether: {
          ...
          fn: function (a) {
            var h = a.offsets,
              ...
              j = f ? "width" : "height";
            return (
              e[g] < d(c[b]) && (a.offsets.popper[b] = d(c[b]) - e[j]),
              e[b] > d(c[g]) && (a.offsets.popper[b] = d(c[g])),
              a
            );
          },
        },
        arrow: {
          ...
          enabled: !0,
          fn: function (a, p) {
            if (!X(a.instance.modifiers, "arrow", "keepTogether")) return a;
            var j,
              c = p.element;
            if ("string" == typeof c) {
              if (!(c = a.instance.popper.querySelector(c))) return a;
            } else if (!a.instance.popper.contains(c))
              return (
                console.warn(
            ...
            var q = a.placement.split("-")[0],
              n = a.offsets,
              g = n.popper,
              d = n.reference,
              h = -1 !== ["left", "right"].indexOf(q),
              k = h ? "height" : "width",
              l = h ? "Top" : "Left",
              b = l.toLowerCase(),
              r = h ? "left" : "top",
              i = h ? "bottom" : "right",
              e = D(c)[k];
            d[i] - e < g[b] && (a.offsets.popper[b] -= g[b] - (d[i] - e)),
              d[b] + e > g[i] && (a.offsets.popper[b] += d[b] + e - g[i]),
              (a.offsets.popper = t(a.offsets.popper));
            var s = d[b] + d[k] / 2 - e / 2,
              o = f(a.instance.popper),
              u = parseFloat(o["margin" + l]),
              v = parseFloat(o["border" + l + "Width"]),
              m = s - a.offsets.popper[b] - u - v;
            return (
              (m = ad(ab(g[k] - e, m), 0)),
              (a.arrowElement = c),
              (a.offsets.arrow = (ak((j = {}), b, $(m)), ak(j, r, ""), j)),
              a
            );
          },
          element: "[x-arrow]",
          ...
          fn: function (a, c) {
            ...
            return (
              b.forEach(function (t, p) {
                if (d !== t || b.length === p + 1) return a;
                e = E((d = a.placement.split("-")[0]));
                var i = a.offsets.popper,
                  k = a.offsets.reference,
                  h = ac,
                  q =
                    ("left" === d && h(i.right) > h(k.left)) ||
                    ("right" === d && h(i.left) < h(k.right)) ||
                    ("top" === d && h(i.bottom) > h(k.top)) ||
                    ("bottom" === d && h(i.top) < h(k.bottom)),
                  l = h(i.left) < h(f.left),
                  m = h(i.right) > h(f.right),
                  n = h(i.top) < h(f.top),
                  o = h(i.bottom) > h(f.bottom),
                  r =
                    ("left" === d && l) ||
                    ("right" === d && m) ||
                    ("top" === d && n) ||
                    ("bottom" === d && o),
                  j = -1 !== ["top", "bottom"].indexOf(d),
                  u =
                    !!c.flipVariations &&
                    ((j && "start" === g && l) ||
                      (j && "end" === g && m) ||
                ...
                (q || r || s) &&
                  ...
                  (a.offsets.popper = al(
                    {},
                    a.offsets.popper,
                    F(a.instance.popper, a.offsets.reference, a.placement)
                  )),
        ...
        inner: {
          ...
          fn: function (a) {
            var d = a.placement,
              ...
              h = -1 === ["top", "left"].indexOf(b);
            return (
              (c[f ? "left" : "top"] =
                g[b] - (h ? c[f ? "width" : "height"] : 0)),
              (a.placement = E(d)),
              (a.offsets.popper = t(c)),
              a
            );
          },
        },
        hide: {
          ...
          enabled: !0,
          fn: function (a) {
            if (!X(a.instance.modifiers, "hide", "preventOverflow")) return a;
            var b = a.offsets.reference,
              c = G(a.instance.modifiers, function (a) {
        ...
        computeStyle: {
          ...
          fn: function (a, g) {
            var n = g.x,
              o = g.y,
              p = a.offsets.popper,
              h = G(a.instance.modifiers, function (a) {
            ...
            var i,
              j,
              q = void 0 === h ? g.gpuAcceleration : h,
              d = k(a.instance.popper),
              l = u(d),
              b = { position: p.position },
              c = W(a, 2 > window.devicePixelRatio || !am),
            ...
            if (
              ((j =
                "bottom" == e
                  ? "HTML" === d.nodeName
                    ? -d.clientHeight + c.bottom
                    : -l.height + c.bottom
                  : c.top),
              (i =
                "right" == f
                  ? "HTML" === d.nodeName
                    ? -d.clientWidth + c.right
                    : -l.width + c.right
                  : c.left),
              q && m)
            )
              (b[m] = "translate3d(" + i + "px, " + j + "px, 0)"),
                (b[e] = 0),
                (b[f] = 0),
              ...
              var r = "bottom" == e ? -1 : 1,
                s = "right" == f ? -1 : 1;
              (b[e] = j * r), (b[f] = i * s), (b.willChange = e + ", " + f);
            }
            var t = { "x-placement": a.placement };
            return (
              (a.attributes = al({}, t, a.attributes)),
              (a.styles = al({}, b, a.styles)),
              (a.arrowStyles = al({}, a.offsets.arrow, a.arrowStyles)),
              a
            );
          },
          gpuAcceleration: !0,
        ...
        applyStyle: {
          ...
          fn: function (a) {
            return (
              U(a.instance.popper, a.styles),
              V(a.instance.popper, a.attributes),
              a.arrowElement &&
                Object.keys(a.arrowStyles).length &&
                U(a.arrowElement, a.arrowStyles),
              a
            );
          },
          onLoad: function (c, b, a, g, d) {
            var e = C(d, b, c, a.positionFixed),
              f = B(
                a.placement,
                e,
                b,
            ...
            return (
              b.setAttribute("x-placement", f),
              U(b, { position: a.positionFixed ? "fixed" : "absolute" }),
              a
            );
          },
  ...
  (function (a, b) {
    ...
    function D(a, b, c) {
      return b && C(a.prototype, b), c && C(a, c), a;
    }
    function w() {
      return (w =
        Object.assign ||
    ...
    function z(b) {
      var c = this,
        d = !1;
      return (
        a.default(this).one(n.TRANSITION_END, function () {
          d = !0;
        }),
        setTimeout(function () {
          d || n.triggerTransitionEnd(c);
        }, b),
        this
      );
    }
    var n = {
      ...
      typeCheckConfig: function (g, h, c) {
        for (var a in c)
    ...
    n.jQueryDetection(),
      (a.default.fn.emulateTransitionEnd = z),
      (a.default.event.special[n.TRANSITION_END] = {
    ...
    var f = "alert",
      ...
      e = (function () {
        ...
        return (
          ...
          (b._getRootElement = function (c) {
            var d = n.getSelectorFromElement(c),
              b = !1;
            return (
              d && (b = document.querySelector(d)),
              b || (b = a.default(c).closest(".alert")[0]),
              b
            );
          }),
          (b._triggerCloseEvent = function (c) {
            var b = a.default.Event("close.bs.alert");
            return a.default(c).trigger(b), b;
          }),
          (b._removeElement = function (b) {
            var d = this;
            if (
              (a.default(b).removeClass("show"), a.default(b).hasClass("fade"))
            ) {
              var c = n.getTransitionDurationFromElement(b);
              a.default(b)
                .one(n.TRANSITION_END, function (a) {
                  return d._destroyElement(b, a);
                })
                .emulateTransitionEnd(c);
            } else this._destroyElement(b);
          }),
          (b._destroyElement = function (b) {
          ...
          (c._jQueryInterface = function (b) {
            return this.each(function () {
              var e = a.default(this),
                d = e.data("bs.alert");
              d || ((d = new c(this)), e.data("bs.alert", d)),
                "close" === b && d[b](this);
            });
          }),
    ...
    a
      ...
      (a.default.fn[f] = e._jQueryInterface),
      (a.default.fn[f].Constructor = e),
      (a.default.fn[f].noConflict = function () {
        return (a.default.fn[f] = E), e._jQueryInterface;
      });
    var F = a.default.fn.button,
      o = (function () {
        function b(a) {
        ...
        return (
          (c.toggle = function () {
            ...
            if (e) {
              var b = this._element.querySelector('input:not([type="hidden"])');
              if (b) {
                if ("radio" === b.type) {
                  if (b.checked && this._element.classList.contains("active"))
                    c = !1;
                  else {
                    var f = e.querySelector(".active");
          ...
          (b._jQueryInterface = function (c, d) {
            return this.each(function () {
              var f = a.default(this),
                e = f.data("bs.button");
              e || ((e = new b(this)), f.data("bs.button", e)),
    ...
    a
      ...
      .on("click.bs.button.data-api", '[data-toggle^="button"]', function (c) {
        var b = c.target,
          e = b;
        if (
          (a.default(b).hasClass("btn") ||
            (b = a.default(b).closest(".btn")[0]),
          !b || b.hasAttribute("disabled") || b.classList.contains("disabled"))
        )
          c.preventDefault();
        else {
          var d = b.querySelector('input:not([type="hidden"])');
          if (
            d &&
            (d.hasAttribute("disabled") || d.classList.contains("disabled"))
          )
            return void c.preventDefault();
          ("INPUT" !== e.tagName && "LABEL" === b.tagName) ||
      ...
      (a.default.fn.button = o._jQueryInterface),
      (a.default.fn.button.Constructor = o),
      (a.default.fn.button.noConflict = function () {
        return (a.default.fn.button = F), o._jQueryInterface;
      });
    var g = "carousel",
      _ = ".bs.carousel",
      G = a.default.fn[g],
        ...
        return (
          ...
          (b.pause = function (a) {
            a || (this._isPaused = !0),
              ...
              ) && (n.triggerTransitionEnd(this._element), this.cycle(!0)),
          ...
          (b._getConfig = function (a) {
            return (a = w({}, H, a)), n.typeCheckConfig(g, a, I), a;
          }),
          ...
          (b._addEventListeners = function () {
            ...
            this._config.keyboard &&
              a.default(this._element).on("keydown.bs.carousel", function (a) {
                return b._keydown(a);
              }),
          ...
          (b._addTouchEventListeners = function () {
            ...
            if (this._touchSupported) {
              var c = function (a) {
                  b._pointerEvent &&
                  J[a.originalEvent.pointerType.toUpperCase()]
              ...
              a
                ...
                .on("dragstart.bs.carousel", function (a) {
                  return a.preventDefault();
                }),
                this._pointerEvent
                  ? (a
                      .default(this._element)
                      .on("pointerdown.bs.carousel", function (a) {
                        return c(a);
                      }),
                    a
                      .default(this._element)
                      .on("pointerup.bs.carousel", function (a) {
                        return d(a);
                      }),
                    this._element.classList.add("pointer-event"))
                  : (a
                      .default(this._element)
                      .on("touchstart.bs.carousel", function (a) {
                        return c(a);
                      }),
                    a
                      .default(this._element)
                    ...
                    a
                      .default(this._element)
                      .on("touchend.bs.carousel", function (a) {
                        return d(a);
                      }));
            }
          }),
          ...
          (b._getItemByDirection = function (a, c) {
            ...
            if (((f && 0 === b) || (e && b === g)) && !this._config.wrap)
              return c;
          ...
          (b._triggerSlideEvent = function (b, d) {
            var e = this._getItemIndex(b),
              f = this._getItemIndex(
            ...
            return a.default(this._element).trigger(c), c;
          }),
          (b._setActiveIndicatorElement = function (c) {
            if (this._indicatorsElement) {
              var d = [].slice.call(
                this._indicatorsElement.querySelectorAll(".active")
              );
              a.default(d).removeClass("active");
              var b = this._indicatorsElement.children[this._getItemIndex(c)];
          ...
          (b._updateInterval = function () {
            var a =
              ...
              this._element.querySelector(".active.carousel-item");
            if (a) {
              var b = parseInt(a.getAttribute("data-interval"), 10);
              b
          ...
          (b._slide = function (g, i) {
            var d,
              f,
              e,
              o = this,
              c = this._element.querySelector(".active.carousel-item"),
              j = this._getItemIndex(c),
              b = i || (c && this._getItemByDirection(g, c)),
            ...
            if (
              ("next" === g
                ...
                : ((d = "carousel-item-right"),
                  ...
                  (e = "right")),
              b && a.default(b).hasClass("active"))
            )
              this._isSliding = !1;
            else if (
              !this._triggerSlideEvent(b, e).isDefaultPrevented() &&
              c &&
              b
            ) {
              (this._isSliding = !0),
              ...
              var l = a.default.Event("slid.bs.carousel", {
                relatedTarget: b,
                direction: e,
                from: j,
                to: k,
              });
              if (a.default(this._element).hasClass("slide")) {
                a.default(b).addClass(f),
                  n.reflow(b),
                  a.default(c).addClass(d),
                  a.default(b).addClass(d);
                var m = n.getTransitionDurationFromElement(c);
                a.default(c)
                  .one(n.TRANSITION_END, function () {
                    a
                      ...
                      .removeClass(d + " " + f)
                      .addClass("active"),
                      a.default(c).removeClass("active " + f + " " + d),
                      (o._isSliding = !1),
                      setTimeout(function () {
                        return a.default(o._element).trigger(l);
                      }, 0);
                  })
                  .emulateTransitionEnd(m);
              } else
                a.default(c).removeClass("active"),
                  a.default(b).addClass("active"),
                  (this._isSliding = !1),
          ...
          (c._jQueryInterface = function (b) {
            return this.each(function () {
              var d = a.default(this).data("bs.carousel"),
                e = w({}, H, a.default(this).data());
              "object" == typeof b && (e = w({}, e, b));
          ...
          (c._dataApiClickHandler = function (g) {
            ...
            if (e) {
              var b = a.default(e)[0];
              if (b && a.default(b).hasClass("carousel")) {
                var f = w({}, a.default(b).data(), a.default(this).data()),
                  d = this.getAttribute("data-slide-to");
                d && (f.interval = !1),
                  c._jQueryInterface.call(a.default(b), f),
                  d && a.default(b).data("bs.carousel").to(d),
                  g.preventDefault();
              }
            }
          }),
    ...
    a
      ...
      a.default(window).on("load.bs.carousel.data-api", function () {
        for (
          ...
          var d = a.default(c[b]);
          h._jQueryInterface.call(d, d.data());
        }
      }),
      (a.default.fn[g] = h._jQueryInterface),
      (a.default.fn[g].Constructor = h),
      (a.default.fn[g].noConflict = function () {
        return (a.default.fn[g] = G), h._jQueryInterface;
      });
    var i = "collapse",
      K = a.default.fn[i],
      L = { toggle: !0, parent: "" },
      ...
      p = (function () {
        function c(a, f) {
          ...
          for (
            ...
            var e = d[b],
              c = n.getSelectorFromElement(e),
              h = [].slice
                .call(document.querySelectorAll(c))
                .filter(function (b) {
                  return b === a;
                });
            null !== c &&
              h.length > 0 &&
              ((this._selector = c), this._triggerArray.push(e));
          }
        ...
        return (
          (b.toggle = function () {
            a.default(this._element).hasClass("show")
              ? this.hide()
              : this.show();
          }),
          (b.show = function () {
                  ...
                  (b = [].slice
                    ...
                    .filter(function (a) {
                      return "string" == typeof i._config.parent
                        ? a.getAttribute("data-parent") === i._config.parent
                        : a.classList.contains("collapse");
                    })).length &&
                (b = null),
              !(
                b &&
                (e = a.default(b).not(this._selector).data("bs.collapse")) &&
                e._isTransitioning
              ))
            ) {
              var f = a.default.Event("show.bs.collapse");
              if (
                (a.default(this._element).trigger(f), !f.isDefaultPrevented())
              ) {
                b &&
                  (c._jQueryInterface.call(
                    a.default(b).not(this._selector),
                    "hide"
                  ),
                  e || a.default(b).data("bs.collapse", null));
                ...
                a
                  ...
                  .one(n.TRANSITION_END, function () {
                    a
                      ...
                      a.default(i._element).trigger("shown.bs.collapse");
                  })
          ...
          (b.hide = function () {
            ...
            if (
              ...
              var d = a.default.Event("hide.bs.collapse");
              if (
                (a.default(this._element).trigger(d), !d.isDefaultPrevented())
              ) {
                ...
                if (e > 0)
                  for (var c = 0; c < e; c++) {
                    var f = this._triggerArray[c],
                      g = n.getSelectorFromElement(f);
                    null !== g &&
                      (a
                        .default([].slice.call(document.querySelectorAll(g)))
                        .hasClass("show") ||
                        a
                          .default(f)
                          .addClass("collapsed")
                ...
                var h = n.getTransitionDurationFromElement(this._element);
          ...
          (b._getConfig = function (a) {
            return (
              ((a = w({}, L, a)).toggle = Boolean(a.toggle)),
              n.typeCheckConfig(i, a, M),
              a
            );
          }),
          (b._getDimension = function () {
            return a.default(this._element).hasClass("width")
              ? "width"
              : "height";
          }),
          (b._getParent = function () {
            var b,
              f = this;
            n.isElement(this._config.parent)
              ? ((b = this._config.parent),
                void 0 !== this._config.parent.jquery &&
                  (b = this._config.parent[0]))
              : (b = document.querySelector(this._config.parent));
            var d =
                '[data-toggle="collapse"][data-parent="' +
                this._config.parent +
                '"]',
              e = [].slice.call(b.querySelectorAll(d));
            return (
              a.default(e).each(function (b, a) {
                f._addAriaAndCollapsedClass(c._getTargetFromElement(a), [a]);
              }),
              b
            );
          }),
          (b._addAriaAndCollapsedClass = function (d, b) {
          ...
          (c._getTargetFromElement = function (b) {
            var a = n.getSelectorFromElement(b);
          ...
          (c._jQueryInterface = function (b) {
            return this.each(function () {
              var e = a.default(this),
                ...
                f = w({}, L, e.data(), "object" == typeof b && b ? b : {});
              if (
                (!d &&
                  f.toggle &&
                  "string" == typeof b &&
                  /show|hide/.test(b) &&
                  (f.toggle = !1),
                d || ((d = new c(this, f)), e.data("bs.collapse", d)),
                "string" == typeof b)
              ) {
                if (void 0 === d[b])
    ...
    a
      ...
      .on(
        ...
        function (b) {
          ...
          var e = a.default(this),
            c = n.getSelectorFromElement(this),
            d = [].slice.call(document.querySelectorAll(c));
          a.default(d).each(function () {
            var b = a.default(this),
              c = b.data("bs.collapse") ? "toggle" : e.data();
            p._jQueryInterface.call(b, c);
          });
        }
      ),
      (a.default.fn[i] = p._jQueryInterface),
      (a.default.fn[i].Constructor = p),
      (a.default.fn[i].noConflict = function () {
        return (a.default.fn[i] = K), p._jQueryInterface;
      });
    var j = "dropdown",
      N = a.default.fn[j],
        ...
        return (
          (b.toggle = function () {
            if (
              ...
              !a.default(this._element).hasClass("disabled")
            ) {
          ...
          (b.show = function (e) {
            if (
              ...
              !(
                this._element.disabled ||
                a.default(this._element).hasClass("disabled") ||
                a.default(this._menu).hasClass("show")
              ))
            ) {
              var f = { relatedTarget: this._element },
                g = a.default.Event("show.bs.dropdown", f),
                b = c._getParentFromElement(this._element);
              if ((a.default(b).trigger(g), !g.isDefaultPrevented())) {
                if (!this._inNavbar && e) {
                  if (void 0 === B.default)
                    throw new TypeError(
                  ...
                  "parent" === this._config.reference
                    ...
                    "scrollParent" !== this._config.boundary &&
                      a.default(b).addClass("position-static"),
                    (this._popper = new B.default(
                      d,
                      this._menu,
                ...
                "ontouchstart" in document.documentElement &&
                  0 === a.default(b).closest(".navbar-nav").length &&
                  a
                  ...
                  a
                    .default(b)
                    .toggleClass("show")
                    .trigger(a.default.Event("shown.bs.dropdown", f));
              }
            }
          }),
          (b.hide = function () {
            if (
              ...
              var b = { relatedTarget: this._element },
                d = a.default.Event("hide.bs.dropdown", b),
                e = c._getParentFromElement(this._element);
              a.default(e).trigger(d),
                d.isDefaultPrevented() ||
                  ...
                  a
                    .default(e)
                    .toggleClass("show")
                    .trigger(a.default.Event("hidden.bs.dropdown", b)));
            }
          }),
          (b.dispose = function () {
          ...
          (b._getConfig = function (b) {
            return (
              ...
              n.typeCheckConfig(j, b, this.constructor.DefaultType),
              b
            );
          }),
          ...
          (b._getPlacement = function () {
            ...
            return (
              c.hasClass("dropup")
                ? (b = a.default(this._menu).hasClass("dropdown-menu-right")
                    ? "top-end"
                    : "top-start")
                ...
                : c.hasClass("dropleft")
                ? (b = "left-start")
                : a.default(this._menu).hasClass("dropdown-menu-right") &&
                  (b = "bottom-end"),
              b
            );
          }),
          ...
          (b._getPopperConfig = function () {
            ...
            return (
              ...
              w({}, a, this._config.popperConfig)
            );
          }),
          (c._jQueryInterface = function (b) {
            return this.each(function () {
              var d = a.default(this).data("bs.dropdown");
              if (
                (d ||
                  ((d = new c(this, "object" == typeof b ? b : null)),
                  a.default(this).data("bs.dropdown", d)),
                "string" == typeof b)
              ) {
                if (void 0 === d[b])
                  throw new TypeError('No method named "' + b + '"');
          ...
          (c._clearMenus = function (b) {
            if (!b || (3 !== b.which && ("keyup" !== b.type || 9 === b.which)))
              for (
                ...
                var f = c._getParentFromElement(e[d]),
                  g = a.default(e[d]).data("bs.dropdown"),
                  h = { relatedTarget: e[d] };
                if ((b && "click" === b.type && (h.clickEvent = b), g)) {
                  var k = g._menu;
                  if (
                    a.default(f).hasClass("show") &&
                    !(
                      b &&
                      (("click" === b.type &&
                        /input|textarea/i.test(b.target.tagName)) ||
                        ("keyup" === b.type && 9 === b.which)) &&
                      a.default.contains(f, b.target)
                    )
                  ) {
                    var i = a.default.Event("hide.bs.dropdown", h);
                    a.default(f).trigger(i),
                      i.isDefaultPrevented() ||
                        ...
                        a
                          .default(f)
                          .removeClass("show")
                          .trigger(a.default.Event("hidden.bs.dropdown", h)));
                  }
                }
              }
          }),
                ...
                ? 32 === b.which ||
                  (27 !== b.which &&
                    ((40 !== b.which && 38 !== b.which) ||
                      a.default(b.target).closest(".dropdown-menu").length))
                : !O.test(b.which)) &&
              !this.disabled &&
              !a.default(this).hasClass("disabled")
            ) {
              var f = c._getParentFromElement(this),
              ...
              if (g || 27 !== b.which) {
                if (
                  ...
                  return (
                    27 === b.which &&
                      a
                        .default(f.querySelector('[data-toggle="dropdown"]'))
                        .trigger("focus"),
    ...
    a
      ...
      .on(
        ...
        function (b) {
          b.preventDefault(),
            b.stopPropagation(),
            c._jQueryInterface.call(a.default(this), "toggle");
        }
      )
      .on("click.bs.dropdown.data-api", ".dropdown form", function (a) {
        a.stopPropagation();
      }),
      (a.default.fn[j] = c._jQueryInterface),
      (a.default.fn[j].Constructor = c),
      (a.default.fn[j].noConflict = function () {
        return (a.default.fn[j] = N), c._jQueryInterface;
      });
    var R = a.default.fn.modal,
        ...
        return (
          ...
          (b.show = function (c) {
            ...
            if (!this._isShown && !this._isTransitioning) {
              a.default(this._element).hasClass("fade") &&
                (this._isTransitioning = !0);
              var b = a.default.Event("show.bs.modal", { relatedTarget: c });
                ...
                this._isShown ||
                  ...
                  a
                    ...
                    .on("mousedown.dismiss.bs.modal", function () {
                      a.default(d._element).one(
                        "mouseup.dismiss.bs.modal",
                        function (b) {
                          a.default(b.target).is(d._element) &&
                            (d._ignoreBackdropClick = !0);
                        }
                      );
                    }),
          ...
          (b.hide = function (b) {
            var f = this;
            if (
              (b && b.preventDefault(), this._isShown && !this._isTransitioning)
            ) {
              var c = a.default.Event("hide.bs.modal");
              if (
                (a.default(this._element).trigger(c),
                this._isShown && !c.isDefaultPrevented())
              ) {
                this._isShown = !1;
                var d = a.default(this._element).hasClass("fade");
                if (
                  ...
                  var e = n.getTransitionDurationFromElement(this._element);
                  a.default(this._element)
                    .one(n.TRANSITION_END, function (a) {
          ...
          (b._getConfig = function (a) {
            return (a = w({}, S, a)), n.typeCheckConfig("modal", a, T), a;
          }),
          (b._triggerBackdropTransition = function () {
            var e = this,
              b = a.default.Event("hidePrevented.bs.modal");
            if (
              (a.default(this._element).trigger(b), !b.isDefaultPrevented())
            ) {
              var c =
              ...
              var d = n.getTransitionDurationFromElement(this._dialog);
              a.default(this._element).off(n.TRANSITION_END),
                a
                  .default(this._element)
                  .one(n.TRANSITION_END, function () {
          ...
          (b._showElement = function (e) {
            var g = this,
              b = a.default(this._element).hasClass("fade"),
              c = this._dialog
            ...
            (this._element.parentNode &&
              ...
              a.default(this._dialog).hasClass("modal-dialog-scrollable") && c
                ? (c.scrollTop = 0)
                : (this._element.scrollTop = 0),
              b && n.reflow(this._element),
              a.default(this._element).addClass("show"),
              this._config.focus && this._enforceFocus();
            var h = a.default.Event("shown.bs.modal", { relatedTarget: e }),
              d = function () {
                g._config.focus && g._element.focus(),
                  (g._isTransitioning = !1),
                  a.default(g._element).trigger(h);
              };
            if (b) {
              var f = n.getTransitionDurationFromElement(this._dialog);
              a.default(this._dialog)
                .one(n.TRANSITION_END, d)
          ...
          (b._enforceFocus = function () {
            ...
            a.default(document)
              ...
              .on("focusin.bs.modal", function (c) {
                document !== c.target &&
                  b._element !== c.target &&
                  0 === a.default(b._element).has(c.target).length &&
                  b._element.focus();
              });
          }),
          (b._setEscapeEvent = function () {
            ...
            this._isShown
              ? a
                  .default(this._element)
                  .on("keydown.dismiss.bs.modal", function (a) {
                    b._config.keyboard && 27 === a.which
              ...
              : this._isShown ||
                a.default(this._element).off("keydown.dismiss.bs.modal");
          }),
          (b._setResizeEvent = function () {
            var b = this;
            this._isShown
              ? a.default(window).on("resize.bs.modal", function (a) {
          ...
          (b._removeBackdrop = function () {
            this._backdrop &&
              (a.default(this._backdrop).remove(), (this._backdrop = null));
          }),
          (b._showBackdrop = function (b) {
            var g = this,
              c = a.default(this._element).hasClass("fade") ? "fade" : "";
            if (this._isShown && this._config.backdrop) {
              if (
                ((this._backdrop = document.createElement("div")),
                (this._backdrop.className = "modal-backdrop"),
                c && this._backdrop.classList.add(c),
                a.default(this._backdrop).appendTo(document.body),
                a
                  .default(this._element)
                  .on("click.dismiss.bs.modal", function (a) {
                ...
                c && n.reflow(this._backdrop),
                a.default(this._backdrop).addClass("show"),
                !b)
              )
                return;
              if (!c) return void b();
              var e = n.getTransitionDurationFromElement(this._backdrop);
              a.default(this._backdrop)
                .one(n.TRANSITION_END, b)
                .emulateTransitionEnd(e);
            } else if (!this._isShown && this._backdrop) {
              a.default(this._backdrop).removeClass("show");
              var d = function () {
                g._removeBackdrop(), b && b();
              };
              if (a.default(this._element).hasClass("fade")) {
                var f = n.getTransitionDurationFromElement(this._backdrop);
                a.default(this._backdrop)
                  .one(n.TRANSITION_END, d)
                  .emulateTransitionEnd(f);
              } else d();
          ...
          (b._setScrollbar = function () {
            ...
            if (this._isBodyOverflowing) {
              ...
              a.default(b).each(function (e, b) {
                var c = b.style.paddingRight,
                  d = a.default(b).css("padding-right");
                a.default(b)
                  .data("padding-right", c)
                  .css(
                    "padding-right",
                    parseFloat(d) + f._scrollbarWidth + "px"
                  );
              }),
                a.default(c).each(function (e, b) {
                  var c = b.style.marginRight,
                    d = a.default(b).css("margin-right");
                  a.default(b)
                    .data("margin-right", c)
                    .css(
                      "margin-right",
              ...
              var d = document.body.style.paddingRight,
                e = a.default(document.body).css("padding-right");
          ...
          (b._resetScrollbar = function () {
            ...
            a.default(c).each(function (d, b) {
              ...
              void 0 !== c &&
                a.default(b).css("margin-right", c).removeData("margin-right");
            });
            var d = a.default(document.body).data("padding-right");
          ...
          (c._jQueryInterface = function (b, d) {
            return this.each(function () {
              var e = a.default(this).data("bs.modal"),
                f = w(
                  {},
                  S,
                  a.default(this).data(),
              ...
              if (
                (e ||
                  ((e = new c(this, f)), a.default(this).data("bs.modal", e)),
                "string" == typeof b)
              ) {
                if (void 0 === e[b])
                  throw new TypeError('No method named "' + b + '"');
                e[b](d);
              } else f.show && e.show(d);
            });
          }),
          D(c, null, [
            {
    ...
    a
      .default(document)
      .on("click.bs.modal.data-api", '[data-toggle="modal"]', function (d) {
        var b,
          f = this,
          c = n.getSelectorFromElement(this);
        c && (b = document.querySelector(c));
        var e = a.default(b).data("bs.modal")
          ? "toggle"
          : w({}, a.default(b).data(), a.default(this).data());
        ("A" !== this.tagName && "AREA" !== this.tagName) || d.preventDefault();
        var g = a.default(b).one("show.bs.modal", function (b) {
          b.isDefaultPrevented() ||
            g.one("hidden.bs.modal", function () {
              a.default(f).is(":visible") && f.focus();
            });
        });
        q._jQueryInterface.call(a.default(b), e, this);
      }),
      (a.default.fn.modal = q._jQueryInterface),
      (a.default.fn.modal.Constructor = q),
      (a.default.fn.modal.noConflict = function () {
        return (a.default.fn.modal = R), q._jQueryInterface;
      });
    var U = [
        "background",
        "cite",
      ...
      for (
        var d = new window.DOMParser().parseFromString(a, "text/html"),
          ...
          g = function (b, g) {
            ...
            if (-1 === i.indexOf(a.nodeName.toLowerCase()))
              return a.parentNode.removeChild(a), "continue";
            var d = [].slice.call(a.attributes),
              h = [].concat(e["*"] || [], e[c] || []);
            d.forEach(function (b) {
              (function (a, d) {
                ...
                if (-1 !== d.indexOf(b))
                  return (
                    -1 === U.indexOf(b) ||
                    Boolean(a.nodeValue.match(V) || a.nodeValue.match(W))
                  );
                for (
    ...
    var k = "tooltip",
      ...
      aa = ["sanitize", "whiteList", "sanitizeFn"],
      ab = {
        animation: "boolean",
        template: "string",
      ...
      d = (function () {
        ...
        return (
          ...
          (b.show = function () {
            ...
            var c = a.default.Event(this.constructor.Event.SHOW);
            if (this.isWithContent() && this._isEnabled) {
              a.default(this.element).trigger(c);
              var d = n.findShadowRoot(this.element),
                h = a.default.contains(
                  null !== d ? d : this.element.ownerDocument.documentElement,
                  this.element
                );
              if (c.isDefaultPrevented() || !h) return;
              var b = this.getTipElement(),
                e = n.getUID(this.constructor.NAME);
              b.setAttribute("id", e),
                this.element.setAttribute("aria-describedby", e),
                this.setContent(),
                this.config.animation && a.default(b).addClass("fade");
              var i =
                  "function" == typeof this.config.placement
                    ? this.config.placement.call(this, b, this.element)
                    : this.config.placement,
                f = this._getAttachment(i);
              this.addAttachmentClass(f);
              var j = this._getContainer();
              a.default(b).data(this.constructor.DATA_KEY, this),
                a.default.contains(
                  this.element.ownerDocument.documentElement,
                  this.tip
                ) || a.default(b).appendTo(j),
                a
                  .default(this.element)
                ...
                a.default(b).addClass("show"),
                a.default(b).addClass(this.config.customClass),
                "ontouchstart" in document.documentElement &&
                  a
                    .default(document.body)
                    .children()
              ...
              var g = function () {
                ...
                var b = l._hoverState;
                (l._hoverState = null),
                  a.default(l.element).trigger(l.constructor.Event.SHOWN),
                  "out" === b && l._leave(null, l);
              };
              if (a.default(this.tip).hasClass("fade")) {
                var k = n.getTransitionDurationFromElement(this.tip);
                a.default(this.tip)
                  .one(n.TRANSITION_END, g)
          ...
          (b.hide = function (f) {
            var g = this,
              ...
              c = a.default.Event(this.constructor.Event.HIDE),
              d = function () {
                "show" !== g._hoverState &&
                  b.parentNode &&
                  ...
                  a.default(g.element).trigger(g.constructor.Event.HIDDEN),
                  null !== g._popper && g._popper.destroy(),
                  f && f();
              };
            if ((a.default(this.element).trigger(c), !c.isDefaultPrevented())) {
              if (
                (a.default(b).removeClass("show"),
                "ontouchstart" in document.documentElement &&
                  a
                    .default(document.body)
                    .children()
                ...
                a.default(this.tip).hasClass("fade"))
              ) {
                var e = n.getTransitionDurationFromElement(b);
                a.default(b).one(n.TRANSITION_END, d).emulateTransitionEnd(e);
              } else d();
              this._hoverState = "";
            }
          }),
          ...
          (b.addAttachmentClass = function (b) {
          ...
          (b.setContent = function () {
            ...
            this.setElementContent(
              a.default(b.querySelectorAll(".tooltip-inner")),
              this.getTitle()
            ),
              a.default(b).removeClass("fade show");
          }),
          (b.setElementContent = function (c, b) {
            "object" == typeof b && (b.nodeType || b.jquery)
              ? this.config.html
                ? a.default(b).parent().is(c) || c.empty().append(b)
                : c.text(a.default(b).text())
              : this.config.html
              ? (this.config.sanitize &&
                  (b = X(b, this.config.whiteList, this.config.sanitizeFn)),
                c.html(b))
              : c.text(b);
          }),
          (b.getTitle = function () {
          ...
          (b._enter = function (c, b) {
            var d = this.constructor.DATA_KEY;
            (b = b || a.default(c.currentTarget).data(d)) ||
              ((b = new this.constructor(
                c.currentTarget,
                this._getDelegateConfig()
              )),
              a.default(c.currentTarget).data(d, b)),
              c &&
                (b._activeTrigger["focusin" === c.type ? "focus" : "hover"] =
                  !0),
              a.default(b.getTipElement()).hasClass("show") ||
              "show" === b._hoverState
                ? (b._hoverState = "show")
          ...
          (b._leave = function (c, b) {
            ...
            (b = b || a.default(c.currentTarget).data(d)) ||
              ...
              a.default(c.currentTarget).data(d, b)),
              c &&
                (b._activeTrigger["focusout" === c.type ? "focus" : "hover"] =
                  !1),
              b._isWithActiveTrigger() ||
                (clearTimeout(b._timeout),
                (b._hoverState = "out"),
          ...
          (b._getConfig = function (b) {
            var c = a.default(this.element).data();
            return (
              Object.keys(c).forEach(function (a) {
                -1 !== aa.indexOf(a) && delete c[a];
              }),
              "number" ==
                typeof (b = w(
                  {},
                  ...
                  c,
                  "object" == typeof b && b ? b : {}
                )).delay && (b.delay = { show: b.delay, hide: b.delay }),
              "number" == typeof b.title && (b.title = b.title.toString()),
              "number" == typeof b.content &&
                (b.content = b.content.toString()),
              n.typeCheckConfig(k, b, this.constructor.DefaultType),
              b.sanitize &&
                (b.template = X(b.template, b.whiteList, b.sanitizeFn)),
              b
            );
          }),
          ...
          (b._cleanTipClass = function () {
            var c = a.default(this.getTipElement()),
              b = c.attr("class").match(Z);
            null !== b && b.length && c.removeClass(b.join(""));
          }),
          (b._handlePopperPlacementChange = function (a) {
          ...
          (c._jQueryInterface = function (b) {
            return this.each(function () {
              var e = a.default(this),
                ...
                f = "object" == typeof b && b;
              if (
                (d || !/dispose|hide/.test(b)) &&
                (d || ((d = new c(this, f)), e.data("bs.tooltip", d)),
                "string" == typeof b)
              ) {
                if (void 0 === d[b])
                  throw new TypeError('No method named "' + b + '"');
    ...
    (a.default.fn[k] = d._jQueryInterface),
      (a.default.fn[k].Constructor = d),
      (a.default.fn[k].noConflict = function () {
        return (a.default.fn[k] = Y), d._jQueryInterface;
      });
    var l = "popover",
      ae = a.default.fn[l],
      af = new RegExp("(^|\\s)bs-popover\\S+", "g"),
      ag = w({}, d.Default, {
        placement: "right",
        trigger: "click",
        content: "",
      ...
      ah = w({}, d.DefaultType, { content: "(string|element|function)" }),
      ai = {
          ...
          (c._jQueryInterface = function (b) {
            return this.each(function () {
              ...
              if (
                (d || !/dispose|hide/.test(b)) &&
                (d ||
                  ((d = new c(this, e)), a.default(this).data("bs.popover", d)),
                "string" == typeof b)
              ) {
                if (void 0 === d[b])
                  throw new TypeError('No method named "' + b + '"');
    ...
    (a.default.fn[l] = r._jQueryInterface),
      (a.default.fn[l].Constructor = r),
      (a.default.fn[l].noConflict = function () {
        return (a.default.fn[l] = ae), r._jQueryInterface;
      });
    var m = "scrollspy",
      aj = a.default.fn[m],
      ak = { offset: 10, method: "auto", target: "" },
      al = { offset: "number", method: "string", target: "(string|element)" },
      s = (function () {
        function c(b, c) {
          var d = this;
          (this._element = b),
            ...
            a
              ...
              .on("scroll.bs.scrollspy", function (a) {
                return d._process(a);
              }),
            this.refresh(),
            this._process();
        ...
        return (
          (b.refresh = function () {
            var d = this,
              ...
              e = "position" === c ? this._getScrollTop() : 0;
            (this._offsets = []),
              (this._targets = []),
              ...
              [].slice
                ...
                .map(function (g) {
                  var b,
                    d = n.getSelectorFromElement(g);
                  if ((d && (b = document.querySelector(d)), b)) {
                    var f = b.getBoundingClientRect();
                    if (f.width || f.height)
                      return [a.default(b)[c]().top + e, d];
                  }
                  return null;
                })
                .filter(function (a) {
                ...
                .forEach(function (a) {
                  d._offsets.push(a[0]), d._targets.push(a[1]);
                });
          }),
          (b.dispose = function () {
          ...
          (b._getConfig = function (b) {
            if (
              "string" !=
                typeof (b = w({}, ak, "object" == typeof b && b ? b : {}))
                  .target &&
              n.isElement(b.target)
            ) {
              var c = a.default(b.target).attr("id");
              c || ((c = n.getUID(m)), a.default(b.target).attr("id", c)),
                (b.target = "#" + c);
            }
            return n.typeCheckConfig(m, b, al), b;
          }),
          ...
          (b._activate = function (c) {
            ...
            var d = this._selector.split(",").map(function (a) {
              ...
              b = a.default(
                [].slice.call(document.querySelectorAll(d.join(",")))
              );
            b.hasClass("dropdown-item")
              ...
              a
                .default(this._scrollElement)
                .trigger("activate.bs.scrollspy", { relatedTarget: c });
          }),
          (b._clear = function () {
            [].slice
              .call(document.querySelectorAll(this._selector))
          ...
          (c._jQueryInterface = function (b) {
            return this.each(function () {
              var d = a.default(this).data("bs.scrollspy");
              if (
                (d ||
                  ((d = new c(this, "object" == typeof b && b)),
                  a.default(this).data("bs.scrollspy", d)),
                "string" == typeof b)
              ) {
                if (void 0 === d[b])
                  throw new TypeError('No method named "' + b + '"');
    ...
    a.default(window).on("load.bs.scrollspy.data-api", function () {
      for (
        var b = [].slice.call(document.querySelectorAll('[data-spy="scroll"]')),
          c = b.length;
        c--;

      ) {
        var d = a.default(b[c]);
        s._jQueryInterface.call(d, d.data());
      }
    }),
      (a.default.fn[m] = s._jQueryInterface),
      (a.default.fn[m].Constructor = s),
      (a.default.fn[m].noConflict = function () {
        return (a.default.fn[m] = aj), s._jQueryInterface;
      });
    var am = a.default.fn.tab,
      t = (function () {
        function b(a) {
          this._element = a;
        }
        ...
        return (
          (c.show = function () {
            ...
            if (
              !(
                (this._element.parentNode &&
                  this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
                  a.default(this._element).hasClass("active")) ||
                a.default(this._element).hasClass("disabled")
              )
            ) {
              var d,
                b,
                c = a.default(this._element).closest(".nav, .list-group")[0],
                e = n.getSelectorFromElement(this._element);
              if (c) {
                var i =
                  "UL" === c.nodeName || "OL" === c.nodeName
                    ? "> li > .active"
                    : ".active";
                b = (b = a.default.makeArray(a.default(c).find(i)))[
                  b.length - 1
                ];
              }
              var f = a.default.Event("hide.bs.tab", {
                  relatedTarget: this._element,
                }),
                g = a.default.Event("show.bs.tab", { relatedTarget: b });
              if (
                (b && a.default(b).trigger(f),
                a.default(this._element).trigger(g),
                !g.isDefaultPrevented() && !f.isDefaultPrevented())
              ) {
                e && (d = document.querySelector(e)),
                  this._activate(this._element, c);
                var h = function () {
                  var c = a.default.Event("hidden.bs.tab", {
                      relatedTarget: j._element,
                    }),
                    d = a.default.Event("shown.bs.tab", { relatedTarget: b });
                  a.default(b).trigger(c), a.default(j._element).trigger(d);
                };
                d ? this._activate(d, d.parentNode, h) : h();
              }
            }
          }),
          (c.dispose = function () {
          ...
          (c._activate = function (h, b, e) {
            var i = this,
              c = (
                b && ("UL" === b.nodeName || "OL" === b.nodeName)
                  ? a.default(b).find("> li > .active")
                  : a.default(b).children(".active")
              )[0],
              f = e && c && a.default(c).hasClass("fade"),
              d = function () {
                return i._transitionComplete(h, c, e);
              };
            if (c && f) {
              var g = n.getTransitionDurationFromElement(c);
              a.default(c)
                .removeClass("show")
                .one(n.TRANSITION_END, d)
          ...
          (c._transitionComplete = function (b, c, d) {
            if (c) {
              a.default(c).removeClass("active");
              var e = a
            ...
            if (
              ...
              n.reflow(b),
              b.classList.contains("fade") && b.classList.add("show"),
              b.parentNode && a.default(b.parentNode).hasClass("dropdown-menu"))
            ) {
              var f = a.default(b).closest(".dropdown")[0];
              if (f) {
                var g = [].slice.call(f.querySelectorAll(".dropdown-toggle"));
                a.default(g).addClass("active");
              }
          ...
          (b._jQueryInterface = function (c) {
            return this.each(function () {
              var e = a.default(this),
                d = e.data("bs.tab");
              if (
                (d || ((d = new b(this)), e.data("bs.tab", d)),
                "string" == typeof c)
              ) {
                if (void 0 === d[c])
    ...
    a
      ...
      .on(
        ...
        function (b) {
          b.preventDefault(), t._jQueryInterface.call(a.default(this), "show");
        }
      ),
      (a.default.fn.tab = t._jQueryInterface),
      (a.default.fn.tab.Constructor = t),
      (a.default.fn.tab.noConflict = function () {
        return (a.default.fn.tab = am), t._jQueryInterface;
      });
    var an = a.default.fn.toast,
      ao = { animation: "boolean", autohide: "boolean", delay: "number" },
      ap = { animation: !0, autohide: !0, delay: 500 },
      u = (function () {
        function c(a, b) {
          (this._element = a),
            (this._config = this._getConfig(b)),
        ...
        return (
          (b.show = function () {
            var e = this,
              b = a.default.Event("show.bs.toast");
            if (
              (a.default(this._element).trigger(b), !b.isDefaultPrevented())
            ) {
              this._clearTimeout(),
              ...
              var c = function () {
                e._element.classList.remove("showing"),
                  ...
                  a.default(e._element).trigger("shown.bs.toast"),
                  e._config.autohide &&
              ...
              if (
                ...
                var d = n.getTransitionDurationFromElement(this._element);
                a.default(this._element)
                  .one(n.TRANSITION_END, c)
                  .emulateTransitionEnd(d);
              } else c();
            }
          }),
          ...
          (b._getConfig = function (b) {
            return (
              ...
              n.typeCheckConfig("toast", b, this.constructor.DefaultType),
              b
            );
          }),
          (b._setListeners = function () {
            var b = this;
            a.default(this._element).on(
            ...
            var d = this,
              b = function () {
                d._element.classList.add("hide"),
                  a.default(d._element).trigger("hidden.bs.toast");
              };
            if (
    ...
    (a.default.fn.toast = u._jQueryInterface),
      (a.default.fn.toast.Constructor = u),
      (a.default.fn.toast.noConflict = function () {
        return (a.default.fn.toast = an), u._jQueryInterface;
      }),
      (b.Alert = e),
      (b.Button = o),
      (b.Carousel = h),
  ...
  PageTransitions = (function () {
        ...
        c.length > 0 &&
          ((window.onhashchange = function () {
            ...
            c.each(function () {
              ...
              b.indexOf(a) >= 0 &&
                (($nextPageIndex = $(a).index()),
                g > 67 && (g = 1),
                c.removeClass("active"),
                c.eq(b.indexOf(a)).addClass("active"),
                (function (o) {
                  var c,
                    d,
                    p = $("html").data("randomAnimation"),
                    s = $("html").data("animation");
                  if (f === o) return !1;
                  if (((h = !0), !p))
                    switch (s) {
                      case 1:
                  ...
                  p ? (m = g) : f < o ? (m = c) : f > o && (m = d);
                  var q = e.eq(f);
                  f = o;
                  var r = e.eq(f).addClass("page-active"),
                    a = "",
                    b = "";
                  switch (m) {
                    case 1:
                      (a = "pt-page-moveToLeft"), (b = "pt-page-moveFromRight");
                      break;
                    case 2:
                      (a = "pt-page-moveToRight"), (b = "pt-page-moveFromLeft");
                      break;
                    case 3:
                      (a = "pt-page-moveToTop"), (b = "pt-page-moveFromBottom");
                      break;
                    case 4:
                      (a = "pt-page-moveToBottom"), (b = "pt-page-moveFromTop");
                      break;
                    case 5:
                      (a = "pt-page-fade"),
                        (b = "pt-page-moveFromRight pt-page-ontop");
                      break;
                    case 6:
                      (a = "pt-page-fade"),
                        (b = "pt-page-moveFromLeft pt-page-ontop");
                      break;
                    case 7:
                      (a = "pt-page-fade"),
                        (b = "pt-page-moveFromBottom pt-page-ontop");
                      break;
                    case 8:
                      (a = "pt-page-fade"),
                        (b = "pt-page-moveFromTop pt-page-ontop");
                      break;
                    case 9:
                      (a = "pt-page-moveToLeftFade"),
                        (b = "pt-page-moveFromRightFade");
                      break;
                    case 10:
                      (a = "pt-page-moveToRightFade"),
                        (b = "pt-page-moveFromLeftFade");
                      break;
                    case 11:
                      (a = "pt-page-moveToTopFade"),
                        (b = "pt-page-moveFromBottomFade");
                      break;
                    case 12:
                      (a = "pt-page-moveToBottomFade"),
                        (b = "pt-page-moveFromTopFade");
                      break;
                    case 13:
                    ...
                    case 22:
                      (a = "pt-page-scaleDownUp"),
                        (b = "pt-page-scaleUp pt-page-delay300");
                      break;
                    case 23:
                    ...
                    case 27:
                      (a = "pt-page-scaleDownCenter"),
                        (b = "pt-page-scaleUpCenter pt-page-delay400");
                      break;
                    case 28:
                    ...
                    case 32:
                      (a = "pt-page-flipOutRight"),
                        (b = "pt-page-flipInLeft pt-page-delay500");
                      break;
                    case 33:
                      (a = "pt-page-flipOutLeft"),
                        (b = "pt-page-flipInRight pt-page-delay500");
                      break;
                    case 34:
                      (a = "pt-page-flipOutTop"),
                        (b = "pt-page-flipInBottom pt-page-delay500");
                      break;
                    case 35:
                      (a = "pt-page-flipOutBottom"),
                        (b = "pt-page-flipInTop pt-page-delay500");
                      break;
                    case 36:
                    ...
                    case 37:
                      (a = "pt-page-rotateOutNewspaper"),
                        (b = "pt-page-rotateInNewspaper pt-page-delay500");
                      break;
                    case 38:
                    ...
                    case 42:
                      (a = "pt-page-rotatePushLeft"),
                        (b = "pt-page-rotatePullRight pt-page-delay180");
                      break;
                    case 43:
                      (a = "pt-page-rotatePushRight"),
                        (b = "pt-page-rotatePullLeft pt-page-delay180");
                      break;
                    case 44:
                      (a = "pt-page-rotatePushTop"),
                        (b = "pt-page-rotatePullBottom pt-page-delay180");
                      break;
                    case 45:
                      (a = "pt-page-rotatePushBottom"),
                        (b = "pt-page-rotatePullTop pt-page-delay180");
                      break;
                    case 46:
    ...
    function n(c, d) {
      ...
      (i = !1),
        (j = !1),
        (a = d),
        (b = c).attr("class", b.data("originalClassList")),
        a.attr("class", a.data("originalClassList") + " page-active"),
        (h = !1);
    }
    return (
      (a = []),
      ...
      a.indexOf(b) >= 0 &&
        ((f = a.indexOf(b)),
        c.removeClass("active"),
        c.eq(a.indexOf(b)).addClass("active")),
      d(),
      { init: d }
    );
  })();
...
jQuery(document).ready(function (a) {
  ...
  function m(b) {
    var c = p(b);
    if (b.parents(".cd-headline").hasClass("type")) {
      var r = b.parent(".cd-words-wrapper");
      r.addClass("selected").removeClass("waiting"),
        setTimeout(function () {
    ...
    } else if (b.parents(".cd-headline").hasClass("letters")) {
      var l = b.children("i").length >= c.children("i").length;
      (function h(b, c, e, f) {
        if (
        ...
        o(c.find("i").eq(0), c, l, h);
    } else
      b.parents(".cd-headline").hasClass("clip")
        ? b
            .parents(".cd-words-wrapper")
            .animate({ width: "2px" }, k, function () {
              q(b, c), n(c);
            })
        : b.parents(".cd-headline").hasClass("loading-bar")
        ? (b.parents(".cd-words-wrapper").removeClass("is-loading"),
          q(b, c),
          setTimeout(function () {
            m(c);
          }, e),
          setTimeout(function () {
            b.parents(".cd-words-wrapper").addClass("is-loading");
          }, g))
        : (q(b, c),
          setTimeout(function () {
            m(c);
  ...
  function n(a, b) {
    a.parents(".cd-headline").hasClass("type")
      ? (o(a.find("i").eq(0), a, !1, b),
        a.addClass("is-visible").removeClass("is-hidden"))
      : a.parents(".cd-headline").hasClass("clip") &&
        a
          .parents(".cd-words-wrapper")
          .animate({ width: a.width() + 10 }, k, function () {
            setTimeout(function () {
              m(a);
            }, l);
          });
  ...
  function o(a, b, c, e) {
    a.addClass("in").removeClass("out"),
      a.is(":last-child")
        ? (b.parents(".cd-headline").hasClass("type") &&
            setTimeout(function () {
  ...
  a(".cd-headline.letters")
    .find("b")
    .each(function () {
      var c = a(this),
        b = c.text().split(""),
        d = c.hasClass("is-visible");
      for (i in b)
        c.parents(".rotate-2").length > 0 && (b[i] = "<em>" + b[i] + "</em>"),
          (b[i] = d ? '<i class="in">' + b[i] + "</i>" : "<i>" + b[i] + "</i>");
      var e = b.join("");
      c.html(e).css("opacity", 1);
    }),
    (b = a(".cd-headline")),
    (c = d),
    b.each(function () {
      ...
      if (b.hasClass("loading-bar"))
        ...
        var h = b.find(".cd-words-wrapper b"),
          i = 0;
        h.each(function () {
          var b = a(this).width();
          b > i && (i = b);
  ...
  (function (b, c, d, e) {
    ...
    (a.Defaults = {
        ...
        },
        {
          ...
          run: function (c) {
            var d =
              ...
              e = [];
            for (c.items = { merge: !1, width: d }; b--; )
              (a = this._mergers[b]),
                (a =
                  (this.settings.mergeFit &&
                    Math.min(a, this.settings.items)) ||
                  a),
                (c.items.merge = a > 1 || c.items.merge),
        ...
        },
        {
          ...
          run: function () {
            var a = [],
              ...
              e = d.loop && c.length ? (d.rewind ? g : Math.max(g, i)) : 0,
              h = "",
              f = "";
            for (e /= 2; e > 0; )
        ...
        },
        {
          ...
          run: function () {
            var b,
              ...
              h = d + this.width() * f,
              i = [];
            for (a = 0, e = this._coordinates.length; a < e; a++)
              (b = this._coordinates[a - 1] || 0),
                (c = Math.abs(this._coordinates[a]) + g * f),
                ((this.op(b, "<=", d) && this.op(b, ">", h)) ||
                  (this.op(c, "<", d) && this.op(c, ">", h))) &&
                  i.push(a);
      ...
      (a.prototype.initializeStage = function () {
        (this.$stage = this.$element.find("." + this.settings.stageClass)),
          this.$stage.length ||
            ...
            (this.$stage = b("<" + this.settings.stageElement + ">", {
              class: this.settings.stageClass,
            }).wrap(b("<div/>", { class: this.settings.stageOuterClass }))),
      ...
      (a.prototype.setup = function () {
        ...
        c
          ? (b.each(c, function (a) {
            ...
            "function" ==
              typeof (a = b.extend({}, this.options, c[d])).stagePadding &&
      ...
      (a.prototype.prepare = function (c) {
        ...
        return (
          a.data ||
            (a.data = b("<" + this.settings.itemElement + "/>")
          ...
          b(d).one(
            ...
            b.proxy(function (a) {
              ...
              b(d).on(
                ...
                (Math.abs(c.x) < Math.abs(c.y) && this.is("valid")) ||
                  (a.preventDefault(),
                  this.enter("dragging"),
                  this.trigger("drag"));
            }, this)
      ...
      (a.prototype.onDragEnd = function (e) {
        ...
        b(d).off(".owl.core"),
          ...
          ((0 !== a.x && this.is("dragging")) || !this.is("valid")) &&
            ...
            this.current(
              this.closest(f.x, 0 !== a.x ? c : this._drag.direction)
            ),
            this.invalidate("position"),
            this.update(),
      ...
      (a.prototype.closest = function (a, f) {
        ...
        return (
          this.settings.freeDrag ||
            b.each(
              d,
              b.proxy(function (b, h) {
                return (
                  "left" === f && a > h - 30 && a < h + 30
                    ? (c = b)
                    : "right" === f && a > h - g - 30 && a < h - g + 30
                    ? (c = b + 1)
                    : this.op(a, "<", h) &&
          ...
          this.settings.loop ||
            (this.op(a, ">", d[this.minimum()])
              ? (c = a = this.minimum())
              : this.op(a, "<", d[this.maximum()]) && (c = a = this.maximum())),
          c
        );
      }),
      (a.prototype.animate = function (a) {
        ...
        this.is("animating") && this.onTransitionEnd(),
          ...
          b.support.transform3d && b.support.transition
            ? this.$stage.css({
      ...
      (a.prototype.current = function (a) {
        ...
        if (((a = this.normalize(a)), this._current !== a)) {
          ...
          b.data !== e && (a = this.normalize(b.data)),
            (this._current = a),
            this.invalidate("position"),
            this.trigger("changed", {
      ...
      (a.prototype.maximum = function (f) {
        ...
        if (b.loop) c = this._clones.length / 2 + this._items.length - 1;
          ...
          if ((a = this._items.length))
            for (
              d = this._items[--a].width(), e = this.$element.width();
              a-- &&
          ...
          c = b.center ? this._items.length - 1 : this._items.length - b.items;
      ...
      (a.prototype.clones = function (a) {
        ...
        return a === e
          ? b.map(this._clones, function (b, a) {
              return f(a);
            })
      ...
      (a.prototype.coordinates = function (c) {
        ...
        return c === e
          ...
          : (this.settings.center
              ? (this.settings.rtl && ((f = -1), (d = c + 1)),
                (a = this._coordinates[c]),
                (a +=
                  ((this.width() - a + (this._coordinates[d] || 0)) / 2) * f))
              : (a = this._coordinates[d] || 0),
            (a = Math.ceil(a)));
      }),
      (a.prototype.duration = function (b, c, a) {
        return 0 === a
          ? 0
          : Math.min(Math.max(Math.abs(c - b), 1), 6) *
              Math.abs(a || this.settings.smartSpeed);
      }),
      (a.prototype.to = function (a, h) {
        var c = this.current(),
          ...
          f = this.maximum();
        this.settings.loop
          ? (!this.settings.rewind && Math.abs(b) > e / 2 && (b += -1 * i * e),
            (d = (((((a = c + b) - g) % e) + e) % e) + g) !== a &&
              d - b <= f &&
              d - b > 0 &&
              ((c = d - b), (a = d), this.reset(c)))
          : (a = this.settings.rewind
              ? ((a % (f += 1)) + f) % f
              : Math.max(g, Math.min(f, a))),
      ...
      (a.prototype.viewport = function () {
        ...
        return (
          this.options.responsiveBaseElement !== c
            ? (a = b(this.options.responsiveBaseElement).width())
            : c.innerWidth
            ? (a = c.innerWidth)
            : d.documentElement && d.documentElement.clientWidth
            ? (a = d.documentElement.clientWidth)
      ...
      (a.prototype.add = function (a, c) {
        ...
        (c = c === e ? this._items.length : this.normalize(c, !0)),
          ...
          this.trigger("add", { content: a, position: c }),
          (a = this.prepare(a)),
          0 === this._items.length || c === this._items.length
            ? (0 === this._items.length && this.$stage.append(a),
              0 !== this._items.length && this._items[c - 1].after(a),
              this._items.push(a),
              this._mergers.push(
                1 *
                  a
          ...
          this.invalidate("items"),
          this.trigger("added", { content: a, position: c });
      }),
      ...
      (a.prototype.trigger = function (c, g, e, i, j) {
        var h = { item: { count: this._items.length, index: this.current() } },
          ...
          d = b.Event(
            [c, "owl", e || "carousel"].join(".").toLowerCase(),
            b.extend({ relatedTarget: this }, h, g)
          );
        return (
          this._supress[c] ||
            ...
            this.register({ type: a.Type.Event, name: c }),
      ...
      (a.prototype.enter = function (a) {
        b.each(
          ...
          b.proxy(function (b, a) {
            this._states.current[a] === e && (this._states.current[a] = 0),
      ...
      (a.prototype.register = function (c) {
        if (c.type === a.Type.Event) {
          if (
            (b.event.special[c.name] || (b.event.special[c.name] = {}),
          ...
          c.type === a.Type.State &&
            (this._states.tags[c.name]
              ? (this._states.tags[c.name] = this._states.tags[c.name].concat(
                  c.tags
                ))
              : (this._states.tags[c.name] = c.tags),
      ...
      (a.prototype.pointer = function (a) {
        ...
        return (
          (a =
            (a = a.originalEvent || a || c.event).touches && a.touches.length
              ? a.touches[0]
        ...
        return this.each(function () {
          ...
          e ||
            ...
            b.each(
              ...
              function (d, c) {
                e.register({ type: a.Type.Event, name: c }),
                  e.$element.on(
                    c + ".owl.carousel.core",
                    b.proxy(function (a) {
                      a.namespace &&
  ...
  (function (b, c, d, e) {
    var a = function (c) {
      (this._core = c),
        ...
        (this._core.options = b.extend({}, a.Defaults, this._core.options)),
    ...
    (a.Defaults = { autoRefresh: !0, autoRefreshInterval: 500 }),
      ...
      (a.prototype.destroy = function () {
        var a, b;
        for (a in (c.clearInterval(this._interval), this._handlers))
          ...
          "initialized.owl.carousel change.owl.carousel resized.owl.carousel":
            b.proxy(function (c) {
              if (
                ...
                ((c.property && "position" == c.property.name) ||
                  "initialized" == c.type)
              ) {
                var a = this._core.settings,
                  d = (a.center && Math.ceil(a.items / 2)) || a.items,
                  f = (a.center && -1 * d) || 0,
                  e =
                    (c.property && void 0 !== c.property.value
                      ? c.property.value
                ...
                for (
                  a.lazyLoadEager > 0 &&
                  ((d += a.lazyLoadEager),
                  a.loop && ((e -= a.lazyLoadEager), d++));
                  f++ < d;

                )
                  this.load(g / 2 + this._core.relative(e)),
                    g && b.each(this._core.clones(this._core.relative(e)), h),
                    e++;
              }
            }, this),
        }),
    ...
    (a.Defaults = { lazyLoad: !1, lazyLoadEager: 0 }),
      (a.prototype.load = function (e) {
        ...
        !d ||
          ...
          (d.each(
            b.proxy(function (g, f) {
              var e,
                a = b(f),
                d =
                  (c.devicePixelRatio > 1 && a.attr("data-src-retina")) ||
                  a.attr("data-src") ||
                  a.attr("data-srcset");
              this._core.trigger("load", { element: a, url: d }, "lazy"),
                a.is("img")
                  ? a
                      .one(
                        "load.owl.lazy",
                  ...
                  ? a
                      ...
                      .attr("srcset", d)
                  : (((e = new Image()).onload = b.proxy(function () {
                      a.css({
  ...
  (function (b, c, d, e) {
    var a = function (d) {
      (this._core = d),
        ...
        (this._handlers = {
          "initialized.owl.carousel refreshed.owl.carousel": b.proxy(function (
            a
          ) {
          ...
          "loaded.owl.lazy": b.proxy(function (a) {
            a.namespace &&
              this._core.settings.autoHeight &&
    ...
    var a = function (c) {
      (this._core = c),
        ...
        (this._handlers = {
          ...
          "resize.owl.carousel": b.proxy(function (a) {
            a.namespace &&
              this._core.settings.video &&
              this.isInFullScreen() &&
              a.preventDefault();
          }, this),
          "refreshed.owl.carousel": b.proxy(function (a) {
            a.namespace &&
    ...
    (a.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      (a.prototype.fetch = function (a, e) {
        var d = a.attr("data-vimeo-id")
          ...
          g = a.attr("data-height") || this._core.settings.videoHeight,
          c = a.attr("href");
        ...
        if (
          ...
          if (!(b[3].indexOf("vzaar") > -1))
            throw new Error("Video URL not supported.");
          d = "vzaar";
        }
        (b = b[6]),
          (this._videos[c] = { type: d, id: b, width: f, height: g }),
          e.attr("data-video", c),
      ...
      (a.prototype.thumbnail = function (d, a) {
        var j,
          ...
          f = function (a) {
            (k = '<div class="owl-video-play-icon"></div>'),
              (j = l.lazyLoad
                ? b("<div/>", { class: "owl-video-tn " + i, srcType: a })
                : b("<div/>", {
                    class: "owl-video-tn",
        ...
        if (
          (d.wrap(b("<div/>", { class: "owl-video-wrapper", style: h })),
          this._core.settings.lazyLoad && ((e = "data-src"), (i = "owl-lazy")),
          c.length)
        )
          return f(c.attr(e)), c.remove(), !1;
        "youtube" === a.type
          ? f((g = "//img.youtube.com/vi/" + a.id + "/hqdefault.jpg"))
          : "vimeo" === a.type
          ? b.ajax({
              type: "GET",
      ...
      (a.prototype.play = function (e) {
        var c,
          ...
          f = a.width || "100%",
          g = a.height || this._core.$stage.height();
        this._playing ||
          ...
          "youtube" === a.type
            ...
            : "vimeo" === a.type
            ? c.attr("src", "//player.vimeo.com/video/" + a.id + "?autoplay=1")
            : "vzaar" === a.type &&
              c.attr(
                "src",
      ...
      (a.prototype.destroy = function () {
        var a, b;
        for (a in (this._core.$element.off("click.owl.video"), this._handlers))
          this._core.$element.off(a, this._handlers[a]);
        for (b in Object.getOwnPropertyNames(this))
          "function" != typeof this[b] && (this[b] = null);
      }),
  ...
  (function (b, c, d, e) {
    var a = function (c) {
      (this.core = c),
        (this.core.options = b.extend({}, a.Defaults, this.core.options)),
        (this.swapping = !0),
        ...
        (this.handlers = {
          ...
          "translate.owl.carousel": b.proxy(function (a) {
            a.namespace &&
              this.swapping &&
  ...
  (function (b, c, d, e) {
    ...
    var a = function (c) {
      (this._core = c),
        ...
        (this._handlers = {
          ...
          "added.owl.carousel": b.proxy(function (a) {
            a.namespace &&
              this._core.settings.dotsData &&
              this._templates.splice(a.position, 0, this._templates.pop());
          }, this),
          "remove.owl.carousel": b.proxy(function (a) {
            a.namespace &&
              this._core.settings.dotsData &&
    ...
    (a.Defaults = {
      ...
      (a.prototype.initialize = function () {
        ...
        for (c in ((this._controls.$relative = (
          a.navContainer
            ? b(a.navContainer)
            : b("<div>").addClass(a.navContainerClass).appendTo(this.$element)
        ).addClass("disabled")),
        (this._controls.$previous = b("<" + a.navElement + ">")
        ...
        (this._controls.$next = b("<" + a.navElement + ">")
        ...
        (this._controls.$absolute = (
          a.dotsContainer
            ? b(a.dotsContainer)
            : b("<div>").addClass(a.dotsClass).appendTo(this.$element)
        ).addClass("disabled")),
        this._controls.$absolute.on(
          "click",
          "button",
          b.proxy(function (c) {
            var d = b(c.target).parent().is(this._controls.$absolute)
              ? b(c.target).index()
              : b(c.target).parent().index();
      ...
      (a.prototype.destroy = function () {
        var b, a, c, d, e;
        for (b in ((e = this._core.settings), this._handlers))
          this.$element.off(b, this._handlers[b]);
        for (a in this._controls)
          "$relative" === a && e.navContainer
      ...
      (a.prototype.update = function () {
        var b,
          ...
          a = this._core.settings,
          f = a.center || a.autoWidth || a.dotsData ? 1 : a.dotsEach || a.items;
        if (
          ...
          a.dots &&
            ...
            a.dotsData && 0 !== c
              ...
              ? this._controls.$absolute.append(
                  new Array(c + 1).join(this._templates[0])
                )
              : c < 0 && this._controls.$absolute.children().slice(c).remove(),
            this._controls.$absolute.find(".active").removeClass("active"),
            this._controls.$absolute
              .children()
              .eq(b.inArray(this.current(), this._pages))
              .addClass("active"));
      }),
      ...
      (a.prototype.to = function (c, d, e) {
        ...
        !e && this._pages.length
          ? ((a = this._pages.length),
            b.proxy(this._overrides.to, this._core)(
              this._pages[((c % a) + a) % a].start,
              d
            ))
  ...
  (function (b, c, d, e) {
    ...
    var a = function (d) {
      (this._core = d),
        ...
        (this._handlers = {
          ...
          "changed.owl.carousel": b.proxy(function (d) {
    ...
    (a.Defaults = { URLhashListener: !1 }),
      (a.prototype.destroy = function () {
        var a, d;
        for (a in (b(c).off("hashchange.owl.navigation"), this._handlers))
          this._core.$element.off(a, this._handlers[a]);
  ...
  (function (a, h, i, j) {
    function d(b, e) {
      ...
      return (
        a.each((b + " " + l.join(c + " ") + c).split(" "), function (b, a) {
          if (void 0 !== k[a]) return (d = !e || a), !1;
        }),
        d
      );
    }
    ...
    d("transition") &&
      ((a.support.transition = new String(b("transition"))),
      (a.support.transition.end = c.transition.end[a.support.transition])),
      g() &&
        ((a.support.animation = new String(b("animation"))),
        (a.support.animation.end = c.animation.end[a.support.animation])),
      e() &&
        ((a.support.transform = new String(b("transform"))),
        (a.support.transform3d = f()));
  })(window.Zepto || window.jQuery, window, document),
  (function (b, a) {
    "object" == typeof exports && "undefined" != typeof module
      ? (module.exports = a())
      : "function" == typeof define && define.amd
      ? define(a)
      : ((b = "undefined" != typeof globalThis ? globalThis : b || self).fitty =
          a());
  })(this, function () {
    return (function (a) {
      if (a) {
        var d = function (a) {
          ...
          k = function (a) {
            a
              .filter(function (a) {
                return !a.styleComputed;
              })
              .forEach(function (a) {
                a.styleComputed = o(a);
              }),
              a.filter(p).forEach(q);
            var b = a.filter(n);
            b.forEach(m),
          ...
          m = function (a) {
            (a.availableWidth = a.element.parentNode.clientWidth),
              (a.currentWidth = a.element.scrollWidth),
              (a.previousFontSize = a.currentFontSize),
              (a.currentFontSize = Math.min(
                Math.max(
                  a.minSize,
                  (a.availableWidth / a.currentWidth) * a.previousFontSize
                ),
                a.maxSize
              )),
              (a.whiteSpace =
                a.multiLine && a.currentFontSize === a.minSize
                  ? "normal"
                  : "nowrap");
          },
          n = function (a) {
            return (
              a.dirty !== g ||
              (a.dirty === g &&
                a.element.parentNode.clientWidth !== a.availableWidth)
            );
          },
          o = function (b) {
            var c = a.getComputedStyle(b.element, null);
            return (
              (b.currentFontSize = parseFloat(c.getPropertyValue("font-size"))),
              (b.display = c.getPropertyValue("display")),
          ...
          p = function (a) {
            var b = !1;
            return (
              !a.preStyleTestCompleted &&
              (/inline-/.test(a.display) ||
                ((b = !0), (a.display = "inline-block")),
              "nowrap" !== a.whiteSpace &&
                ((b = !0), (a.whiteSpace = "nowrap")),
              (a.preStyleTestCompleted = !0),
              b)
            );
          },
          q = function (a) {
            (a.element.style.whiteSpace = a.whiteSpace),
              (a.element.style.display = a.display),
              (a.element.style.fontSize = a.currentFontSize + "px");
          },
          r = function (a) {
            a.element.dispatchEvent(
              new CustomEvent("fit", {
                detail: {
                  oldValue: a.previousFontSize,
                  newValue: a.currentFontSize,
                  scaleFactor: a.currentFontSize / a.previousFontSize,
                },
              })
            );
          },
          ...
          t = function (a) {
            return function () {
              (h = h.filter(function (b) {
                ...
                a.observeMutations && a.observer.disconnect(),
                (a.element.style.whiteSpace = a.originalStyle.whiteSpace),
                (a.element.style.display = a.originalStyle.display),
                (a.element.style.fontSize = a.originalStyle.fontSize);
            };
          },
          u = function (a) {
            return function () {
              a.active || ((a.active = !0), j());
            };
          },
          v = function (a) {
            return function () {
          ...
          w = function (a) {
            a.observeMutations &&
              ((a.observer = new MutationObserver(s(a, f))),
              a.observer.observe(a.element, a.observeMutations));
          },
          x = {
            minSize: 16,
            maxSize: 512,
            multiLine: !0,
            observeMutations: "MutationObserver" in a && {
              subtree: !0,
              childList: !0,
              characterData: !0,
            },
          ...
          y = null,
          z = function () {
            a.clearTimeout(y), (y = a.setTimeout(c(g), C.observeWindowDelay));
          },
          A = ["resize", "orientationchange"];
        return (
          Object.defineProperty(C, "observeWindow", {
            set: function (b) {
              var c = "".concat(b ? "add" : "remove", "EventListener");
      ...
      function B(a, c) {
        var e = Object.assign({}, x, c),
          d = a.map(function (d) {
            var a,
              c = Object.assign({}, e, { element: d, active: !0 });
            return (
              ((a = c).originalStyle = {
                whiteSpace: a.element.style.whiteSpace,
                display: a.element.style.display,
                fontSize: a.element.style.fontSize,
              }),
              w(a),
              (a.newbie = !0),
              (a.dirty = !0),
      ...
      function C(a) {
        ...
        return "string" == typeof a
          ? B(d(document.querySelectorAll(a)), b)
          : B([a], b)[0];
      }
      ...
      function i(a, d, e) {
        ...
        return (
          a.each(function (l, j) {
            ...
            if (!a)
              return void g(
                h + " not initialized. Cannot call methods, i.e. " + f
              );
            var i = a[d];
            if (!i || "_" == d.charAt(0))
  ...
  (function (b, a) {
    ...
    function b(b) {
      if (
        ...
        for (
          var t = (a.isBorderBox = "border-box" == i.boxSizing), k = 0;
          k < j;
          k++
        ) {
          var l = c[k],
        ...
        var n = a.paddingLeft + a.paddingRight,
          o = a.paddingTop + a.paddingBottom,
        ...
        var s = d(i.height);
        return (
          !1 !== s && (a.height = s + (q ? 0 : o + p)),
          (a.innerWidth = a.width - (n + _)),
          (a.innerHeight = a.height - (o + p)),
          (a.outerWidth = a.width + u),
  ...
  (function (a, b) {
    ...
    var d = document.documentElement.style,
      b = "string" == typeof d.transition ? "transition" : "WebkitTransition",
    ...
    (a.constructor = c),
      ...
      (a.getPosition = function () {
        var d = getComputedStyle(this.element),
          ...
          b = parseFloat(h),
          c = this.layout.size;
        -1 != g.indexOf("%") && (a = (a / 100) * c.width),
          -1 != h.indexOf("%") && (b = (b / 100) * c.height),
          (a = isNaN(a) ? 0 : a),
          (b = isNaN(b) ? 0 : b),
          (a -= e ? c.paddingLeft : c.paddingRight),
          (b -= f ? c.paddingTop : c.paddingBottom),
          (this.position.x = a),
          (this.position.y = b);
      }),
      (a.layoutPosition = function () {
        var d = this.layout.size,
          ...
          e = b ? "paddingLeft" : "paddingRight",
          f = b ? "left" : "right",
          g = b ? "right" : "left",
          h = this.position.x + d[e];
        (a[f] = this.getXValue(h)), (a[g] = "");
        var i = c ? "paddingTop" : "paddingBottom",
          j = c ? "top" : "bottom",
          k = c ? "bottom" : "top",
          l = this.position.y + d[i];
        (a[j] = this.getYValue(l)),
          (a[k] = ""),
          this.css(a),
      ...
      (a._transitionTo = function (a, b) {
        ...
        var d = this.position.x,
          e = this.position.y,
          f = a == this.position.x && b == this.position.y;
        if ((this.setPosition(a, b), f && !this.isTransitioning))
          return void this.layoutPosition();
        var g = a - d,
          h = b - e,
          c = {};
        (c.transform = this.getTranslate(g, h)),
          this.transition({
            to: c,
      ...
      (a.transition = function (a) {
        ...
        for (b in a.to)
          (c.ingProperties[b] = !0), a.isCleaning && (c.clean[b] = !0);
        if (a.from) {
          this.css(a.from);
    ...
    (a.ontransitionend = function (c) {
      if (c.target === this.element) {
        var a = this._transn,
          b = m[c.propertyName] || c.propertyName;
        delete a.ingProperties[b],
          i(a.ingProperties) && this.disableTransition(),
          b in a.clean &&
            ((this.element.style[c.propertyName] = ""), delete a.clean[b]),
          b in a.onEnd && (a.onEnd[b].call(this), delete a.onEnd[b]),
    ...
    return (
      (a.removeTransitionStyles = function () {
        this.css(n);
      }),
    ...
    function b(b, e) {
      ...
      if (!a)
        return void (
          k &&
          k.error(
            "Bad element for " + this.constructor.namespace + ": " + (a || b)
          )
        );
      (this.element = a),
    ...
    c.extend(a, g.prototype),
      ...
      (a._create = function () {
        this.reloadItems(),
          ...
          c.extend(this.element.style, this.options.containerStyle),
      ...
      (a._itemize = function (d) {
        for (
          var b = this._filterFindItemElements(d),
      ...
      (a._getMeasurement = function (c, d) {
        ...
        a
          ? ("string" == typeof a
              ? (b = this.element.querySelector(a))
              : a instanceof HTMLElement && (b = a),
            (this[c] = b ? h(b)[d] : a))
          : (this[c] = 0);
      }),
      ...
      (a._getContainerSize = f),
      (a._setContainerMeasure = function (b, c) {
        if (void 0 !== b) {
          var a = this.size;
          a.isBorderBox &&
            (b += c
      ...
      (a._manageStamp = f),
      (a._getElementOffset = function (d) {
      ...
      c.debounceMethod(b, "onresize", 100),
      (a.resize = function () {
      ...
      (b.create = function (d, f) {
        var a = i(b);
        return (
          (a.defaults = c.extend({}, b.defaults)),
          c.extend(a.defaults, f),
          (a.compatOptions = c.extend({}, b.compatOptions)),
          (a.namespace = d),
          (a.data = b.data),
          (a.Item = i(e)),
          c.htmlInit(a, d),
          l && l.bridget && l.bridget(d, a),
          a
        );
      });
    var o = { ms: 1, s: 1e3 };
  ...
  (function (a, b) {
    ...
    var a = (b.prototype = Object.create(c.Item.prototype)),
      d = a._create;
    (a._create = function () {
      ...
      (a.updateSortData = function () {
        if (!this.isIgnored) {
          ...
          var b = this.layout.options.getSortData,
            c = this.layout._sorters;
          for (var a in b) {
            var d = c[a];
    ...
    return (
      ...
      (a.needsVerticalResizeLayout = function () {
        ...
        return (
          this.isotope.size &&
          a &&
          a.innerHeight != this.isotope.size.innerHeight
        );
      }),
    ...
    return (
      ...
      (a._getItemLayoutPosition = function (a) {
        ...
        var e = a.size.outerWidth % this.columnWidth,
          c = Math[e && e < 1 ? "round" : "ceil"](
            a.size.outerWidth / this.columnWidth
          );
        c = Math.min(c, this.cols);
        for (
          var f = this.options.horizontalOrder
              ? "_getHorizontalColPosition"
              : "_getTopColPosition",
            b = this[f](c, a),
            g = { x: this.columnWidth * b.col, y: b.y },
            h = b.y + a.size.outerHeight,
            i = c + b.col,
            d = b.col;
          d < i;
          d++
      ...
      (a._getHorizontalColPosition = function (b, c) {
        ...
        return (
          (this.horizontalColIndex = d ? a + b : this.horizontalColIndex),
          { col: a, y: this._getColGroupY(a, b) }
        );
      }),
      (a._manageStamp = function (f) {
        var g = d(f),
          a = this._getElementOffset(f),
          h = this._getOption("originLeft") ? a.left : a.right,
          i = h + g.outerWidth,
          e = Math.floor(h / this.columnWidth);
        e = Math.max(0, e);
        var b = Math.floor(i / this.columnWidth);
        (b -= i % this.columnWidth ? 0 : 1), (b = Math.min(this.cols - 1, b));
        for (
          var j = this._getOption("originTop"),
            k = (j ? a.top : a.bottom) + g.outerHeight,
            c = e;
          c <= b;
          c++
        )
  ...
  (function (b, a) {
    ...
    var d = e.create("masonry"),
      a = d.prototype,
      f = { _getElementOffset: !0, layout: !0, _getMeasurement: !0 };
  ...
  (function (b, a) {
    ...
    "use strict";
    var b = c.create("vertical", { horizontalAlignment: 0 }),
      a = b.prototype;
    return (
      (a._resetLayout = function () {
        this.y = 0;
  ...
  (function (a, b) {
      ...
      return function (g, h) {
        for (var d = 0; d < a.length; d++) {
          var c = a[d],
            ...
            f = h.sortData[c];
          if (e > f || e < f)
            return (e > f ? 1 : -1) * ((void 0 !== b[c] ? b[c] : b) ? 1 : -1);
        }
        return 0;
      };
    }
    ...
    var a = b.prototype;
    (a._create = function () {
      for (var a in ((this.itemGUID = 0),
      (this._sorters = {}),
      this._getSorters(),
      d.prototype._create.call(this),
      (this.modes = {}),
      ...
      (a._itemize = function () {
        for (
          var a = d.prototype._itemize.apply(this, arguments), b = 0;
          b < a.length;
          b++
        )
          a[b].id = this.itemGUID++;
        return this._updateItemsSortData(a), a;
      }),
      (a._initLayoutMode = function (a) {
        var b = f.modes[a],
          c = this.options[a] || {};
        (this.options[a] = b.options ? i.extend(b.options, c) : c),
      ...
      (a.arrange = function (b) {
        ...
        (this.filteredItems = a.matches),
          this._bindArrangeComplete(),
          this._isInstant
            ? this._noTransition(this._hideReveal, [a])
            : this._hideReveal(a),
          this._sort(),
          this._layout();
      }),
      (a._init = a.arrange),
      (a._hideReveal = function (a) {
      ...
      (a._filter = function (e) {
        ...
        b = b || "*";
        for (
          var f = [], g = [], h = [], i = this._getFilterTest(b), c = 0;
          c < e.length;
          c++
        ) {
          var a = e[c];
          if (!a.isIgnored) {
            var d = i(a);
            d && f.push(a),
              d && a.isHidden ? g.push(a) : d || a.isHidden || h.push(a);
          }
        }
        return { matches: f, needReveal: g, needHide: h };
      }),
      (a._getFilterTest = function (a) {
        return k && this.options.isJQueryFiltering
          ? function (b) {
      ...
      (a.updateSortData = function (a) {
        var b;
        a ? ((a = i.makeArray(a)), (b = this.getItems(a))) : (b = this.items),
          this._getSorters(),
      ...
      (a._updateItemsSortData = function (a) {
        for (var c = a && a.length, b = 0; c && b < c; b++)
          a[b].updateSortData();
      });
    var m = (function () {
      function a(a) {
    ...
    (b.sortDataParsers = {
      ...
      (a._getIsSameSortBy = function (b) {
        for (var a = 0; a < b.length; a++)
          if (b[a] != this.sortHistory[a]) return !1;
        return !0;
      }),
      (a._mode = function () {
      ...
      (a.insert = function (e) {
        ...
        if (b.length) {
          var a,
            ...
            c = b.length;
          for (a = 0; a < c; a++)
            (d = b[a]), this.element.appendChild(d.element);
  ...
  (function (a) {
    ...
    var i,
      ...
      D = function (b, d) {
        i.ev.triggerHandler(c + b, d),
          i.st.callbacks &&
            ((b = b.charAt(0).toLowerCase() + b.slice(1)),
            i.st.callbacks[b] &&
              i.st.callbacks[b].apply(i, a.isArray(d) ? d : [d]));
      },
      E = function (b) {
        return (
          (b === n && i.currTemplate.closeBtn) ||
            ((i.currTemplate.closeBtn = a(
              i.st.closeMarkup.replace("%title%", i.st.tClose)
            )),
            (n = b)),
          i.currTemplate.closeBtn
        );
      },
      d = function () {
        a.magnificPopup.instance ||
          ((i = new b()).init(), (a.magnificPopup.instance = i));
      },
      F = function () {
    ...
    (b.prototype = {
      ...
      init: function () {
        ...
        (i.isLowIE = i.isIE8 = document.all && !document.addEventListener),
          (i.isAndroid = /android/gi.test(b)),
          (i.isIOS = /iphone|ipad|ipod/gi.test(b)),
          (i.supportsTransition = F()),
          (i.probablyMobile =
            i.isAndroid ||
            i.isIOS ||
      ...
      open: function (b) {
        if (!1 === b.isObj) {
          (i.items = b.items.toArray()), (i.index = 0);
          var c,
            d,
            h = b.items;
          for (c = 0; c < h.length; c++)
            if (((d = h[c]).parsed && (d = d.el[0]), d === b.el[0])) {
              i.index = c;
              break;
            }
        } else
          (i.items = a.isArray(b.items) ? b.items : [b.items]),
            (i.index = b.index || 0);
        if (i.isOpen) return void i.updateItemHTML();
        (i.types = []),
          (m = ""),
          b.mainEl && b.mainEl.length ? (i.ev = b.mainEl.eq(0)) : (i.ev = k),
          b.key
            ? (i.popupsCache[b.key] || (i.popupsCache[b.key] = {}),
              (i.currTemplate = i.popupsCache[b.key]))
            : (i.currTemplate = {}),
          (i.st = a.extend(!0, {}, a.magnificPopup.defaults, b)),
          (i.fixedContentPos =
            "auto" === i.st.fixedContentPos
              ? !i.probablyMobile
              : i.st.fixedContentPos),
          i.st.modal &&
            ((i.st.closeOnContentClick = !1),
            (i.st.closeOnBgClick = !1),
            (i.st.showCloseBtn = !1),
            (i.st.enableEscapeKey = !1)),
          i.bgOverlay ||
            ((i.bgOverlay = C("bg").on("click" + v, function () {
              i.close();
            })),
            (i.wrap = C("wrap")
              .attr("tabindex", -1)
              .on("click" + v, function (a) {
                i._checkIfClose(a.target) && i.close();
              })),
            (i.container = C("container", i.wrap))),
          (i.contentContainer = C("content")),
          i.st.preloader &&
            (i.preloader = C("preloader", i.container, i.st.tLoading));
        var j = a.magnificPopup.modules;
        for (c = 0; c < j.length; c++) {
          var e = j[c];
          i["init" + (e = e.charAt(0).toUpperCase() + e.slice(1))].call(i);
        }
        D("BeforeOpen"),
          i.st.showCloseBtn &&
            (i.st.closeBtnInside
              ? (B(s, function (c, d, a, b) {
                  a.close_replaceWith = E(b.type);
                }),
                (m += " mfp-close-btn-in"))
              : i.wrap.append(E())),
          i.st.alignTop && (m += " mfp-align-top"),
          i.fixedContentPos
            ? i.wrap.css({
                overflow: i.st.overflowY,
                overflowX: "hidden",
                overflowY: i.st.overflowY,
              })
            : i.wrap.css({ top: A.scrollTop(), position: "absolute" }),
          (!1 !== i.st.fixedBgPos &&
            ("auto" !== i.st.fixedBgPos || i.fixedContentPos)) ||
            i.bgOverlay.css({ height: k.height(), position: "absolute" }),
          i.st.enableEscapeKey &&
            k.on("keyup" + v, function (a) {
              27 === a.keyCode && i.close();
            }),
          A.on("resize" + v, function () {
            i.updateSize();
          }),
          i.st.closeOnContentClick || (m += " mfp-auto-cursor"),
          m && i.wrap.addClass(m);
        var l = (i.wH = A.height()),
          f = {};
        if (i.fixedContentPos && i._hasScrollBar(l)) {
          var n = i._getScrollbarSize();
          n && (f.marginRight = n);
        }
        i.fixedContentPos &&
          (i.isIE7
            ...
            : (f.overflow = "hidden"));
        var g = i.st.mainClass;
        return (
          i.isIE7 && (g += " mfp-ie7"),
          g && i._addClassToMFP(g),
          i.updateItemHTML(),
          D("BuildControls"),
          a("html").css(f),
          i.bgOverlay.add(i.wrap).prependTo(i.st.prependTo || a(document.body)),
          (i._lastFocusedEl = document.activeElement),
          setTimeout(function () {
            i.content
              ? (i._addClassToMFP(w), i._setFocus())
              : i.bgOverlay.addClass(w),
              k.on("focusin" + v, i._onFocusIn);
          }, 16),
          (i.isOpen = !0),
          i.updateSize(l),
          D(t),
      ...
      close: function () {
        i.isOpen &&
          (D(p),
          (i.isOpen = !1),
          i.st.removalDelay && !i.isLowIE && i.supportsTransition
            ? (i._addClassToMFP(x),
              setTimeout(function () {
                i._close();
              }, i.st.removalDelay))
      ...
      _close: function () {
        ...
        if (
          ...
          i.wrap.detach(),
          i.container.empty(),
          i.st.mainClass && (b += i.st.mainClass + " "),
          i._removeClassFromMFP(b),
          i.fixedContentPos)
        ) {
          var c = { marginRight: "" };
          i.isIE7 ? a("body, html").css("overflow", "") : (c.overflow = ""),
            a("html").css(c);
        }
        k.off("keyup" + v + " focusin" + v),
          i.ev.off(v),
          i.wrap.attr("class", "mfp-wrap").removeAttr("style"),
          i.bgOverlay.attr("class", "mfp-bg"),
          i.container.attr("class", "mfp-container"),
          !i.st.showCloseBtn ||
            (i.st.closeBtnInside && !0 !== i.currTemplate[i.currItem.type]) ||
            (i.currTemplate.closeBtn && i.currTemplate.closeBtn.detach()),
          i.st.autoFocusLast && i._lastFocusedEl && a(i._lastFocusedEl).focus(),
          (i.currItem = null),
          (i.content = null),
          (i.currTemplate = null),
          (i.prevHeight = 0),
      ...
      updateSize: function (b) {
        if (i.isIOS) {
          ...
          i.wrap.css("height", a), (i.wH = a);
        } else i.wH = b || A.height();
        i.fixedContentPos || i.wrap.css("height", i.wH), D("Resize");
      },
      updateItemHTML: function () {
        var c = i.items[i.index];
        i.contentContainer.detach(),
          i.content && i.content.detach(),
          c.parsed || (c = i.parseEl(i.index));
        var b = c.type;
        if (
          (D("BeforeChange", [i.currItem ? i.currItem.type : "", b]),
          (i.currItem = c),
          !i.currTemplate[b])
        ) {
          var d = !!i.st[b] && i.st[b].markup;
          D("FirstMarkupParse", d),
            d ? (i.currTemplate[b] = a(d)) : (i.currTemplate[b] = !0);
        }
        l && l !== c.type && i.container.removeClass("mfp-" + l + "-holder");
        var e = i["get" + b.charAt(0).toUpperCase() + b.slice(1)](
          c,
          i.currTemplate[b]
        );
        i.appendContent(e, b),
          ...
          D(u, c),
          (l = c.type),
          i.container.prepend(i.contentContainer),
          D("AfterChange");
      },
        ...
        (i.content = a),
          a
            ? i.st.showCloseBtn &&
              i.st.closeBtnInside &&
              !0 === i.currTemplate[b]
              ? i.content.find(".mfp-close").length || i.content.append(E())
              : (i.content = a)
            : (i.content = ""),
          D(r),
          i.container.addClass("mfp-" + b + "-holder"),
          i.contentContainer.append(i.content);
      },
      parseEl: function (c) {
        var e,
          b = i.items[c];
        if (
          ...
          for (var f = i.types, d = 0; d < f.length; d++)
      ...
      addGroup: function (c, a) {
        var d = function (b) {
          (b.mfpEl = this), i._openClick(b, c, a);
        };
        a || (a = {});
      ...
      _openClick: function (b, e, c) {
        if (
          ...
          if (d) {
            if (a.isFunction(d)) {
              if (!d.call(i)) return !0;
            } else if (A.width() < d) return !0;
          }
          b.type && (b.preventDefault(), i.isOpen && b.stopPropagation()),
            (c.el = a(b.mfpEl)),
      ...
      updateStatus: function (a, b) {
        if (i.preloader) {
          j !== a && i.container.removeClass("mfp-s-" + j),
            b || "loading" !== a || (b = i.st.tLoading);
          var c = { status: a, text: b };
          D("UpdateStatus", c),
            (a = c.status),
            (b = c.text),
            i.preloader.html(b),
            i.preloader.find("a").on("click", function (a) {
              a.stopImmediatePropagation();
            }),
            i.container.addClass("mfp-s-" + a),
            (j = a);
        }
      },
      _checkIfClose: function (b) {
        if (!a(b).hasClass(y)) {
          var c = i.st.closeOnContentClick,
            d = i.st.closeOnBgClick;
          if (
            (c && d) ||
            !i.content ||
            a(b).hasClass("mfp-close") ||
            (i.preloader && b === i.preloader[0])
          )
            return !0;
          if (b === i.content[0] || a.contains(i.content[0], b)) {
            if (c) return !0;
      ...
      _addClassToMFP: function (a) {
        i.bgOverlay.addClass(a), i.wrap.addClass(a);
      },
      _removeClassFromMFP: function (a) {
        this.bgOverlay.removeClass(a), i.wrap.removeClass(a);
      },
      _hasScrollBar: function (a) {
        return (
          (i.isIE7 ? k.height() : document.body.scrollHeight) >
          (a || A.height())
        );
      },
      _setFocus: function () {
        (i.st.focus ? i.content.find(i.st.focus).eq(0) : i.wrap).focus();
      },
      _onFocusIn: function (b) {
        return b.target === i.wrap[0] || a.contains(i.wrap[0], b.target)
          ? void 0
          : (i._setFocus(), !1);
      },
              ...
              if (c.length > 0) {
                ...
                "replaceWith" === g
                  ...
                  ? c.is("img")
                    ? c.attr("src", b)
                    : c.replaceWith(
                        a("<img>").attr("src", b).attr("class", c.attr("class"))
                      )
                  : c.attr(e[1], b);
              }
            } else d.find(v + "-" + f).html(b);
          });
      },
      _getScrollbarSize: function () {
        if (void 0 === i.scrollbarSize) {
          var a = document.createElement("div");
          (a.style.cssText =
            "width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;"),
            document.body.appendChild(a),
            (i.scrollbarSize = a.offsetWidth - a.clientWidth),
            document.body.removeChild(a);
        }
        return i.scrollbarSize;
      },
    }),
      (a.magnificPopup = {
        instance: null,
      ...
      (a.fn.magnificPopup = function (b) {
        ...
        if ("string" == typeof b) {
          if ("open" === b) {
            var e,
              f = z ? c.data("magnificPopup") : c[0].magnificPopup,
            ...
            f.items
              ...
              : ((e = c),
                ...
                (e = e.eq(g))),
              i._openClick({ mfpEl: e }, c, f);
          } else
            i.isOpen && i[b].apply(i, Array.prototype.slice.call(arguments, 1));
        } else
          (b = a.extend(!0, {}, b)),
            z ? c.data("magnificPopup", b) : (c[0].magnificPopup = b),
            i.addGroup(c, b);
        return c;
      });
    var G,
        ...
        getInline: function (c, d) {
          if ((J(), c.src)) {
            ...
            if (b.length) {
              ...
              f &&
                f.tagName &&
                (H || ((H = C((G = e.hiddenClass))), (G = "mfp-" + G)),
                (I = b.after(H).detach().removeClass(G))),
                i.updateStatus("ready");
            } else i.updateStatus("error", e.tNotFound), (b = a("<div>"));
            return (c.inlineElement = b), b;
          }
          return i.updateStatus("ready"), i._parseMarkup(d, {}, c), d;
        },
      },
    });
    var K,
      f = "ajax",
      L = function () {
        K && a(document.body).removeClass(K);
      },
      M = function () {
        L(), i.req && i.req.abort();
      };
    a.magnificPopup.registerModule(f, {
      ...
      proto: {
        ...
        getAjax: function (b) {
          K && a(document.body).addClass(K), i.updateStatus("loading");
          var c = a.extend(
            {
              url: b.src,
              ...
              error: function () {
                L(),
                  ...
                  i.updateStatus(
                    "error",
                    i.st.ajax.tError.replace("%url%", b.src)
                  );
              },
            },
            i.st.ajax.settings
          );
          return (i.req = a.ajax(c)), "";
        },
      },
    });
    var N,
      O = function (b) {
        ...
        var c = i.st.image.titleSrc;
        if (c) {
          if (a.isFunction(c)) return c.call(i, b);
      ...
      proto: {
        initImage: function () {
          ...
          i.types.push("image"),
            ...
            B("Resize" + b, i.resizeImage),
            i.isLowIE && B("AfterChange", i.resizeImage);
        },
        resizeImage: function () {
          var a = i.currItem;
          if (a && a.img && i.st.image.verticalFit) {
            var b = 0;
            i.isLowIE &&
              (b =
                parseInt(a.img.css("padding-top"), 10) +
                parseInt(a.img.css("padding-bottom"), 10)),
              a.img.css("max-height", i.wH - b);
          }
        },
        _onImageHasSize: function (a) {
          a.img &&
            ...
            D("ImageHasSize", a),
            a.imgHidden &&
              (i.content && i.content.removeClass("mfp-loading"),
              (a.imgHidden = !1)));
        },
        ...
        getImage: function (b, c) {
          var j = 0,
            f = function () {
              b &&
                (b.img[0].complete
                  ? (b.img.off(".mfploader"),
                    b === i.currItem &&
                      (i._onImageHasSize(b), i.updateStatus("ready")),
                    (b.hasSize = !0),
                    (b.loaded = !0),
                    D("ImageLoadComplete"))
                  : 200 > ++j
            ...
            g = function () {
              b &&
                ...
                b === i.currItem &&
                  (i._onImageHasSize(b),
                  i.updateStatus("error", h.tError.replace("%url%", b.src))),
                (b.hasSize = !0),
                (b.loaded = !0),
                (b.loadError = !0));
            },
          ...
          if (e.length) {
            ...
            (d.className = "mfp-img"),
              ...
              (b.img = a(d).on("load.mfploader", f).on("error.mfploader", g)),
              (d.src = b.src),
          ...
          return (
            i._parseMarkup(c, { title: O(b), img_replaceWith: b.img }, b),
            i.resizeImage(),
            b.hasSize
              ? (N && clearInterval(N),
                b.loadError
                  ? (c.addClass("mfp-loading"),
                    i.updateStatus("error", h.tError.replace("%url%", b.src)))
                  : (c.removeClass("mfp-loading"), i.updateStatus("ready")),
                c)
              : (i.updateStatus("loading"),
                (b.loading = !0),
                b.hasSize ||
                  ((b.imgHidden = !0),
                  c.addClass("mfp-loading"),
      ...
      proto: {
        initZoom: function () {
          var c,
            b = i.st.zoom,
            a = ".zoom";
          if (b.enabled && i.supportsTransition) {
            var d,
              e,
              f = b.duration,
              g = function (e) {
              ...
              h = function () {
                i.content.css("visibility", "visible");
              };
            B("BuildControls" + a, function () {
              if (i._allowZoom()) {
                if (
                  (clearTimeout(d),
                  i.content.css("visibility", "hidden"),
                  !(c = i._getItemToZoom()))
                )
                  return void h();
                (e = g(c)).css(i._getOffset()),
                  i.wrap.append(e),
                  (d = setTimeout(function () {
                    e.css(i._getOffset(!0)),
                      (d = setTimeout(function () {
                        h(),
                          setTimeout(function () {
                            e.remove(), (c = e = null), D("ZoomAnimationEnded");
                          }, 16);
                      }, f));
                  }, 16));
              }
              ...
              B(p + a, function () {
                if (i._allowZoom()) {
                  if ((clearTimeout(d), (i.st.removalDelay = f), !c)) {
                    if (!(c = i._getItemToZoom())) return;
                    e = g(c);
                  }
                  e.css(i._getOffset(!0)),
                    i.wrap.append(e),
              ...
              B(o + a, function () {
                i._allowZoom() && (h(), e && e.remove(), (c = null));
              });
          }
        },
        _allowZoom: function () {
          return "image" === i.currItem.type;
        },
        _getItemToZoom: function () {
          return !!i.currItem.hasSize && i.currItem.img;
        },
        _getOffset: function (f) {
          var b,
            c = (b = f
              ? i.currItem.img
              : i.st.zoom.opener(i.currItem.el || i.currItem)).offset(),
            e = parseInt(b.css("padding-top"), 10),
            g = parseInt(b.css("padding-bottom"), 10);
          c.top -= a(window).scrollTop() - e;
          var d = {
            width: b.width(),
            height: (z ? b.innerHeight() : b[0].offsetHeight) - g - e,
          };
          return (
            Q()
    ...
    var g = "iframe",
      ...
      S = function (b) {
        if (i.currTemplate[g]) {
          var a = i.currTemplate[g].find("iframe");
          a.length &&
            (b || (a[0].src = R),
            i.isIE8 && a.css("display", b ? "block" : "none"));
        }
      };
            ...
            !!c &&
              ...
              B(t + b, function () {
                c.navigateByImgClick &&
                  i.wrap.on("click" + b, ".mfp-img", function () {
                    return i.items.length > 1 ? (i.next(), !1) : void 0;
                  }),
                  k.on("keydown" + b, function (a) {
                    37 === a.keyCode ? i.prev() : 39 === a.keyCode && i.next();
                  });
              }),
              B("UpdateStatus" + b, function (b, a) {
                a.text &&
                  (a.text = U(a.text, i.currItem.index, i.items.length));
              }),
              B(s + b, function (e, f, b, d) {
                var a = i.items.length;
                b.counter = a > 1 ? U(c.tCounter, d.index, a) : "";
              }),
              B("BuildControls" + b, function () {
                if (i.items.length > 1 && c.arrows && !i.arrowLeft) {
                  var b = c.arrowMarkup,
                    d = (i.arrowLeft = a(
                  ...
                  d.click(function () {
                    ...
                    i.container.append(d.add(e));
                }
              }),
              B(u + b, function () {
                i._preloadTimeout && clearTimeout(i._preloadTimeout),
                  (i._preloadTimeout = setTimeout(function () {
                    i.preloadNearbyImages(), (i._preloadTimeout = null);
                  }, 16));
              }),
              void B(o + b, function () {
                k.off(b),
                  i.wrap.off("click" + b),
                  (i.arrowRight = i.arrowLeft = null);
              }))
          );
        },
        next: function () {
          (i.direction = !0), (i.index = T(i.index + 1)), i.updateItemHTML();
        },
        prev: function () {
          (i.direction = !1), (i.index = T(i.index - 1)), i.updateItemHTML();
        },
        goTo: function (a) {
          (i.direction = a >= i.index), (i.index = a), i.updateItemHTML();
        },
        preloadNearbyImages: function () {
          var a,
            b = i.st.gallery.preload,
            c = Math.min(b[0], i.items.length),
            d = Math.min(b[1], i.items.length);
          for (a = 1; a <= (i.direction ? d : c); a++)
            i._preloadItem(i.index + a);
          for (a = 1; a <= (i.direction ? c : d); a++)
            i._preloadItem(i.index - a);
        },
        _preloadItem: function (c) {
          if (((c = T(c)), !i.items[c].preloaded)) {
            var b = i.items[c];
            b.parsed || (b = i.parseEl(c)),
              D("LazyLoad", b),
              "image" === b.type &&
                (b.img = a('<img class="mfp-img" />')
                  ...
                  .on("error.mfploader", function () {
                    (b.hasSize = !0), (b.loadError = !0), D("LazyLoadError", b);
                  })
                  .attr("src", b.src)),
              (b.preloaded = !0);
          }
        ...
        initRetina: function () {
          if (window.devicePixelRatio > 1) {
            var b = i.st.retina,
              a = b.ratio;
            (a = isNaN(a) ? a() : a) > 1 &&
              (B("ImageHasSize." + h, function (c, b) {
                b.img.css({
                  "max-width": b.img[0].naturalWidth / a,
                  width: "100%",
                });
              }),
              B("ElementParse." + h, function (d, c) {
  ...
  (function (b, a) {
    ...
    var h,
      ...
      ba = function (c, b) {
        try {
          cg(a, c, { value: b, configurable: !0, writable: !0 });
        } catch (d) {
          a[c] = b;
        }
        return b;
      },
      k = a["__core-js_shared__"] || ba("__core-js_shared__", {}),
      C = B(function (a) {
        (a.exports = function (a, b) {
          return k[a] || (k[a] = void 0 !== b ? b : {});
        })("versions", []).push({
          version: "3.22.6",
          mode: "global",
      ...
      b = w
        ...
        : function (a) {
            return (
              a &&
              function () {
                return ae.apply(a, arguments);
              }
            );
          },
      ci = a.TypeError,
      cj = function (a) {
        if (null == a) throw ci("Can't call method on " + a);
        return a;
      },
      ck = a.Object,
      cl = function (a) {
      ...
      cp = b((1).toString),
      bd = function (a) {
        return "Symbol(" + (void 0 === a ? "" : a) + ")_" + cp(++cn + co, 36);
      },
      D = function (a) {
      ...
      x = function (b, c) {
        return arguments.length < 2 ? cq(a[b]) : a[b] && a[b][c];
      },
      _ = x("navigator", "userAgent") || "",
      af = a.process,
      ag = a.Deno,
      ah = (af && af.versions) || (ag && ag.version),
      ai = ah && ah.v8;
    ai && (u = (h = ai.split("."))[0] > 0 && h[0] < 4 ? 1 : +(h[0] + h[1])),
      !u &&
        _ &&
        (!(h = _.match(/Edge\/(\d+)/)) || h[1] >= 74) &&
        (h = _.match(/Chrome\/(\d+)/)) &&
        (u = +h[1]);
    var E = u,
      be =
      ...
      aj = be && !Symbol.sham && "symbol" == typeof Symbol.iterator,
      cr = C("wks"),
      o = a.Symbol,
      cs = o && o.for,
      ct = aj ? o : (o && o.withoutSetter) || bd,
      d = function (a) {
        if (!bc(cr, a) || (!be && "string" != typeof cr[a])) {
          var b = "Symbol." + a;
          be && bc(o, a) ? (cr[a] = o[a]) : (cr[a] = aj && cs ? cs(b) : ct(b));
        }
        return cr[a];
      },
      $ = {};
    $[d("toStringTag")] = "z";
    var F = "[object z]" === String($),
      f = !c(function () {
        return (
          7 !=
      ...
      al = a.document,
      cu = ak(al) && ak(al.createElement),
      bf = function (a) {
        return cu ? al.createElement(a) : {};
      },
      cv =
        !f &&
        !c(function () {
          return (
            7 !=
            Object.defineProperty(bf("div"), "a", {
              get: function () {
                return 7;
              },
            }).a
      ...
      cy = function (a) {
        if (ak(a)) return a;
        throw cx(cw(a) + " is not an object");
      },
      an = Function.prototype.call,
      ao = w
        ? an.bind(an)
        : function () {
            return an.apply(an, arguments);
          },
      cz = b({}.isPrototypeOf),
      cA = a.Object,
      cB = aj
        ...
        : function (b) {
            var a = x("Symbol");
            return D(a) && cz(a.prototype, cA(b));
          },
      cC = a.String,
      cD = function (a) {
        try {
      ...
      cF = function (a) {
        if (D(a)) return a;
        throw cE(cD(a) + " is not a function");
      },
      cG = function (b, c) {
        var a = b[c];
        return null == a ? void 0 : cF(a);
      },
      cH = a.TypeError,
      cI = a.TypeError,
      cJ = d("toPrimitive"),
      cK = function (a, b) {
        if (!ak(a) || cB(a)) return a;
        var c,
          d = cG(a, cJ);
        if (d) {
          if (
        ...
        return (
          ...
          (function (a, d) {
            var b, c;
            if (
              ("string" === d && D((b = a.toString)) && !ak((c = ao(b, a)))) ||
              (D((b = a.valueOf)) && !ak((c = ao(b, a)))) ||
              ("string" !== d && D((b = a.toString)) && !ak((c = ao(b, a))))
            )
              return c;
            throw cH("Can't convert object to primitive value");
          })(a, b)
        );
      },
      cL = function (b) {
      ...
      y = {
        f: f
          ? am
            ? function (c, b, a) {
                if (
                  ...
                  d &&
                    ...
                    (a = {
                      configurable:
                        "configurable" in a ? a.configurable : d.configurable,
                      enumerable:
                        "enumerable" in a ? a.enumerable : d.enumerable,
                      writable: !1,
                    }));
                }
                return bg(c, b, a);
            ...
            : bg
          : function (b, c, a) {
              if ((cy(b), (c = cL(c)), cy(a), cv))
                try {
                  return bg(b, c, a);
                } catch (d) {}
              if ("get" in a || "set" in a) throw cM("Accessors not supported");
      ...
      cP = f
        ? function (a, b, c) {
            return y.f(a, b, cO(1, c));
          }
        : function (a, b, c) {
            return (a[b] = c), a;
          },
      ap = Function.prototype,
      bh = f && Object.getOwnPropertyDescriptor,
      G = bc(ap, "name"),
      H = {
        EXISTS: G,
        PROPER: G && "something" === function () {}.name,
        CONFIGURABLE: G && (!f || (f && bh(ap, "name").configurable)),
      },
      cQ = b(Function.toString);
    D(k.inspectSource) ||
    ...
    var I,
      ...
      bi = k.inspectSource,
      aq = a.WeakMap,
      ar = D(aq) && /native code/.test(bi(aq)),
      cR = C("keys"),
      L = function (a) {
        return cR[a] || (cR[a] = bd(a));
      },
      as = {},
      cS = a.TypeError,
      bj = a.WeakMap;
    if (ar || k.state) {
      var M = k.state || (k.state = new bj()),
        cT = b(M.get),
        cU = b(M.has),
        cV = b(M.set);
      (I = function (a, b) {
        if (cU(M, a)) throw new cS("Object already initialized");
        return (b.facade = a), cV(M, a, b), b;
      }),
        (J = function (a) {
          return cT(M, a) || {};
        }),
      ...
      (as[bk] = !0),
        (I = function (a, b) {
          if (bc(a, bk)) throw new cS("Object already initialized");
          return (b.facade = a), cP(a, bk, b), b;
        }),
        (J = function (a) {
          return bc(a, bk) ? a[bk] : {};
        }),
    ...
    var i = {
        ...
        getterFor: function (a) {
          return function (b) {
            var c;
            if (!ak(b) || (c = J(b)).type !== a)
              throw cS("Incompatible receiver, " + a + " required");
            return c;
          };
        },
      },
      cW = B(function (a) {
        var d = H.CONFIGURABLE,
          e = i.enforce,
          g = i.get,
          ...
          b = (a.exports = function (c, a, b) {
            if (
              ("Symbol(" === String(a).slice(0, 7) &&
                (a = "[" + String(a).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"),
              b && b.getter && (a = "get " + a),
              b && b.setter && (a = "set " + a),
              (!bc(c, "name") || (d && c.name !== a)) &&
                h(c, "name", { value: a, configurable: !0 }),
              j &&
                b &&
                bc(b, "arity") &&
                c.length !== b.arity &&
                h(c, "length", { value: b.arity }),
              b && bc(b, "constructor") && b.constructor)
            ) {
              if (f)
                try {
                  h(c, "prototype", { writable: !1 });
                } catch (i) {}
            } else c.prototype = void 0;
            var g = e(c);
            return (
              bc(g, "source") ||
                (g.source = k.join("string" == typeof a ? a : "")),
              c
            );
          });
        Function.prototype.toString = b(function () {
          return (D(this) && g(this).source) || bi(this);
        }, "toString");
      }),
      at = function (c, b, d, a) {
        a || (a = {});
        var e = a.enumerable,
          f = void 0 !== a.name ? a.name : b;
        return (
          D(d) && cW(d, f, a),
          a.global
            ? e
      ...
      bl = F
        ? {}.toString
        : function () {
            return "[object " + c0(this) + "]";
          };
    F || at(Object.prototype, "toString", bl, { unsafe: !0 });
    var O = {
        CSSRuleList: 0,
      ...
      P = bf("span").classList,
      au = P && P.constructor && P.constructor.prototype,
      av = au === Object.prototype ? void 0 : au,
      c1 = b(b.bind),
      c2 = function (a, b) {
        return (
          cF(a),
      ...
      c3 = b("".split),
      c4 = c(function () {
        return !bm("z").propertyIsEnumerable(0);
      })
        ? function (a) {
            return "String" == N(a) ? c3(a, "") : bm(a);
          }
        : bm,
      c5 = Math.ceil,
      c6 = Math.floor,
      ...
      c8 = function (b) {
        var a = +b;
        return a != a || 0 === a ? 0 : c7(a);
      },
      c9 = Math.min,
      da = function (a) {
        return a > 0 ? c9(c8(a), 9007199254740991) : 0;
      },
      db = function (a) {
        return da(a.length);
      },
      ...
      bn = function () {},
      dd = [],
      bo = x("Reflect", "construct"),
      aw = /^\s*(?:class|function)\b/,
      de = b(aw.exec),
      df = !aw.exec(bn),
      bp = function (a) {
        if (!D(a)) return !1;
    ...
    var dg =
      ...
      dj = function (d, b) {
        var c, a;
        return new (dc((c = d)) &&
          ((dg((a = c.constructor)) && (a === di || dc(a.prototype))) ||
            (ak(a) && null === (a = a[dh]))) &&
          (a = void 0),
        void 0 === a ? di : a)(0 === b ? 0 : b);
      },
      dk = b([].push),
      j = function (a) {
        var c = 1 == a,
        ...
        return function (l, r, s, t) {
          for (
            var j,
              ...
              i = 0,
              q = t || dj,
              k = c ? q(l, p) : d || g ? q(l, 0) : void 0;
            p > i;
            i++
          )
            if ((h || i in n) && ((m = u((j = n[i]), i, o)), a)) {
              if (c) k[i] = m;
              else if (m)
                switch (a) {
                  case 3:
      ...
      dm = ay("forEach")
        ? [].forEach
        : function (a) {
            return dl(this, a, arguments.length > 1 ? arguments[1] : void 0);
          },
      az = function (a) {
        if (a && a.forEach !== dm)
          try {
    ...
    for (var Q in O) O[Q] && az(a[Q] && a[Q].prototype);
    az(av);
    var aA = !(
        "undefined" == typeof window ||
        !window.document ||
      ...
      bq = Object.getOwnPropertyDescriptor,
      dn = {
        f:
          bq && !aB.call({ 1: 2 }, 1)
            ? function (b) {
      ...
      bs = {
        f: f
          ...
          : function (a, b) {
              ...
              if (bc(a, b)) return cO(!ao(dn.f, a, b), a[b]);
            },
      },
      dq = Math.max,
      dr = Math.min,
      ...
      dt = { includes: aC(!0), indexOf: aC(!1) }.indexOf,
      du = b([].push),
      dv = function (f, d) {
        var a,
          c = dp(f),
          e = 0,
          b = [];
        for (a in c) !bc(as, a) && bc(c, a) && du(b, a);
        for (; d.length > e; ) bc(c, (a = d[e++])) && (~dt(b, a) || du(b, a));
        return b;
      },
      bt = [
        "constructor",
      ...
      dx = { f: Object.getOwnPropertySymbols },
      dy = b([].concat),
      dz =
        x("Reflect", "ownKeys") ||
        function (a) {
      ...
      dA = function (c, d, e) {
        for (var f = dz(d), g = y.f, h = bs.f, b = 0; b < f.length; b++) {
          var a = f[b];
          bc(c, a) || (e && bc(e, a)) || g(c, a, h(d, a));
        }
      },
      dB = /#|\.prototype\./,
      p = function (d, a) {
        var b = dD[dC(d)];
        return b == dF || (b != dE && (D(a) ? c(a) : !!a));
      },
      dC = (p.normalize = function (a) {
        return String(a).replace(dB, ".").toLowerCase();
      }),
      dD = (p.data = {}),
      dE = (p.NATIVE = "N"),
      dF = (p.POLYFILL = "P"),
      ...
      q = function (b, h) {
        var f,
          ...
          j = b.global,
          k = b.stat;
        if ((f = j ? a : k ? a[g] || ba(g, {}) : (a[g] || {}).prototype))
          for (c in h) {
            if (
              ((e = h[c]),
              (d = b.dontCallGetSet ? (i = dH(f, c)) && i.value : f[c]),
              !dG(j ? c : g + (k ? "." : "#") + c, b.forced) && void 0 !== d)
            ) {
              if (typeof e == typeof d) continue;
              dA(e, d);
            }
            (b.sham || (d && d.sham)) && cP(e, "sham", !0), at(f, c, e, b);
          }
      },
      dI = a.String,
      dJ = function (a) {
      ...
      S = function (a) {
        return function (c) {
          var b = dJ(cj(c));
          return 1 & a && (b = dK(b, dL, "")), 2 & a && (b = dK(b, dM, "")), b;
        };
      },
      dN = { start: S(1), end: S(2), trim: S(3) }.trim,
      T = a.parseInt,
      aD = a.Symbol,
      bv = aD && aD.iterator,
      bw = /^[+-]?0x/i,
      ...
      aE =
        ...
        (bv &&
          ...
          ? function (b, c) {
              var a = dN(dJ(b));
              return T(a, c >>> 0 || (dO(bw, a) ? 16 : 10));
            }
          : T;
    q({ global: !0, forced: parseInt != aE }, { parseInt: aE });
    var dP =
        Object.keys ||
        function (a) {
          return dv(a, bt);
      ...
      aG =
        ...
        c(function () {
              ...
              aF(
                ...
                aF(
                  dQ({}, "a", {
                    enumerable: !0,
                    get: function () {
                      dQ(this, "b", { value: 3, enumerable: !1 });
                    },
                  }),
                  { b: 2 }
                )
          ...
          return (
            ...
            7 != aF({}, a)[b] ||
              "abcdefghijklmnopqrst" != dP(aF({}, c)).join("")
          );
        })
          ? function (i, m) {
              for (
                var c = cl(i), j = arguments.length, d = 1, e = dx.f, k = dn.f;
                j > d;
                ...
                for (
                  var b,
                    a = c4(arguments[d++]),
                    g = e ? dR(dP(a), e(a)) : dP(a),
                    l = g.length,
                    h = 0;
                  l > h;

                )
                  (b = g[h++]), (f && !ao(k, a, b)) || (c[b] = a[b]);
              return c;
            }
          : aF;
    q(
      { target: "Object", stat: !0, arity: 2, forced: Object.assign !== aG },
      { assign: aG }
    );
    var bx,
      dS = d("species"),
    ...
    q(
      { target: "Array", proto: !0, forced: !by },
      {
        filter: function (a) {
          return dT(this, a, arguments.length > 1 ? arguments[1] : void 0);
        },
      }
    );
    var dU,
      dV = {
        f:
          f && !am
            ...
            : function (a, b) {
                cy(a);
                for (var c, f = dp(b), d = dP(b), g = d.length, e = 0; g > e; )
                  y.f(a, (c = d[e++]), f[c]);
                return a;
              },
      },
      dW = x("document", "documentElement"),
      bz = L("IE_PROTO"),
      dX = function () {},
      dY = function (a) {
      ...
      d$ = function () {
        try {
          dU = new ActiveXObject("htmlfile");
        } catch (b) {}
        d$ =
          "undefined" != typeof document
            ? document.domain && dU
              ? dZ(dU)
              : (((d = bf("iframe")).style.display = "none"),
                dW.appendChild(d),
                (d.src = String("javascript:")),
                (c = d.contentWindow.document).open(),
                c.write(dY("document.F=Object")),
                c.close(),
                c.F)
            : dZ(dU);
        for (var c, d, a = bt.length; a--; ) delete d$.prototype[bt[a]];
        return d$();
      };
    as[bz] = !0;
    var bA =
      ...
      aH = d("unscopables"),
      aI = Array.prototype;
    null == aI[aH] && bB(aI, aH, { configurable: !0, value: bA(null) });
    var l,
      aJ,
      aK,
      U = function (a) {
      ...
      aN = bC
        ...
        : function (c) {
            var a = cl(c);
            if (bc(a, d_)) return a[d_];
            var b = a.constructor;
            return D(b) && a instanceof b
              ? b.prototype
              : a instanceof aM
              ? d0
              : null;
    ...
    [].keys &&
      ("next" in (aK = [].keys())
        ? (aJ = aN(aN(aK))) !== Object.prototype && (l = aJ)
        : (aP = !0)),
      (null == l ||
        c(function () {
          var a = {};
          return l[aO].call(a) !== a;
        })) &&
        (l = {}),
      D(l[aO]) ||
        at(l, aO, function () {
    ...
    var V = { IteratorPrototype: l, BUGGY_SAFARI_ITERATORS: aP },
      d1 = y.f,
      d2 = d("toStringTag"),
      d3 = function (a, b, c) {
        a && !c && (a = a.prototype),
          a && !bc(a, d2) && d1(a, d2, { configurable: !0, value: b });
      },
      d4 = V.IteratorPrototype,
      d5 = function () {
        return this;
      },
      d6 = a.String,
          ...
          ? (function () {
              ...
              return function (a, b) {
                return (
                  cy(a),
                  (function (a) {
                    if ("object" == typeof a || D(a)) return a;
                    throw d7("Can't set " + d6(a) + " as a prototype");
                  })(b),
                  d ? c(a, b) : (a.__proto__ = b),
                  a
                );
              };
            })()
      ...
      d9 = H.PROPER,
      ea = H.CONFIGURABLE,
      eb = V.IteratorPrototype,
      ec = V.BUGGY_SAFARI_ITERATORS,
      ed = d("iterator"),
      ee = function () {
        return this;
      },
      aQ = function (k, d, m, n, c, o, p) {
        (s = m),
          (t = d),
          (u = n),
          (v = t + " Iterator"),
          (s.prototype = bA(d4, { next: cO(1, u) })),
          d3(s, v, !1),
          (aL[v] = d5);
        var s,
          t,
          ...
          j = !1,
          a = k.prototype,
          i = a[ed] || a["@@iterator"] || (c && a[c]),
          f = (!ec && i) || h(c),
          l = ("Array" == d && a.entries) || i;
        if (
          (l &&
            (b = aN(l.call(new k()))) !== Object.prototype &&
            b.next &&
            (aN(b) !== eb && (d8 ? d8(b, eb) : D(b[ed]) || at(b, ed, ee)),
            d3(b, r, !0)),
          d9 &&
            "values" == c &&
            i &&
          ...
          if (
            ...
            for (g in e) (!ec && !j && g in a) || at(a, g, e[g]);
          else q({ target: d, proto: !0, forced: ec || j }, e);
        }
        return a[ed] !== f && at(a, ed, f, { name: c }), (aL[d] = f), e;
      },
      bD = y.f,
      ef = i.set,
      eg = i.getterFor("Array Iterator"),
      bE = aQ(
        Array,
        "Array",
        function (a, b) {
        ...
        function () {
          var b = eg(this),
            ...
            a = b.index++;
          return !c || a >= c.length
            ? ((b.target = void 0), { value: void 0, done: !0 })
            : "keys" == d
            ? { value: a, done: !1 }
            : "values" == d
            ? { value: c[a], done: !1 }
      ...
      aR = (aL.Arguments = aL.Array);
    if ((U("keys"), U("values"), U("entries"), f && "values" !== aR.name))
      try {
        bD(aR, "name", { value: "values" });
      } catch (eh) {}
    var ei = b("".charAt),
      ej = b("".charCodeAt),
      ek = b("".slice),
      ...
      aT = { codeAt: aS(!1), charAt: aS(!0) },
      el = aT.charAt,
      em = i.set,
      en = i.getterFor("String Iterator");
    aQ(
      String,
      "String",
      function (a) {
        em(this, { type: "String Iterator", string: dJ(a), index: 0 });
      },
      function () {
        var a,
          b = en(this),
        ...
        return d >= c.length
          ? { value: void 0, done: !0 }
          : ((a = el(c, d)), (b.index += a.length), { value: a, done: !1 });
      }
    );
    var bF = function (a, b, d) {
        for (var c in b) at(a, c, b[c], d);
        return a;
      },
      eo = a.Array,
      ep = Math.max,
          ...
          return (function (h, l, i) {
            for (
              ...
              (a = f),
                ...
                (d = h[c]),
                (b = void 0),
                (b = cL(j)) in a ? y.f(a, b, cO(0, d)) : (a[b] = d);
            return (f.length = g), f;
          })(er);
        }
      },
      et = {
        f: function (a) {
          return er && "Window" == N(a) ? es(a) : eq(dp(a));
        },
      },
      bG = c(function () {
      ...
      eu =
        c(function () {
          ...
          ? function (a) {
              return (
                !!ak(a) && (!bG || "ArrayBuffer" != N(a)) && (!bH || bH(a))
              );
            }
          : bH,
      ev = !c(function () {
      ...
      m = B(function (a) {
        var d = y.f,
          ...
          f = 0,
          g = function (a) {
            d(a, c, { value: { objectID: "O" + f++, weakData: {} } });
          },
          h = (a.exports = {
            enable: function () {
              ...
              (a[c] = 1),
                d(a).length &&
                  ((bu.f = function (e) {
                    for (var a = d(e), b = 0, g = a.length; b < g; b++)
                      if (a[b] === c) {
                        f(a, b, 1);
                        break;
                      }
            ...
            onFreeze: function (a) {
              return ev && e && eu(a) && !bc(a, c) && g(a), a;
            },
          });
        as[c] = !0;
      }),
      ew = (m.enable, m.fastKey, m.getWeakData, m.onFreeze, d("iterator")),
      ex = Array.prototype,
      ey = d("iterator"),
      ez = function (a) {
        if (null != a) return cG(a, ey) || cG(a, "@@iterator") || aL[c0(a)];
      },
      eA = a.TypeError,
      eB = function (c, d, b) {
        var a, e;
      ...
      eE = function (c, l, a) {
        var d,
          ...
          r = c2(l, m),
          s = function (a) {
            return d && eB(d, "normal", a), new bI(!0, a);
          },
          k = function (a) {
            return p
              ? (cy(a), q ? r(a[0], a[1], s) : r(a[0], a[1]))
              : q
              ? r(a, s)
              : r(a);
          };
        if (n) d = c;
          ...
          if (!(f = ez(c))) throw eC(cD(c) + " is not iterable");
          if (void 0 !== (g = f) && (aL.Array === g || ex[ew] === g)) {
            for (e = 0, h = db(c); h > e; e++)
              if ((b = k(c[e])) && cz(eD, b)) return b;
            return new bI(!1);
          }
          d = (function (a, c) {
            var b = arguments.length < 2 ? ez(a) : c;
            if (cF(b)) return cy(ao(b, a));
            throw eA(cD(a) + " is not iterable");
          })(c, f);
        }
        for (i = d.next; !(j = ao(i, d)).done; ) {
          try {
            b = k(j.value);
          } catch (o) {
            eB(d, "throw", o);
          }
          if ("object" == typeof b && b && cz(eD, b)) return b;
        }
        return new bI(!1);
      },
      eF = a.TypeError,
    ...
    try {
      ...
      (aU[bJ] = function () {
        ...
        Array.from(aU, function () {
          throw 2;
        });
    } catch (eJ) {}
    var eK = m.getWeakData,
      eL = i.set,
      eM = i.getterFor,
      eN = z.find,
      eO = z.findIndex,
      ...
      eQ = 0,
      eR = function (a) {
        return a.frozen || (a.frozen = new bK());
      },
      bK = function () {
        this.entries = [];
      },
      eS = function (a, b) {
        return eN(a.entries, function (a) {
          return a[0] === b;
        });
      };
    bK.prototype = {
      ...
      delete: function (b) {
        var a = eO(this.entries, function (a) {
          return a[0] === b;
        });
        return ~a && eP(this.entries, a, 1), !!~a;
      },
    };
    var bL,
      aV = {
        getConstructor: function (c, d, e, f) {
          var a = c(function (a, c) {
              eG(a, b),
                eL(a, { type: d, id: eQ++, frozen: void 0 }),
                null != c && eE(c, a[f], { that: a, AS_ENTRIES: e });
            }),
            b = a.prototype,
            g = eM(d),
            h = function (a, b, c) {
              var d = g(a),
                e = eK(cy(b), !0);
              return !0 === e ? eR(d).set(b, c) : (e[d.id] = c), a;
            };
          return (
            bF(b, {
              delete: function (b) {
                ...
                return !0 === a
                  ? eR(c).delete(b)
                  : a && bc(a, c.id) && delete a[c.id];
              },
              has: function (a) {
                var c = g(this);
                if (!ak(a)) return !1;
                var b = eK(a);
                return !0 === b ? eR(c).has(a) : b && bc(b, c.id);
              },
            }),
            bF(
              b,
              e
                ? {
                    get: function (a) {
                      ...
                      if (ak(a)) {
                        var b = eK(a);
                        return !0 === b ? eR(c).get(a) : b ? b[c.id] : void 0;
                      }
                    },
                    set: function (a, b) {
                      return h(this, a, b);
      ...
      eT = i.enforce,
      bM = !a.ActiveXObject && "ActiveXObject" in a,
      aW = function (a) {
        return function () {
      ...
      bN = (function (d, l, n) {
        var i = -1 !== d.indexOf("Map"),
          ...
          j = function (a) {
            ...
            at(
              ...
              "add" == a
                ? function (a) {
                    return c(this, 0 === a ? 0 : a), this;
                  }
                : "delete" == a
                ? function (a) {
                    return !(f && !ak(a)) && c(this, 0 === a ? 0 : a);
                  }
                : "get" == a
                ? function (a) {
                    return f && !ak(a) ? void 0 : c(this, 0 === a ? 0 : a);
                  }
                : "has" == a
                ? function (a) {
                    return !(f && !ak(a)) && c(this, 0 === a ? 0 : a);
        ...
        if (
          ...
          (e = n.getConstructor(l, d, i, k)), m.enable();
        else if (dG(d, !0)) {
          var p = new e(),
            s = p[k](f ? {} : -0, 1) != p,
            t = c(function () {
              ...
              var a,
                ...
                f =
                  ...
                  d8 &&
                    ...
                    d8(a, d),
                  a);
              return null != l && eE(l, f[k], { that: f, AS_ENTRIES: i }), f;
            })).prototype = h),
            (h.constructor = e)),
            (t || r) && (j("delete"), j("has"), i && j("get")),
            (r || s) && j(k),
            f && h.clear && delete h.clear;
        }
        return (
          (o[d] = e),
          q({ global: !0, constructor: !0, forced: e != g }, o),
          d3(e, d),
          f || n.setStrong(e, d, i),
          e
        );
    ...
    if (ar && bM) {
      (bL = aV.getConstructor(aW, "WeakMap", !0)), m.enable();
      var r = bN.prototype,
        eU = b(r.delete),
        eV = b(r.has),
        eW = b(r.get),
      ...
      bF(r, {
        delete: function (a) {
          if (ak(a) && !eu(a)) {
            var b = eT(this);
            return (
              b.frozen || (b.frozen = new bL()),
              eU(this, a) || b.frozen.delete(a)
            );
          }
          return eU(this, a);
        },
        has: function (a) {
          if (ak(a) && !eu(a)) {
            var b = eT(this);
            return (
              b.frozen || (b.frozen = new bL()), eV(this, a) || b.frozen.has(a)
            );
          }
          return eV(this, a);
        },
        get: function (a) {
          if (ak(a) && !eu(a)) {
            ...
            return (
              b.frozen || (b.frozen = new bL()),
              eV(this, a) ? eW(this, a) : b.frozen.get(a)
            );
          }
          return eW(this, a);
        },
        set: function (a, b) {
          if (ak(a) && !eu(a)) {
            var c = eT(this);
            c.frozen || (c.frozen = new bL()),
              eV(this, a) ? eX(this, a, b) : c.frozen.set(a, b);
          } else eX(this, a, b);
          return this;
        },
      });
    ...
    for (var W in O) aX(a[W] && a[W].prototype, W);
    aX(av, "DOMTokenList");
    var e_ = /^\s+|\s+$/g,
      e0 = /^[-+]0x[0-9a-f]+$/i,
      e1 = /^0b[01]+$/i,
      e2 = /^0o[0-7]+$/i,
      e3 = parseInt,
      bO = "object" == typeof e && e && e.Object === Object && e,
      bP = "object" == typeof self && self && self.Object === Object && self,
      e4 = bO || bP || Function("return this")(),
      e5 = Object.prototype.toString,
      e6 = Math.max,
      e7 = Math.min,
      e8 = function () {
        return e4.Date.now();
    ...
    function e9(f, b, a) {
      ...
      function o(a) {
        var b = i,
          c = j;
        return (i = j = void 0), (n = a), (k = f.apply(c, b));
      }
      function p(a) {
        return (n = a), (l = setTimeout(r, b)), g ? o(a) : k;
      }
      function q(a) {
        var c = a - m;
        return void 0 === m || c >= b || c < 0 || (h && a - n >= d);
      }
      function r() {
        var e,
          a,
        ...
        l = setTimeout(
          r,
          ((a = b - ((e = c) - m)), h ? e7(a, d - (e - n)) : a)
        );
      }
      function s(a) {
        return (l = void 0), e && i ? o(a) : ((i = j = void 0), k);
      }
      function c() {
        var a = e8(),
          c = q(a);
        if (((i = arguments), (j = this), (m = a), c)) {
          if (void 0 === l) return p(m);
          if (h) return (l = setTimeout(r, b)), o(m);
        }
        return void 0 === l && (l = setTimeout(r, b)), k;
      }
      return (
        (b = fb(b) || 0),
        fa(a) &&
          ((g = !!a.leading),
          (d = (h = "maxWait" in a) ? e6(fb(a.maxWait) || 0, b) : d),
          (e = "trailing" in a ? !!a.trailing : e)),
        (c.cancel = function () {
          void 0 !== l && clearTimeout(l), (n = 0), (i = m = j = l = void 0);
        }),
        (c.flush = function () {
          return void 0 === l ? k : s(e8());
        }),
        c
      );
    }
    ...
    function fb(a) {
      ...
      if (
        "symbol" == typeof (d = a) ||
        ((e = d) && "object" == typeof e && "[object Symbol]" == e5.call(d))
      )
        return NaN;
      if (fa(a)) {
        var d,
    ...
    var fc = function (d, e, a) {
        ...
        return (
          ...
          e9(d, e, { leading: b, maxWait: e, trailing: c })
        );
      },
      fd = /^\s+|\s+$/g,
      fe = /^[-+]0x[0-9a-f]+$/i,
      ...
      fg = /^0o[0-7]+$/i,
      fh = parseInt,
      bQ = "object" == typeof e && e && e.Object === Object && e,
      bR = "object" == typeof self && self && self.Object === Object && self,
      fi = bQ || bR || Function("return this")(),
    ...
    function fo(a) {
      ...
      if (
        "symbol" == typeof (d = a) ||
        ((e = d) && "object" == typeof e && "[object Symbol]" == fj.call(d))
      )
        return NaN;
      if (fn(a)) {
        var d,
    ...
    var aY,
      fp = function (f, b, a) {
        ...
        return (
          ...
          fn(a) &&
            ((g = !!a.leading),
            (d = (h = "maxWait" in a) ? fk(fo(a.maxWait) || 0, b) : d),
            (e = "trailing" in a ? !!a.trailing : e)),
          (c.cancel = function () {
            void 0 !== l && clearTimeout(l), (n = 0), (i = m = j = l = void 0);
          }),
          (c.flush = function () {
            return void 0 === l ? k : s(fm());
          }),
          c
        );
      },
      fq = /^\[object .+?Constructor\]$/,
      bS = "object" == typeof e && e && e.Object === Object && e,
      bT = "object" == typeof self && self && self.Object === Object && self,
      aZ = bS || bT || Function("return this")(),
      bU = Array.prototype,
      bV = Function.prototype,
      a$ = Object.prototype,
      X = aZ["__core-js_shared__"],
      fr = (aY = /[^.]+$/.exec((X && X.keys && X.keys.IE_PROTO) || ""))
        ? "Symbol(src)_1." + aY
        : "",
      bW = bV.toString,
      bX = a$.hasOwnProperty,
    ...
    function fx(d, e) {
      for (var a, b, c = d.length; c--; )
        if ((a = d[c][0]) === (b = e) || (a != a && b != b)) return c;
      return -1;
    }
    function fy(a) {
      var b, c, d;
      return (
        !(!fB(a) || ((b = a), fr && fr in b)) &&
        ("[object Function]" == (d = fB((c = a)) ? fs.call(c) : "") ||
    ...
    function fz(e, c) {
      ...
      return (
        ...
        ? d["string" == typeof c ? "string" : "hash"]
        : d.map;
    }
    function fA(d, e) {
      var a,
        b,
        c = ((a = d), (b = e), null == a ? void 0 : a[b]);
      return fy(c) ? c : void 0;
    }
    function a_(c, a) {
      if ("function" != typeof c || (a && "function" != typeof a))
        throw new TypeError("Expected a function");
      var b = function () {
        var d = arguments,
          e = a ? a.apply(this, d) : d[0],
          f = b.cache;
        if (f.has(e)) return f.get(e);
        var g = c.apply(this, d);
        return (b.cache = f.set(e, g)), g;
      };
      return (b.cache = new (a_.Cache || n)()), b;
    }
    function fB(a) {
      var b = typeof a;
      return !!a && ("object" == b || "function" == b);
    ...
    (s.prototype.clear = function () {
      ...
      (s.prototype.get = function (a) {
        ...
        return bX.call(b, a) ? b[a] : void 0;
      }),
      (s.prototype.has = function (a) {
        var b = this.__data__;
        return fw ? void 0 !== b[a] : bX.call(b, a);
      }),
      (s.prototype.set = function (b, a) {
        return (
          (this.__data__[b] =
            fw && void 0 === a ? "__lodash_hash_undefined__" : a),
          this
        );
      }),
      ...
      (t.prototype.delete = function (c) {
        var a = this.__data__,
          b = fx(a, c);
        return !(b < 0) && (b == a.length - 1 ? a.pop() : fu.call(a, b, 1), !0);
      }),
      ...
      (t.prototype.has = function (a) {
        return fx(this.__data__, a) > -1;
      }),
      (t.prototype.set = function (b, c) {
        var a = this.__data__,
          d = fx(a, b);
        return d < 0 ? a.push([b, c]) : (a[d][1] = c), this;
      }),
      ...
      (n.prototype.delete = function (a) {
        return fz(this, a).delete(a);
      }),
      (n.prototype.get = function (a) {
        return fz(this, a).get(a);
      }),
      (n.prototype.has = function (a) {
        return fz(this, a).has(a);
      }),
      (n.prototype.set = function (a, b) {
        return fz(this, a).set(a, b), this;
      }),
      (a_.Cache = n);
    var a0,
      Y,
      fC = a_,
      fD = [],
      fE = "ResizeObserver loop completed with undelivered notifications.";
    ((Y = a0 || (a0 = {})).BORDER_BOX = "border-box"),
      (Y.CONTENT_BOX = "content-box"),
      (Y.DEVICE_PIXEL_CONTENT_BOX = "device-pixel-content-box");
    var fF,
      bY = function (a) {
        return Object.freeze(a);
      },
      fG = function (a, b) {
        (this.inlineSize = a), (this.blockSize = b), bY(this);
      },
      bZ = (function () {
        function a(a, b, c, d) {
          return (
      ...
      fI = function (a) {
        ...
        var c = a,
          f = c.offsetWidth,
          g = c.offsetHeight;
        return !(f || g || a.getClientRects().length);
      },
      fJ = function (a) {
        ...
        var b,
          ...
          d =
            null ===
              (c =
                null === (b = a) || void 0 === b ? void 0 : b.ownerDocument) ||
            void 0 === c
              ? void 0
              : c.defaultView;
        return !!(d && a instanceof d.Element);
      },
      a1 = "undefined" != typeof window ? window : {},
      fK = new WeakMap(),
      fL = /auto|scroll/,
      fM = /^tb|vertical/,
      fN = /msie|trident/i.test(a1.navigator && a1.navigator.userAgent),
      fO = function (a) {
      ...
      fP = bY({
        ...
        borderBoxSize: Z(),
        contentBoxSize: Z(),
        contentRect: new bZ(0, 0, 0, 0),
      }),
      fQ = function (c, f) {
        if ((void 0 === f && (f = !1), fK.has(c) && !f)) return fK.get(c);
        if (fI(c)) return fK.set(c, fP), fP;
        var a = getComputedStyle(c),
          b = fH(c) && c.ownerSVGElement && c.getBBox(),
          j = !fN && "border-box" === a.boxSizing,
          g = fM.test(a.writingMode || ""),
          r = !b && fL.test(a.overflowY || ""),
          s = !b && fL.test(a.overflowX || ""),
          k = b ? 0 : fO(a.paddingTop),
          t = b ? 0 : fO(a.paddingRight),
          u = b ? 0 : fO(a.paddingBottom),
          l = b ? 0 : fO(a.paddingLeft),
          v = b ? 0 : fO(a.borderTopWidth),
          w = b ? 0 : fO(a.borderRightWidth),
          x = b ? 0 : fO(a.borderBottomWidth),
          m = l + t,
          n = k + u,
          h = (b ? 0 : fO(a.borderLeftWidth)) + w,
          i = v + x,
          o = s ? c.offsetHeight - i - c.clientHeight : 0,
          p = r ? c.offsetWidth - h - c.clientWidth : 0,
          y = j ? m + h : 0,
          z = j ? n + i : 0,
          d = b ? b.width : fO(a.width) - y - p,
          e = b ? b.height : fO(a.height) - z - o,
          A = d + m + p + h,
          B = e + n + o + i,
          q = bY({
            devicePixelContentBoxSize: Z(
            ...
            borderBoxSize: Z(A, B, g),
            contentBoxSize: Z(d, e, g),
            contentRect: new bZ(l, k, d, e),
          });
        return fK.set(c, q), q;
      },
      fR = function (b, c, d) {
        var a = fQ(b, d),
          e = a.borderBoxSize,
          f = a.contentBoxSize,
          g = a.devicePixelContentBoxSize;
        switch (c) {
          case a0.DEVICE_PIXEL_CONTENT_BOX:
            return g;
          case a0.BORDER_BOX:
            return e;
          default:
      ...
      fS = function (b) {
        ...
        (this.target = b),
          ...
          (this.borderBoxSize = bY([a.borderBoxSize])),
          (this.contentBoxSize = bY([a.contentBoxSize])),
          (this.devicePixelContentBoxSize = bY([a.devicePixelContentBoxSize]));
      },
      fT = function (b) {
        if (fI(b)) return 1 / 0;
        for (var c = 0, a = b.parentNode; a; ) (c += 1), (a = a.parentNode);
        return c;
      },
      fU = function () {
        var c = 1 / 0,
        ...
        fD.forEach(function (a) {
          if (0 !== a.activeTargets.length) {
            var b = [];
            a.activeTargets.forEach(function (a) {
              var e = new fS(a.target),
                d = fT(a.target);
              b.push(e),
                (a.lastReportedSize = fR(a.target, a.observedBox)),
                d < c && (c = d);
            }),
              d.push(function () {
                a.callback.call(a.observer, b, a.observer);
              }),
              a.activeTargets.splice(0, a.activeTargets.length);
          }
        });
        for (var a = 0, b = d; a < b.length; a++) (0, b[a])();
        return c;
      },
      fV = function (a) {
        fD.forEach(function (b) {
          b.activeTargets.splice(0, b.activeTargets.length),
            ...
            b.observationTargets.forEach(function (c) {
              c.isActive() &&
                (fT(c.target) > a
                  ? b.activeTargets.push(c)
                  : b.skippedTargets.push(c));
            });
        });
      },
      fW = function () {
        ...
        return (
          fD.some(function (a) {
            ...
            ("function" == typeof ErrorEvent
              ? (a = new ErrorEvent("error", { message: fE }))
              : ((a = document.createEvent("Event")).initEvent("error", !1, !1),
                (a.message = fE)),
      ...
      fY = function (a) {
        if (!fF) {
          ...
          new MutationObserver(function () {
            return fX.splice(0).forEach(function (a) {
              return a();
            });
      ...
      fZ = 0,
      f$ = { attributes: !0, characterData: !0, childList: !0, subtree: !0 },
      f_ = [
        "resize",
        "load",
        "transitionend",
      ...
      f2 = new ((function () {
        ...
        return (
            ...
            if ((void 0 === a && (a = 250), !f1)) {
              ...
              (b = function () {
                ...
                try {
                  ...
                  if (((f1 = !1), (a = d - f0()), !fZ)) return;
                  b ? c.run(1e3) : a > 0 ? c.run(a) : c.start();
                }
              }),
                fY(function () {
          ...
          (a.prototype.observe = function () {
            var b = this,
              a = function () {
                return b.observer && b.observer.observe(document.body, f$);
              };
            document.body ? a() : a1.addEventListener("DOMContentLoaded", a);
          }),
          (a.prototype.start = function () {
            ...
            this.stopped &&
              ...
              this.observe(),
              f_.forEach(function (b) {
                return a1.addEventListener(b, a.listener, !0);
              }));
          }),
          (a.prototype.stop = function () {
            var a = this;
            this.stopped ||
              ...
              f_.forEach(function (b) {
                return a1.removeEventListener(b, a.listener, !0);
              }),
              (this.stopped = !0));
          }),
          a
      ...
      f3 = function (a) {
        !fZ && a > 0 && f2.start(), (fZ += a) || f2.stop();
      },
      f4 = (function () {
        function a(a, b) {
          (this.target = a),
            (this.observedBox = b || a0.CONTENT_BOX),
            (this.lastReportedSize = { inlineSize: 0, blockSize: 0 });
        }
        return (
          (a.prototype.isActive = function () {
            var a,
              b = fR(this.target, this.observedBox, !0);
            return (
              fH((a = this.target)) ||
                (function (a) {
                  switch (a.tagName) {
                ...
                (this.lastReportedSize = b),
              this.lastReportedSize.inlineSize !== b.inlineSize ||
                this.lastReportedSize.blockSize !== b.blockSize
            );
          }),
          a
        );
      ...
      f6 = new WeakMap(),
      f7 = function (b, c) {
        for (var a = 0; a < b.length; a += 1) if (b[a].target === c) return a;
        return -1;
      },
      f8 = (function () {
        function a() {}
        return (
          ...
          (a.observe = function (d, b, c) {
            var a = f6.get(d),
              e = 0 === a.observationTargets.length;
            0 > f7(a.observationTargets, b) &&
              (e && fD.push(a),
              a.observationTargets.push(new f4(b, c && c.box)),
              f3(1),
              f2.schedule());
          }),
          (a.unobserve = function (c, d) {
            var a = f6.get(c),
              b = f7(a.observationTargets, d),
              e = 1 === a.observationTargets.length;
            b >= 0 &&
              (e && fD.splice(fD.indexOf(a), 1),
              a.observationTargets.splice(b, 1),
              f3(-1));
          }),
          (a.disconnect = function (b) {
            var c = this,
              a = f6.get(b);
            a.observationTargets.slice().forEach(function (a) {
              return c.unobserve(b, a.target);
            }),
              a.activeTargets.splice(0, a.activeTargets.length);
          }),
          a
        ...
        return function (i, h, j, c) {
          ...
          if (j < 2)
            for (;;) {
              ...
              if (((b += g), a ? b < 0 : f <= b))
                throw ga("Reduce of empty array with no initial value");
            }
          for (; a ? b >= 0 : f > b; b += g) b in d && (c = h(c, d[b], b, e));
          return c;
        };
      },
      b$ = { left: a2(!1), right: a2(!0) },
      b_ = "process" == N(a.process),
      gb = b$.left,
      b0 = ay("reduce");
    q(
      { target: "Array", proto: !0, forced: !b0 || (!b_ && E > 79 && E < 83) },
      {
        reduce: function (b) {
          var a = arguments.length;
          return gb(this, b, a, a > 1 ? arguments[1] : void 0);
        },
      }
    );
    var a3,
      ...
      gg = i.get,
      gh = C("native-string-replace", String.prototype.replace),
      ac = RegExp.prototype.exec,
      a4 = ac,
      gi = b("".charAt),
      gj = b("".indexOf),
      gk = b("".replace),
        ...
        if (
          (k &&
            ...
            b.lastIndex > 0 &&
              ...
              ((h = "(?: " + h + ")"), (i = " " + i), l++),
            (d = new RegExp("^(?:" + h + ")", c))),
          b7 && (d = new RegExp("^" + h + "$(?!\\s)", c)),
          b5 && (n = b.lastIndex),
          (a = ao(ac, k ? d : b, i)),
          k
            ? a
              ? ((a.input = gl(a.input, l)),
                (a[0] = gl(a[0], l)),
                (a.index = b.lastIndex),
                (b.lastIndex += a[0].length))
              : (b.lastIndex = 0)
            : b5 && a && (b.lastIndex = b.global ? a.index + a[0].length : n),
          b7 &&
            a &&
            a.length > 1 &&
            ao(gh, a[0], d, function () {
              for (e = 1; e < arguments.length - 2; e++)
                void 0 === arguments[e] && (a[e] = void 0);
            }),
          a && j)
        )
          for (a.groups = o = bA(null), e = 0; e < j.length; e++)
            o[(p = j[e])[0]] = a[p[1]];
        return a;
      });
    var a5 = a4;
    q({ target: "RegExp", proto: !0, forced: /./.exec !== a5 }, { exec: a5 });
    var gm = d("species"),
      gn = RegExp.prototype,
      a6 = function (e, h, i, j) {
        var a = d(e),
        ...
        if (!f || !k || i) {
          var l = b(/./[a]),
            g = h(a, ""[e], function (g, a, c, d, h) {
              var i = b(g),
                e = a.exec;
              return e === a5 || e === gn.exec
                ? f && !h
                  ? { done: !0, value: l(a, c, d) }
                  : { done: !0, value: i(c, a, d) }
                : { done: !1 };
            });
          at(String.prototype, e, g[0]), at(gn, a, g[1]);
        }
        j && cP(gn[a], "sham", !0);
      },
      go = aT.charAt,
      gp = function (b, a, c) {
        return a + (c ? go(b, a).length : 1);
      },
      gq = a.TypeError,
      gr = function (a, c) {
        var d = a.exec;
        if (D(d)) {
          var b = ao(d, a, c);
          return null !== b && cy(b), b;
        }
        if ("RegExp" === N(a)) return ao(a5, a, c);
        throw gq("RegExp#exec called on incompatible receiver");
      };
    a6("match", function (a, b, c) {
      return [
        function (b) {
          var c = cj(this),
            d = null == b ? void 0 : cG(b, a);
          return d ? ao(d, b, c) : new RegExp(b)[a](dJ(c));
        },
        function (j) {
          var a = cy(this),
            d = dJ(j),
          ...
          if (!a.global) return gr(a, d);
          var k = a.unicode;
          a.lastIndex = 0;
          for (var g, h = [], e = 0; null !== (g = gr(a, d)); ) {
            var i = dJ(g[0]);
            (h[e] = i),
              "" === i && (a.lastIndex = gp(d, da(a.lastIndex), k)),
              e++;
          }
          return 0 === e ? null : h;
        },
    ...
    f &&
      ...
      b9(a7, "name", {
        ...
        get: function () {
          try {
            return gt(ca, gs(this))[1];
          } catch (a) {
            return "";
          }
        },
      });
    var a8 = Function.prototype,
      cb = a8.apply,
      cc = a8.call,
      gu =
      ...
      gz = /\$([$&'`]|\d{1,2}|<[^>]*>)/g,
      gA = /\$([$&'`]|\d{1,2})/g,
      gB = function (c, g, d, e, a, f) {
        var h = d + c.length,
          i = e.length,
          b = gA;
        return (
          void 0 !== a && ((a = cl(a)), (b = gz)),
          gx(f, b, function (l, b) {
            var f;
            switch (gw(b, 0)) {
              case "$":
    ...
    a6(
      ...
      function (a, b, c) {
        ...
        return [
          function (a, c) {
            var d = cj(this),
              e = null == a ? void 0 : cG(a, a9);
            return e ? ao(e, a, d, c) : ao(b, dJ(d), a, c);
          },
          function (w, a) {
            var g = cy(this),
              e = dJ(w);
            if ("string" == typeof a && -1 === gG(a, d) && -1 === gG(a, "$<")) {
              var q = c(b, g, e, a);
            ...
            for (var j = []; ; ) {
              var f = gr(g, e);
              if (null === f || (gF(j, f), !s)) break;
              "" === dJ(f[0]) && (g.lastIndex = gp(e, da(g.lastIndex), x));
            }
            for (var k, t = "", i = 0, l = 0; l < j.length; l++) {
              for (
                var m = dJ((f = j[l])[0]),
                  h = gC(gD(c8(f.index), e.length), 0),
                  n = [],
                  o = 1;
                o < f.length;
                o++
              )
                gF(n, void 0 === (k = f[o]) ? k : String(k));
              var p = f.groups;
              if (r) {
                var u = gE([m], n, h, e);
                void 0 !== p && gF(u, p);
                var v = dJ(gu(a, void 0, u));
              } else v = gB(m, e, h, n, p, a);
              h >= i && ((t += gH(e, i, h) + v), (i = h + m.length));
            }
            return t + gH(e, i);
          },
        ];
    ...
    var cf = function (a) {
      return Array.prototype.reduce.call(
        a,
        function (a, b) {
          var d = b.name.match(/data-simplebar-(.+)/);
          if (d) {
            var c = d[1].replace(/\W+(.)/g, function (b, a) {
    ...
    function gM(d) {
      if (null === gK) {
        var b = gJ(d);
        if (void 0 === b) return (gK = 0);
        var c = b.body,
          a = b.createElement("div");
        a.classList.add("simplebar-hide-scrollbar"), c.appendChild(a);
        var e = a.getBoundingClientRect().right;
        c.removeChild(a), (gK = e);
      }
      return gK;
    }
    aA &&
      window.addEventListener("resize", function () {
        gL !== window.devicePixelRatio &&
          ((gL = window.devicePixelRatio), (gK = null));
      });
    var g = (function () {
      function b(a, c) {
        var d = this;
        (this.onScroll = function () {
          var a = gI(d.el);
          d.scrollXTicking ||
            (a.requestAnimationFrame(d.scrollX), (d.scrollXTicking = !0)),
            d.scrollYTicking ||
              (a.requestAnimationFrame(d.scrollY), (d.scrollYTicking = !0));
        }),
          ...
          (this.scrollY = function () {
            d.axis.y.isOverflowing &&
              (d.showScrollbar("y"), d.positionScrollbar("y")),
              (d.scrollYTicking = !1);
          }),
          (this.onMouseEnter = function () {
            d.showScrollbar("x"), d.showScrollbar("y");
          }),
          (this.onMouseMove = function (a) {
            (d.mouseX = a.clientX),
              (d.mouseY = a.clientY),
              (d.axis.x.isOverflowing || d.axis.x.forceVisible) &&
                d.onMouseMoveForAxis("x"),
              (d.axis.y.isOverflowing || d.axis.y.forceVisible) &&
          ...
          (this.onWindowResize = function () {
            (d.scrollbarWidth = d.getScrollbarWidth()), d.hideNativeScrollbar();
          }),
          (this.hideScrollbars = function () {
            (d.axis.x.track.rect = d.axis.x.track.el.getBoundingClientRect()),
              ...
              d.isWithinBounds(d.axis.y.track.rect) ||
                (d.axis.y.scrollbar.el.classList.remove(d.classNames.visible),
                (d.axis.y.isVisible = !1)),
              d.isWithinBounds(d.axis.x.track.rect) ||
                (d.axis.x.scrollbar.el.classList.remove(d.classNames.visible),
          ...
          (this.onPointerEvent = function (a) {
            ...
            (d.axis.x.track.rect = d.axis.x.track.el.getBoundingClientRect()),
              (d.axis.y.track.rect = d.axis.y.track.el.getBoundingClientRect()),
              (d.axis.x.isOverflowing || d.axis.x.forceVisible) &&
                (b = d.isWithinBounds(d.axis.x.track.rect)),
              (d.axis.y.isOverflowing || d.axis.y.forceVisible) &&
                (c = d.isWithinBounds(d.axis.y.track.rect)),
              (b || c) &&
                (a.preventDefault(),
                a.stopPropagation(),
                "mousedown" === a.type &&
                  (b &&
                    ((d.axis.x.scrollbar.rect =
                      d.axis.x.scrollbar.el.getBoundingClientRect()),
                    d.isWithinBounds(d.axis.x.scrollbar.rect)
                      ? d.onDragStart(a, "x")
                      : d.onTrackClick(a, "x")),
                  c &&
                    ((d.axis.y.scrollbar.rect =
                      d.axis.y.scrollbar.el.getBoundingClientRect()),
                    d.isWithinBounds(d.axis.y.scrollbar.rect)
                      ? d.onDragStart(a, "y")
                      : d.onTrackClick(a, "y"))));
          }),
          (this.drag = function (c) {
            var e = d.axis[d.draggedAxis].track,
              f = e.rect[d.axis[d.draggedAxis].sizeAttr],
              g = d.axis[d.draggedAxis].scrollbar,
              h = d.contentWrapperEl[d.axis[d.draggedAxis].scrollSizeAttr],
              i = parseInt(d.elStyles[d.axis[d.draggedAxis].sizeAttr], 10);
            c.preventDefault(), c.stopPropagation();
            var a =
              ((("y" === d.draggedAxis ? c.pageY : c.pageX) -
                e.rect[d.axis[d.draggedAxis].offsetAttr] -
                d.axis[d.draggedAxis].dragOffset) /
                (f - g.size)) *
              (h - i);
            "x" === d.draggedAxis &&
              ((a =
                d.isRtl && b.getRtlHelpers().isRtlScrollbarInverted
                  ? a - (f + g.size)
                  : a),
              (a =
                d.isRtl && b.getRtlHelpers().isRtlScrollingInverted ? -a : a)),
              (d.contentWrapperEl[d.axis[d.draggedAxis].scrollOffsetAttr] = a);
          }),
          ...
          (this.options = Object.assign({}, b.defaultOptions, c)),
          (this.classNames = Object.assign(
            {},
            b.defaultOptions.classNames,
          ...
          b.instances.has(this.el) ||
            ((this.recalculate = fc(this.recalculate.bind(this), 64)),
            (this.onMouseMove = fc(this.onMouseMove.bind(this), 64)),
            (this.hideScrollbars = fp(
              this.hideScrollbars.bind(this),
              this.options.timeout
            )),
            (this.onWindowResize = fp(this.onWindowResize.bind(this), 64, {
              leading: !0,
            })),
            (b.getRtlHelpers = fC(b.getRtlHelpers)),
            this.init());
      }
      (b.getRtlHelpers = function () {
        ...
        var g = b.getOffset(e);
        return {
          isRtlScrollingInverted: f.left !== c.left && c.left - g.left != 0,
          isRtlScrollbarInverted: f.left !== c.left,
        };
      }),
      ...
      return (
        ...
        (a.initDOM = function () {
          var c = this;
          if (
            Array.prototype.filter.call(this.el.children, function (a) {
              return a.classList.contains(c.classNames.wrapper);
            }).length
          )
          ...
          if (!this.axis.x.track.el || !this.axis.y.track.el) {
            ...
            a.classList.add(this.classNames.track),
        ...
        (a.setAccessibilityAttributes = function () {
          var a = this.options.ariaLabel || "scrollable content";
          this.contentWrapperEl.setAttribute("tabindex", "0"),
            this.contentWrapperEl.setAttribute("role", "region"),
            this.contentWrapperEl.setAttribute("aria-label", a);
        }),
        (a.initListeners = function () {
          var c = this,
            a = gI(this.el);
          this.options.autoHide &&
            this.el.addEventListener("mouseenter", this.onMouseEnter),
            ["mousedown", "click", "dblclick"].forEach(function (a) {
              c.el.addEventListener(a, c.onPointerEvent, !0);
            }),
            ["touchstart", "touchend", "touchmove"].forEach(function (a) {
              c.el.addEventListener(a, c.onPointerEvent, {
                capture: !0,
                passive: !0,
              });
            }),
          ...
          var d = !1,
            b = a.ResizeObserver || f9;
          (this.resizeObserver = new b(function () {
            d && c.recalculate();
          })),
            ...
            (this.mutationObserver = new a.MutationObserver(this.recalculate)),
        ...
        (a.recalculate = function () {
          ...
          var f = this.heightAutoObserverEl.offsetHeight <= 1,
            g = this.heightAutoObserverEl.offsetWidth <= 1,
            b = this.contentEl.offsetWidth,
            h = this.contentWrapperEl.offsetWidth,
            i = this.elStyles.overflowX,
            j = this.elStyles.overflowY;
          ...
          (this.contentWrapperEl.style.height = f ? "auto" : "100%"),
            (this.placeholderEl.style.width = g ? b + "px" : "auto"),
            (this.placeholderEl.style.height = a + "px");
          var d = this.contentWrapperEl.offsetHeight;
          (this.axis.x.isOverflowing = c > b),
            (this.axis.y.isOverflowing = a > d),
            (this.axis.x.isOverflowing =
              "hidden" !== i && this.axis.x.isOverflowing),
            (this.axis.y.isOverflowing =
              "hidden" !== j && this.axis.y.isOverflowing),
          ...
          (this.axis.x.isOverflowing = this.axis.x.isOverflowing && c > h - l),
            (this.axis.y.isOverflowing =
              this.axis.y.isOverflowing && a > d - k),
        ...
        (a.getScrollbarSize = function (a) {
          if ((void 0 === a && (a = "y"), !this.axis[a].isOverflowing))
            return 0;
          var b,
            d = this.contentEl[this.axis[a].scrollSizeAttr],
            c = this.axis[a].track.el[this.axis[a].offsetSizeAttr];
          return (
            (b = Math.max(~~((c / d) * c), this.options.scrollbarMinSize)),
            this.options.scrollbarMaxSize &&
              (b = Math.min(b, this.options.scrollbarMaxSize)),
            b
          );
        }),
        (a.positionScrollbar = function (a) {
          if ((void 0 === a && (a = "y"), this.axis[a].isOverflowing)) {
            var g = this.contentWrapperEl[this.axis[a].scrollSizeAttr],
              f = this.axis[a].track.el[this.axis[a].offsetSizeAttr],
              h = parseInt(this.elStyles[this.axis[a].sizeAttr], 10),
              d = this.axis[a].scrollbar,
              e = this.contentWrapperEl[this.axis[a].scrollOffsetAttr],
              i =
                (e =
                  "x" === a &&
                  this.isRtl &&
                  b.getRtlHelpers().isRtlScrollingInverted
                    ? -e
                    : e) /
                (g - h),
              c = ~~((f - d.size) * i);
            (c =
              "x" === a &&
              this.isRtl &&
              b.getRtlHelpers().isRtlScrollbarInverted
                ? c + (f - d.size)
                : c),
        ...
        (a.toggleTrackVisibility = function (a) {
          void 0 === a && (a = "y");
          var b = this.axis[a].track.el,
            c = this.axis[a].scrollbar.el;
          this.axis[a].isOverflowing || this.axis[a].forceVisible
            ? ((b.style.visibility = "visible"),
              (this.contentWrapperEl.style[this.axis[a].overflowAttr] =
                "scroll"))
        ...
        (a.hideNativeScrollbar = function () {
        ...
        (a.onMouseMoveForAxis = function (a) {
          void 0 === a && (a = "y"),
            (this.axis[a].track.rect =
              this.axis[a].track.el.getBoundingClientRect()),
            (this.axis[a].scrollbar.rect =
              this.axis[a].scrollbar.el.getBoundingClientRect()),
            this.isWithinBounds(this.axis[a].scrollbar.rect)
              ? this.axis[a].scrollbar.el.classList.add(this.classNames.hover)
              : this.axis[a].scrollbar.el.classList.remove(
                  this.classNames.hover
                ),
            this.isWithinBounds(this.axis[a].track.rect)
              ? (this.showScrollbar(a),
                this.axis[a].track.el.classList.add(this.classNames.hover))
              : this.axis[a].track.el.classList.remove(this.classNames.hover);
        }),
        (a.onMouseLeaveForAxis = function (a) {
          void 0 === a && (a = "y"),
            this.axis[a].track.el.classList.remove(this.classNames.hover),
            this.axis[a].scrollbar.el.classList.remove(this.classNames.hover);
        }),
        (a.showScrollbar = function (a) {
          void 0 === a && (a = "y");
          var b = this.axis[a].scrollbar.el;
          this.axis[a].isVisible ||
            (b.classList.add(this.classNames.visible),
            (this.axis[a].isVisible = !0)),
            this.options.autoHide && this.hideScrollbars();
        }),
        (a.onDragStart = function (c, a) {
          void 0 === a && (a = "y");
          var b = gJ(this.el),
            d = gI(this.el),
            e = this.axis[a].scrollbar,
            f = "y" === a ? c.pageY : c.pageX;
          (this.axis[a].dragOffset = f - e.rect[this.axis[a].offsetAttr]),
            (this.draggedAxis = a),
            this.el.classList.add(this.classNames.dragging),
            b.addEventListener("mousemove", this.drag, !0),
            b.addEventListener("mouseup", this.onEndDrag, !0),
            null === this.removePreventClickId
              ? (b.addEventListener("click", this.preventClick, !0),
                b.addEventListener("dblclick", this.preventClick, !0))
              : (d.clearTimeout(this.removePreventClickId),
                (this.removePreventClickId = null));
        }),
        (a.onTrackClick = function (f, a) {
          var g = this;
          if ((void 0 === a && (a = "y"), this.options.clickOnTrack)) {
            var h = gI(this.el);
            this.axis[a].scrollbar.rect =
              this.axis[a].scrollbar.el.getBoundingClientRect();
            var b = this.axis[a].scrollbar.rect[this.axis[a].offsetAttr],
              c = parseInt(this.elStyles[this.axis[a].sizeAttr], 10),
              d = this.contentWrapperEl[this.axis[a].scrollOffsetAttr],
              e = ("y" === a ? this.mouseY - b : this.mouseX - b) < 0 ? -1 : 1,
              i = -1 === e ? d - c : d + c;
            !(function b() {
              var c, f;
              -1 === e
                ? d > i &&
                  ((d -= g.options.clickOnTrackSpeed),
                  g.contentWrapperEl.scrollTo(
                    (((c = {})[g.axis[a].offsetAttr] = d), c)
                  ),
                  h.requestAnimationFrame(b))
                : d < i &&
                  ((d += g.options.clickOnTrackSpeed),
                  g.contentWrapperEl.scrollTo(
                    (((f = {})[g.axis[a].offsetAttr] = d), f)
                  ),
                  h.requestAnimationFrame(b));
            })();
          }
        ...
        (a.removeListeners = function () {
          ...
          this.options.autoHide &&
            ...
            ["mousedown", "click", "dblclick"].forEach(function (a) {
              b.el.removeEventListener(a, b.onPointerEvent, !0);
            }),
            ["touchstart", "touchend", "touchmove"].forEach(function (a) {
              b.el.removeEventListener(a, b.onPointerEvent, {
                capture: !0,
                passive: !0,
              });
            }),
        ...
        (a.unMount = function () {
          this.removeListeners(), b.instances.delete(this.el);
        }),
        (a.isWithinBounds = function (a) {
          return (
            this.mouseX >= a.left &&
            this.mouseX <= a.left + a.width &&
            this.mouseY >= a.top &&
            this.mouseY <= a.top + a.height
          );
        }),
        (a.findChild = function (a, b) {
          var c =
            a.matches ||
    ...
    return (
      ...
      (g.initDOMLoadedElements = function () {
        document.removeEventListener(
          ...
          Array.prototype.forEach.call(
            ...
            function (a) {
              "init" === a.getAttribute("data-simplebar") ||
                g.instances.has(a) ||
                new g(a, cf(a.attributes));
            }
          );
      }),
      ...
      (g.handleMutations = function (a) {
        a.forEach(function (a) {
          Array.prototype.forEach.call(a.addedNodes, function (a) {
            1 === a.nodeType &&
              (a.hasAttribute("data-simplebar")
                ? !g.instances.has(a) &&
                  document.documentElement.contains(a) &&
                  new g(a, cf(a.attributes))
                : Array.prototype.forEach.call(
                    a.querySelectorAll("[data-simplebar]"),
                    function (a) {
                      "init" !== a.getAttribute("data-simplebar") &&
                        !g.instances.has(a) &&
                        document.documentElement.contains(a) &&
            ...
            Array.prototype.forEach.call(a.removedNodes, function (a) {
              1 === a.nodeType &&
                ("init" === a.getAttribute("data-simplebar")
                  ? g.instances.has(a) &&
                    !document.documentElement.contains(a) &&
                    g.instances.get(a).unMount()
                  : Array.prototype.forEach.call(
                      a.querySelectorAll('[data-simplebar="init"]'),
                      function (a) {
                        g.instances.has(a) &&
                          !document.documentElement.contains(a) &&
                          g.instances.get(a).unMount();
...
function hexToRgb(e) {
  ...
  e = e.replace(a, function (d, a, b, c) {
    return a + a + b + b + c + c;
  });
...
!(function (a) {
  ...
  return (
    (a.fn.tilt = function (b) {
      var c = function () {
          this.ticking ||
            (requestAnimationFrame(j.bind(this)), (this.ticking = !0));
        },
        d = function () {
          var b = this;
        ...
        g = function (a) {
          (this.mousePositions = f(a)), c.call(this);
        },
        h = function () {
          d.call(this),
            (this.reset = !0),
        ...
        i = function () {
          ...
          return {
            tiltX: (
              ...
              f * this.settings.maxTilt
            ).toFixed(2),
            tiltY: (
              g * this.settings.maxTilt -
              this.settings.maxTilt / 2
            ).toFixed(2),
            percentageX: 100 * f,
            percentageY: 100 * g,
            angle:
              Math.atan2(
                this.mousePositions.x - (d + b / 2),
                -(this.mousePositions.y - (e + c / 2))
              ) *
              (180 / Math.PI),
          };
        },
          ...
          return (
            ...
            this.reset
              ...
              : (a(this).css(
                ...
                a(this).trigger("change", [this.transforms]),
                void (this.ticking = !1))
          );
        },
        k = function () {
      ...
      return (
        ...
        (a.fn.tilt.getValues = function () {
          ...
          return (
            a(this).each(function () {
              (this.mousePositions = f.call(this)), b.push(i.call(this));
            }),
            b
          );
        }),
        (a.fn.tilt.reset = function () {
          a(this).each(function () {
            var b = this;
            (this.mousePositions = f.call(this)),
        ...
        this.each(function () {
          ...
          (this.settings = a.extend(
            {
              maxTilt: a(this).is("[data-tilt-max]")
                ? a(this).data("tilt-max")
                : 20,
              perspective: a(this).is("[data-tilt-perspective]")
                ? a(this).data("tilt-perspective")
                : 300,
              easing: a(this).is("[data-tilt-easing]")
                ? a(this).data("tilt-easing")
                : "cubic-bezier(.03,.98,.52,.99)",
              scale: a(this).is("[data-tilt-scale]")
                ? a(this).data("tilt-scale")
                : "1",
              speed: a(this).is("[data-tilt-speed]")
                ? a(this).data("tilt-speed")
                : "400",
              transition:
                !a(this).is("[data-tilt-transition]") ||
                a(this).data("tilt-transition"),
              disableAxis: a(this).is("[data-tilt-disable-axis]")
                ? a(this).data("tilt-disable-axis")
                : null,
              axis: a(this).is("[data-tilt-axis]")
                ? a(this).data("tilt-axis")
                : null,
              reset:
                !a(this).is("[data-tilt-reset]") || a(this).data("tilt-reset"),
              glare:
                !!a(this).is("[data-tilt-glare]") && a(this).data("tilt-glare"),
              maxGlare: a(this).is("[data-tilt-maxglare]")
                ? a(this).data("tilt-maxglare")
                : 1,
            },
            b
          )),
            ...
            (this.init = function () {
              a(c).data("settings", c.settings),
                c.settings.glare &&
                  function () {
                    var b = this.settings.glarePrerender;
                    b ||
                      a(this).append(
                        '<div class="js-tilt-glare"><div class="js-tilt-glare-inner"></div></div>'
                      ),
                      (this.glareElementWrapper =
                        a(this).find(".js-tilt-glare")),
                      (this.glareElement = a(this).find(
                        ".js-tilt-glare-inner"
                      )),
                      b ||
                        (this.glareElementWrapper
                ...
                function () {
                  a(this).on("mousemove", g),
                    a(this).on("mouseenter", e),
                    this.settings.reset && a(this).on("mouseleave", h),
                    this.settings.glare && a(window).on("resize", k.bind(this));
                }.call(c);
            }),
            this.init();
        })
...
var pJS = function (d, c) {
  ...
  c && Object.deepExtend(a, c),
    ...
    (a.fn.particle.prototype.draw = function () {
      ...
      if (void 0 != b.opacity_bubble) var d = b.opacity_bubble;
      else var d = b.opacity;
      if (b.color.rgb)
        var e =
          "rgba(" +
          b.color.rgb.r +
        ...
        var e =
          ...
          ")";
      switch (
        ((a.canvas.ctx.fillStyle = e), a.canvas.ctx.beginPath(), b.shape)
      ) {
        case "circle":
          a.canvas.ctx.arc(b.x, b.y, c, 0, 2 * Math.PI, !1);
          break;
        case "edge":
          a.canvas.ctx.rect(b.x - c, b.y - c, 2 * c, 2 * c);
          break;
        case "triangle":
        ...
        case "polygon":
          a.fn.vendors.drawShape(
            a.canvas.ctx,
            b.x - c / (a.particles.shape.polygon.nb_sides / 3.5),
            b.y - c / 0.76,
        ...
        case "star":
          a.fn.vendors.drawShape(
            a.canvas.ctx,
            b.x - (2 * c) / (a.particles.shape.polygon.nb_sides / 4),
            b.y - c / 1.52,
            (2 * c * 2.66) / (a.particles.shape.polygon.nb_sides / 3),
            a.particles.shape.polygon.nb_sides,
            2
          );
          break;
        case "image":
          if ("svg" == a.tmp.img_type) var f = b.img.obj;
          else var f = a.tmp.img_obj;
          f && g();
      }
    ...
    (a.fn.modes.bubbleParticle = function (b) {
      ...
      function j(c, j, f, e, d) {
        if (c != j) {
          if (a.tmp.bubble_duration_end) {
            if (void 0 != f) {
              var l = e - (k * (e - c)) / a.interactivity.modes.bubble.duration,
                m = c - l;
              (i = c + m),
            ...
            if (g != c) {
              var i = e - (k * (e - c)) / a.interactivity.modes.bubble.duration;
              "size" == d && (b.radius_bubble = i),
                "opacity" == d && (b.opacity_bubble = i);
            }
          } else
      ...
      if (
        ...
        if (a.tmp.bubble_clicking) {
          var d = b.x - a.interactivity.mouse.click_pos_x,
            ...
            h = Math.sqrt(d * d + e * e),
            k = (new Date().getTime() - a.interactivity.mouse.click_time) / 1e3;
          k > a.interactivity.modes.bubble.duration &&
            (a.tmp.bubble_duration_end = !0),
            k > 2 * a.interactivity.modes.bubble.duration &&
    ...
    (a.fn.modes.repulseParticle = function (b) {
      ...
      if (
        ...
        if (
          ...
          0 == a.tmp.repulse_clicking && ((b.vx = b.vx_i), (b.vy = b.vy_i));
      }
    }),
    ...
    (a.fn.vendors.createSvgImg = function (i) {
      var c = a.tmp.source_svg,
        d = /#([0-9A-F]{3,6})/gi,
        e = c.replace(d, function (b, c, d, e) {
          if (i.color.rgb)
            var a =
              "rgba(" +
              i.color.rgb.r +
    ...
    (a.fn.vendors.drawShape = function (a, g, h, b, c, d) {
      var i = c * d,
        e = c / d,
        j = (180 * (e - 2)) / e,
        k = Math.PI - (Math.PI * j) / 180;
      a.save(), a.beginPath(), a.translate(g, h), a.moveTo(0, 0);
      for (var f = 0; i > f; f++)
        a.lineTo(b, 0), a.translate(b, 0), a.rotate(k);
      a.fill(), a.restore();
    }),
...
(Object.deepExtend = function (c, b) {
  ...
  (function (d, a) {
    ...
    ((c = function (e, f) {
      this.options = a.extend(
        {
          ...
          animation: "slide",
          inherit_width_from: d,
          inherit_height_from: d,
          pagination: !0,
          hashchange: !1,
          scrollable: !0,
          elements: {
      ...
      var h = function () {
          return (
            (l = b._findMultiplier()),
            b.$el.on("click", b.options.elements.nav + " a", function (c) {
              c.preventDefault(),
                b.stop(),
                a(this).hasClass("next")
                  ? b.animate("next", function () {
                      b.start();
                    })
                  : b.animate("prev", function () {
                      b.start();
                    });
            }),
            a(document).on("keyup", function (a) {
              37 === a.keyCode && b.animate("prev"),
                39 === a.keyCode && b.animate("next");
            }),
            a(d).on("resize", function () {
              setTimeout(function () {
                var a = b.$container.children();
                (b.width = b._findWidth()),
                  (b.height = b._findHeight()),
                  a.css({ width: b.width, left: b.width }),
                  b.css.containers(),
                  b.css.images();
              }, 10);
            }),
            b.options.hashchange &&
              a(d).on("hashchange", function () {
                var a,
                  c = b._parseHash();
                (a = b._upcomingSlide(c)) >= 0 &&
                  a !== b.current &&
                  b.animate(a);
              }),
            b.pagination._events(),
            b.start(),
            b
          );
        },
        i = {
          containers: function () {
            b.init
              ? (b.$el.css({ height: b.height }),
                b.$control.css({ width: b.width * l, left: -b.width }),
                b.$container.css({}))
              : (a("body").css({ margin: 0 }),
                b.$el.css({
                  position: "relative",
              ...
              1 === b.size() && b.$el.find(b.options.elements.nav).hide();
          },
          images: function () {
            var c = b.$container.find("img").not(b.options.elements.preserve);
            c
              .removeAttr("width")
              .removeAttr("height")
              .css({
              ...
              c.each(function () {
                var c = b.image._aspectRatio(this),
                  d = this;
                if (a.data(this, "processed"))
                  b.image._scale(d, c), b.image._center(d, c);
                else {
                  var e = new Image();
                  (e.onload = function () {
                    b.image._scale(d, c),
                      b.image._center(d, c),
                      a.data(d, "processed", !0);
                  }),
                    (e.src = this.src);
                }
              });
          ...
          children: function () {
            ...
            c.is("img") &&
              ...
              b.init || c.css({ display: "none", left: 2 * b.width }),
              c.css({
                position: "absolute",
                overflow: "hidden",
                height: "100%",
        ...
        c = {
          slide: function (a, d) {
            ...
            c
              .eq(a.upcoming_slide)
              .css({ left: a.upcoming_position, display: "block" }),
              b.$control.animate(
                { left: a.offset },
                b.options.animation_speed,
                b.options.animation_easing,
                function () {
                  b.size() > 1 &&
                    (b.$control.css({ left: -b.width }),
                    c.eq(a.upcoming_slide).css({ left: b.width, zIndex: 2 }),
                    a.outgoing_slide >= 0 &&
                      c
                        .eq(a.outgoing_slide)
                        .css({ left: b.width, display: "none", zIndex: 0 })),
                    d();
                }
              );
          },
          fade: function (b, e) {
            var a = this,
              c = a.$container.children(),
              f = c.eq(b.outgoing_slide),
              d = c.eq(b.upcoming_slide);
            d
              .css({ left: this.width, opacity: 0, display: "block" })
              .animate(
                { opacity: 1 },
                a.options.animation_speed,
                a.options.animation_easing
              ),
              b.outgoing_slide >= 0
                ? f.animate(
                    { opacity: 0 },
                    ...
                    function () {
                      a.size() > 1 &&
                        (c.eq(b.upcoming_slide).css({ zIndex: 2 }),
                        b.outgoing_slide >= 0 &&
                          c
                            .eq(b.outgoing_slide)
      ...
      c = a.extend(c, a.fn.superslides.fx);
      var j = {
          _centerY: function (d) {
            var c = a(d);
            c.css({ top: (b.height - c.height()) / 2 });
          },
          _centerX: function (d) {
            var c = a(d);
            c.css({ left: (b.width - c.width()) / 2 });
          },
          _center: function (a) {
            b.image._centerX(a), b.image._centerY(a);
          },
          _aspectRatio: function (a) {
            if (!a.naturalHeight && !a.naturalWidth) {
              var b = new Image();
              (b.src = a.src),
                (a.naturalHeight = b.height),
                (a.naturalWidth = b.width);
            }
            return a.naturalHeight / a.naturalWidth;
          },
          _scale: function (d, c) {
            c = c || b.image._aspectRatio(d);
            var f = b.height / b.width,
              e = a(d);
            f > c
              ? e.css({ height: b.height, width: b.height / c })
              : e.css({ height: b.width * c, width: b.width });
          },
        },
        k = {
          _setCurrent: function (c) {
            if (b.$pagination) {
              var a = b.$pagination.children();
              a.removeClass("current"), a.eq(c).addClass("current");
            }
          },
          _addItem: function (d) {
            var c = d + 1,
              e = b.$container.children().eq(d).attr("id");
            e && (c = e),
              a("<a>", { href: "#" + c, text: c }).appendTo(b.$pagination);
          },
          _setup: function () {
            if (b.options.pagination && 1 !== b.size()) {
              var d = a("<nav>", {
                class: b.options.elements.pagination.replace(/^\./, ""),
              });
              b.$pagination = d.appendTo(b.$el);
              for (var c = 0; b.size() > c; c++) b.pagination._addItem(c);
            }
          },
          _events: function () {
            b.$el.on(
              "click",
              b.options.elements.pagination + " a",
              function (c) {
                c.preventDefault();
                var a,
                  d = b._parseHash(this.hash);
                (a = b._upcomingSlide(d, !0)) !== b.current &&
                  b.animate(a, function () {
                    b.start();
                  });
              }
            );
      ...
      return (
        ...
        (this.$control = this.$container.wrap(g).parent(".slides-control")),
        b._findPositions(),
        (b.width = b._findWidth()),
        (b.height = b._findHeight()),
        this.css.children(),
      ...
      start: function () {
        var b = this;
        b.options.hashchange ? a(d).trigger("hashchange") : this.animate(),
          this.options.play &&
      ...
      animate: function (c, g) {
        ...
        if (
          !(
            ...
            ((this.animating = !0),
            void 0 === c && (c = "next"),
            (a.upcoming_slide = this._upcomingSlide(c)),
            a.upcoming_slide >= this.size())
          )
        ) {
          if (
            ...
            ("prev" === c || a.outgoing_slide > c) &&
              ((a.upcoming_position = 0), (a.offset = 0)),
            b.size() > 1 && b.pagination._setCurrent(a.upcoming_slide),
            b.options.hashchange)
          ) {
            var e = a.upcoming_slide + 1,
              f = b.$container
                .children(":eq(" + a.upcoming_slide + ")")
                .attr("id");
            d.location.hash = f || e;
          }
          b.$el.trigger("animating.slides", [a]),
            b.animation(a, function () {
              b._findPositions(a.upcoming_slide, b),
                "function" == typeof g && g(),
                (b.animating = !1),
                b.$el.trigger("animated.slides"),
                b.init ||
                  (b.$el.trigger("init.slides"),
                  (b.init = !0),
                  b.$container.fadeIn("fast"));
            });
        }
      },
    }),
        ...
        return (
          this.each(function () {
            ...
            return (
              (g = (h = a(this)).data(b)),
              (i = "object" == typeof e && e),
              g || (d = h.data(b, (g = new c(this, i)))),
              "string" == typeof e && "function" == typeof (d = g[e])
                ? (d = d.call(g, f))
                : void 0
            );
          }),
  ...
  (function (b, a) {
    ...
    function e(a, b) {
      var c = void 0;
      return function () {
        c && clearTimeout(c), (c = setTimeout(a, b));
      };
    }
    function f(b, d) {
      for (var a = b.length, e = a, c = []; a--; ) c.push(d(b[e - a - 1]));
      return c;
    }
    function g(a, b) {
      var c = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
      if (window.Promise) return w(a, b, c);
      a.recalculate(!0, !0);
    }
    function h(a) {
      for (
        var f = a.options,
          c = a.responsiveOptions,
          d = a.keys,
          g = a.docWidth,
          h = void 0,
          b = 0;
    ...
    function j(a) {
      var c = a.useContainerForBreakpoints
          ? a.container.clientWidth
          : window.innerWidth,
        b = { columns: a.columns };
      B(a.margin)
        ? (b.margin = { x: a.margin.x, y: a.margin.y })
        : (b.margin = { x: a.margin, y: a.margin });
      var d = Object.keys(a.breakAt);
      return a.mobileFirst
        ? h({ options: a, responsiveOptions: b, keys: d, docWidth: c })
        : i({ options: a, responsiveOptions: b, keys: d, docWidth: c });
    }
    function k(a) {
      return j(a).columns;
    }
    ...
    function p(a, b) {
      ...
      E(a, e, c),
        r(b, function (b) {
          ...
          isNaN(e) ||
            (a.rows.forEach(function (b, d) {
              b < a.rows[c] && (c = d);
            }),
            (b.style.position = "absolute"),
            (b.style.top = a.rows[c] + "px"),
            (b.style.left = "" + a.cols[c]),
            (a.rows[c] += isNaN(e) ? 0 : e + f),
            d && (b.dataset.macyComplete = 1));
        }),
        d && (a.tmpRows = null),
        o(a);
    }
    function q(a, b) {
      ...
      E(a, e, c),
        r(b, function (b) {
          a.lastcol === e && (a.lastcol = 0);
          var c = D(b, "height");
          (c = parseInt(b.offsetHeight, 10)),
            isNaN(c) ||
              ((b.style.position = "absolute"),
              (b.style.top = a.rows[a.lastcol] + "px"),
              (b.style.left = "" + a.cols[a.lastcol]),
              (a.rows[a.lastcol] += isNaN(c) ? 0 : c + f),
              (a.lastcol += 1),
              d && (b.dataset.macyComplete = 1));
        }),
        d && (a.tmpRows = null),
    ...
    var b = function c(a, b) {
      ...
      if (((a = a.replace(/^\s*/, "").replace(/\s*$/, "")), b))
        return this.byCss(a, b);
      for (var d in this.selectors)
        if (((b = d.split("/")), new RegExp(b[1], b[2]).test(a)))
          return this.selectors[d](a);
      return this.byCss(a);
    };
    (b.prototype.byCss = function (a, b) {
      return (b || document).querySelectorAll(a);
    }),
      (b.prototype.selectors = {}),
      (b.prototype.selectors[/^\.[\w\-]+$/] = function (a) {
    ...
    var r = function (b, c) {
        for (var a = b.length, d = a; a--; ) c(b[d - a - 1]);
      },
      c = function () {
        var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
        (this.running = !1), (this.events = []), this.add(a);
      };
    (c.prototype.run = function () {
      if (!this.running && this.events.length > 0) {
        var a = this.events.shift();
        (this.running = !0), a(), (this.running = !1), this.run();
      }
    }),
      (c.prototype.add = function () {
        ...
        return (
          ...
          (Array.isArray(a)
            ...
            : (this.events.push(a), void this.run()))
        );
      }),
    ...
    var s = function (a) {
        var b =
          arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        return (this.instance = a), (this.data = b), this;
      },
      d = function () {
        var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
        (this.events = {}), (this.instance = a);
      };
    (d.prototype.on = function () {
      ...
      return (
        !(!a || !b) &&
        (Array.isArray(this.events[a]) || (this.events[a] = []),
      ...
      (d.prototype.emit = function () {
        var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
          b =
            arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        if (!a || !Array.isArray(this.events[a])) return !1;
        var c = new s(this.instance, b);
        r(this.events[a], function (a) {
          return a(c);
        });
      });
    var t = function (a) {
        return (
          !("naturalHeight" in a && a.naturalHeight + a.naturalWidth === 0) ||
          a.width + a.height !== 0
        );
      },
      u = function (a, b) {
        ...
        return new Promise(function (a, c) {
          if (b.complete) return t(b) ? a(b) : c(b);
          b.addEventListener("load", function () {
            return t(b) ? a(b) : c(b);
          }),
          ...
          .then(function (b) {
            c && a.emit(a.constants.EVENT_IMAGE_LOAD, { img: b });
          })
          .catch(function (b) {
            return a.emit(a.constants.EVENT_IMAGE_ERROR, { img: b });
          });
      },
      v = function (b, a) {
        var c = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
      ...
      w = function (a, b) {
        var c = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
        return Promise.all(v(a, b, c)).then(function () {
          a.emit(a.constants.EVENT_IMAGE_COMPLETE);
        });
      },
      x = function (a) {
        return e(function () {
          a.emit(a.constants.EVENT_RESIZE),
            a.queue.add(function () {
              return a.recalculate(!0, !0);
            });
        }, 100);
      },
      y = function (a) {
        if (
          ((a.container = b(a.options.container)),
          a.container instanceof b || !a.container)
        )
          return (
            !!a.options.debug && console.error("Error: Container not found")
          );
        a.container.length && (a.container = a.container[0]),
          (a.options.container = a.container),
      ...
      A = function (a) {
        var c = b("img", a.container);
        window.addEventListener("resize", a.resizer),
          a.on(a.constants.EVENT_IMAGE_LOAD, function () {
            return a.recalculate(!1, !1);
          }),
          a.on(a.constants.EVENT_IMAGE_COMPLETE, function () {
            return a.recalculate(!0, !0);
          }),
          a.options.useOwnImageLoader || g(a, c, !a.options.waitForImages),
          a.emit(a.constants.EVENT_INITIALIZED);
      },
      _ = function (a) {
        y(a), z(a), A(a);
      },
      ...
      C = function (a, b) {
        B(a) || (b.columns = a),
          B(a) && a.columns && (b.columns = a.columns),
          B(a) &&
            a.margin &&
            !B(a.margin) &&
            (b.margin = { x: a.margin, y: a.margin }),
          B(a) &&
            ...
            B(a.margin) &&
            a.margin.x &&
            (b.margin.x = a.margin.x),
          B(a) &&
            a.margin &&
            B(a.margin) &&
            a.margin.y &&
            (b.margin.y = a.margin.y);
      },
      D = function (a, b) {
      ...
      E = function (a, c) {
        ...
        if ((a.lastcol || (a.lastcol = 0), a.rows.length < 1 && (d = !0), d)) {
          (a.rows = []), (a.cols = []), (a.lastcol = 0);
          for (var b = c - 1; b >= 0; b--)
            (a.rows[b] = 0), (a.cols[b] = n(a, b));
        } else if (a.tmpRows) {
          a.rows = [];
          for (var b = c - 1; b >= 0; b--) a.rows[b] = a.tmpRows[b];
        } else {
          a.tmpRows = [];
          for (var b = c - 1; b >= 0; b--) a.tmpRows[b] = a.rows[b];
        }
      },
      F = function (a) {
        var d = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
          ...
          c = d
            ...
            : b(':scope > *:not([data-macy-complete="1"])', a.container);
        c = Array.from(c).filter(function (a) {
          return null !== a.offsetParent;
        });
        var f = m(a.options);
        return (
          r(c, function (a) {
            d && (a.dataset.macyComplete = 0), (a.style.width = f);
          }),
          a.options.trueOrder
            ? (q(a, c, d, e), a.emit(a.constants.EVENT_RECALCULATED))
            : (p(a, c, d, e), a.emit(a.constants.EVENT_RECALCULATED))
        );
      },
      G = function () {
    ...
    Array.from ||
      (Array.from = function (a) {
        for (var b = 0, c = []; b < a.length; ) c.push(a[b++]);
        return c;
      });
    var I = {
      columns: 4,
    ...
    !(function () {
      try {
        ...
        !(function () {
          function a(a) {
            return function (d) {
              if (d && b.test(d)) {
                ...
                c ||
                  (this.id = "q" + Math.floor(9e6 * Math.random()) + "1000000"),
                  (arguments[0] = d.replace(b, "#" + this.id));
                var e = a.apply(this, arguments);
                return (
                  null === c ? this.removeAttribute("id") : c || (this.id = c),
                  e
                );
              }
          ...
          var b = /:scope\b/gi,
            c = a(Element.prototype.querySelector);
          Element.prototype.querySelector = function (a) {
            return c.apply(this, arguments);
          };
          var d = a(Element.prototype.querySelectorAll);
    ...
    var a = function a() {
      ...
      (this.options = {}),
        H(this.options, I, b),
        (this.options.cancelLegacy && !G()) || _(this);
    };
    return (
      (a.init = function (b) {
        return (
      ...
      (a.prototype.recalculateOnImageLoad = function () {
        var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
        return g(this, b("img", this.container), !a);
      }),
      (a.prototype.runOnImageLoad = function (a) {
        var c = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
          d = b("img", this.container);
        return (
          this.on(this.constants.EVENT_IMAGE_COMPLETE, a),
          c && this.on(this.constants.EVENT_IMAGE_LOAD, a),
          g(this, d, c)
        );
      }),
      ...
      (a.prototype.remove = function () {
        window.removeEventListener("resize", this.resizer),
          r(this.container.children, function (a) {
            a.removeAttribute("data-macy-complete"), a.removeAttribute("style");
          }),
      ...
      (a.prototype.constants = a.constants),
      a
    );
  }),
  (function (b, a) {
    "function" == typeof define && define.amd
      ? define(["jquery"], a)
      : a("object" == typeof exports ? require("jquery") : b.jQuery);
  })(this, function (b) {
    "use strict";
    function d(g) {
      var d,
      ...
      for (
        ...
        (d = b.indexOf(":")),
          ...
          (a = b.substring(d + 1)),
          a || (a = void 0),
          "string" == typeof a && (a = "true" === a || ("false" !== a && a)),
          "string" == typeof a && (a = isNaN(a) ? a : +a),
          (i[e] = a);
      return null == e && null == a ? g : i;
    }
    function e(e) {
      var f,
        a,
    ...
    function f(a, d) {
      ...
      b('<img src="' + a + '.gif">').on("load", c),
        b('<img src="' + a + '.jpg">').on("load", c),
        b('<img src="' + a + '.jpeg">').on("load", c),
        b('<img src="' + a + '.png">').on("load", c);
    }
    function a(i, a, c) {
      if (
        ((this.$element = b(i)),
        "string" == typeof a && (a = d(a)),
        c ? "string" == typeof c && (c = d(c)) : (c = {}),
        "string" == typeof a)
      )
        a = a.replace(/\.\w*$/, "");
      else if ("object" == typeof a)
        for (var e in a)
          a.hasOwnProperty(e) && (a[e] = a[e].replace(/\.\w*$/, ""));
      (this.settings = b.extend({}, g, c)), (this.path = a);
      try {
        this.init();
      } catch (f) {
        if (f.message !== h) throw f;
      }
    }
    var c = "vide",
      g = {
    ...
    (a.prototype.init = function () {
      ...
      (k = g.$wrapper =
        ...
        "detect" === n
          ? f(i, function (a) {
              k.css("background-image", "url(" + a + ")");
            })
          : "none" !== n &&
            k.css("background-image", "url(" + i + "." + n + ")"),
        "static" === m.css("position") && m.css("position", "relative"),
        m.prepend(k),
        "object" == typeof a
          ? (a.mp4 &&
              (l += '<source src="' + a.mp4 + '.mp4" type="video/mp4">'),
            a.webm &&
              (l += '<source src="' + a.webm + '.webm" type="video/webm">'),
            a.ogv && (l += '<source src="' + a.ogv + '.ogv" type="video/ogg">'),
            (j = g.$video = b("<video>" + l + "</video>")))
          : (j = g.$video =
              b(
                '<video><source src="' +
                  a +
      ...
      j
        ...
        .one("playing.vide", function () {
          j.css({ visibility: "visible", opacity: 1 }),
            k.css("background-image", "none");
        }),
        m.on("resize.vide", function () {
          d.resizing && g.resize();
        }),
        k.append(j);
    }),
      ...
      (a.prototype.resize = function () {
        if (this.$video) {
          var b = this.$wrapper,
            ...
            e = b.width();
          e / g > d / f
            ? a.css({ width: e + 2, height: "auto" })
            : a.css({ width: "auto", height: d + 2 });
        }
      }),
      (a.prototype.destroy = function () {
        delete b[c].lookup[this.index],
          this.$video && this.$video.off(c),
          this.$element.off(c).removeData(c),
          this.$wrapper.remove();
      }),
      (b[c] = { lookup: [] }),
      (b.fn[c] = function (d, e) {
        ...
        return (
          this.each(function () {
            (f = b.data(this, c)) && f.destroy(),
              ((f = new a(this, d, e)).index = b[c].lookup.push(f) - 1),
              b.data(this, c, f);
          }),
          this
        );
      ...
      b(document).ready(function () {
        ...
        a.on("resize.vide", function () {
          for (var a, e = b[c].lookup.length, d = 0; d < e; d++)
            (a = b[c].lookup[d]) && a.settings.resizing && a.resize();
        }),
...
var getYTPVideoID = function (a) {
  ...
  return (
    a.indexOf("youtu.be") > 0
      ? (b = (c =
          (b = a.substr(a.lastIndexOf("/") + 1, a.length)).indexOf("?list=") > 0
...
!(function (jQuery, ytp) {
  (jQuery.mbYTPlayer = {
                    ...
                    new YT.Player(playerID, {
                      ...
                      events: {
                        ...
                        onStateChange: function (event) {
                          if (
                            ...
                            if (YTPlayer.preventTrigger)
                              ...
                              var eventType,
                                YTPEvent = jQuery.Event(eventType);
                        ...
                        onPlaybackQualityChange: function (b) {
                          ...
                          (a.quality = c), jQuery(YTPlayer).trigger(a);
                        },
                        onError: function (a) {
                          150 == a.data &&
                            (console.log(
    ...
    getDataFromAPI: function (a) {
      if (
        ...
        setTimeout(function () {
          ...
          for (var c in ((b.prop = {}), a.videoData))
        ...
        jQuery.getJSON(
          ...
          function (d) {
            (a.dataReceived = !0),
              ...
              (a.videoData.thumb_max = e.thumbnails.maxres
                ? e.thumbnails.maxres.url
                : null),
              (a.videoData.thumb_high = e.thumbnails.high
                ? e.thumbnails.high.url
                : null),
              (a.videoData.thumb_medium = e.thumbnails.medium
                ? e.thumbnails.medium.url
                : null),
              jQuery.mbStorage.set("YTPlayer_data_" + a.videoID, a.videoData),
              (a.hasData = !0);
            var e,
              b = jQuery.Event("YTPData");
            for (var c in ((b.prop = {}), a.videoData))
              b.prop[c] = a.videoData[c];
            jQuery(a).trigger(b);
          }
    ...
    setVideoQuality: function (a) {
      this.get(0).player.setPlaybackQuality(a);
    },
    playlist: function (b, c, d, e) {
      var a = this.get(0);
      return (
        (a.isPlayList = !0),
        c && (b = jQuery.shuffle(b)),
        a.videoID ||
          ((a.videos = b),
          (a.videoCounter = 0),
          (a.videoLength = b.length),
          jQuery(a).data("property", b[0]),
        ...
        jQuery(a).on("YTPEnd", function () {
          (e = void 0 === e || e), jQuery(a).playNext(e);
        }),
        this
      );
    },
    playNext: function (b) {
      ...
      return (
        ...
        a.videoCounter++,
        a.videoCounter >= a.videoLength && b && (a.videoCounter = 0),
        a.videoCounter < a.videoLength
    ...
    playIndex: function (b) {
      ...
      return (
        ...
        a.checkForStartAt &&
          (clearInterval(a.checkForStartAt), clearInterval(a.getState)),
        (a.videoCounter = b),
        a.videoCounter >= a.videoLength - 1 &&
          (a.videoCounter = a.videoLength - 1),
        jQuery(a).changeMovie(a.videos[a.videoCounter]),
        this
      );
    ...
    changeMovie: function (b) {
      ...
      (a.opt.startAt = 0),
        ...
        (a.hasData = !1),
        (a.hasChanged = !0),
        (a.player.loopTime = void 0),
        b && jQuery.extend(a.opt, b),
        (a.videoID = getYTPVideoID(a.opt.videoURL).videoID),
        "true" == a.opt.loop && (a.opt.loop = 9999),
        jQuery(a.playerEl).CSSAnimate({ opacity: 0 }, 200, function () {
          var b = jQuery.Event("YTPChangeMovie");
          (b.time = a.currentTime),
            ...
            jQuery(a).optimizeDisplay(),
            jQuery.mbYTPlayer.checkForState(a),
            jQuery.mbYTPlayer.getDataFromAPI(a);
        }),
        jQuery.mbYTPlayer.applyMask(a);
    },
    getPlayer: function () {
    ...
    toggleLoops: function () {
      ...
      return (
        1 == a.loop
          ? (a.loop = 0)
          : (a.startAt ? b.player.seekTo(a.startAt) : b.player.playVideo(),
            (a.loop = 1)),
        this
      );
    },
    ...
    seekTo: function (a) {
      return this.get(0).player.seekTo(a, !0), this;
    },
    setVolume: function (b) {
      var a = this.get(0);
      return (
        b || a.opt.vol || 0 != a.player.getVolume()
          ? (!b && a.player.getVolume() > 0) || (b && a.opt.vol == b)
            ? a.isMute
              ? jQuery(a).YTPUnmute()
              : jQuery(a).YTPMute()
            : ((a.opt.vol = b),
    ...
    mute: function () {
      ...
      if (!a.isMute) {
        ...
        var b = jQuery.Event("YTPMuted");
        return (
          (b.time = a.currentTime), a.canTrigger && jQuery(a).trigger(b), this
        );
      }
    },
    unmute: function () {
    ...
    toggleFilter: function (a, b) {
      return this.each(function () {
        this.filters[a].value
          ? (this.filters[a].value = 0)
          : (this.filters[a].value = b),
          this.filtersEnabled && jQuery(this).YTPEnableFilters();
      });
    },
        ...
        for (var b in a.filters)
          a.filters[b].value &&
            (c +=
              ...
              a.filters[b].unit +
              ") ");
        d.css("-webkit-filter", c), d.css("filter", c), (a.filtersEnabled = !0);
      });
    },
      ...
      return this.each(function () {
        if (("function" == typeof a && ((b = a), (a = null)), a))
          ...
          for (var c in this.filters)
            jQuery(this).YTPApplyFilter(c, 0), "function" == typeof b && b(c);
      });
    },
    getFilters: function () {
      ...
      if ((b.off("YTPTime.mask"), a.opt.mask)) {
        if ("string" == typeof a.opt.mask)
          ...
          for (var c in a.opt.mask)
            a.opt.mask[c] && jQuery("<img/>").attr("src", a.opt.mask[c]);
          a.opt.mask[0] && b.YTPAddMask(a.opt.mask[0]),
            b.on("YTPTime.mask", function (d) {
              for (var c in a.opt.mask)
                d.time == c &&
                  (a.opt.mask[c]
                    ? (b.YTPAddMask(a.opt.mask[c]),
                      (a.actualMask = a.opt.mask[c]))
                    : b.YTPRemoveMask());
            });
        }
      }
    ...
    manageProgress: function () {
      var a = this.get(0),
        ...
        e = b.find(".mb_YTPProgress"),
        f = b.find(".mb_YTPLoaded"),
        g = b.find(".mb_YTPseekbar"),
        h = e.outerWidth(),
        c = Math.floor(a.player.getCurrentTime()),
        d = Math.floor(a.player.getDuration()),
        i = (c * h) / d,
        j = 100 * a.player.getVideoLoadedFraction();
      return (
        f.css({ left: 0, width: j + "%" }),
        g.css({ left: 0, width: i }),
        { totalTime: d, currentTime: c }
      );
    },
    ...
    checkForStart: function (a) {
      ...
      if (jQuery.contains(document, a)) {
        if (
          ...
          var b = "dot" == a.opt.addRaster ? "raster-dot" : "raster";
          a.overlay.addClass(a.isRetina ? b + " retina" : b);
        } else
          a.overlay.removeClass(function (d, b) {
            var c = b.split(" "),
              a = [];
            return (
              jQuery.each(c, function (c, b) {
        ...
        a.player.playVideo(),
          ...
          (a.checkForStartAt = setInterval(function () {
            jQuery(a).YTPMute();
            var f =
              a.player.getVideoLoadedFraction() >= c / a.player.getDuration();
            if (
              a.player.getDuration() > 0 &&
              a.player.getCurrentTime() >= c &&
              f
            ) {
              clearInterval(a.checkForStartAt),
                "function" == typeof a.opt.onReady && a.opt.onReady(a),
                (a.isReady = !0);
              var b = jQuery.Event("YTPReady");
              if (
                ((b.time = a.currentTime),
                jQuery(a).trigger(b),
                (a.preventTrigger = !0),
                ...
                (e.time = a.currentTime),
                  ...
                  jQuery.browser.safari &&
                    (a.safariPlay = setInterval(function () {
                      1 != a.state ? d.YTPPlay() : clearInterval(a.safariPlay);
                    }, 10)),
                  d.on("YTPReady", function () {
                    d.YTPPlay();
                  });
              } else
                a.player.pauseVideo(),
            ...
            } else jQuery.browser.safari && (a.player.playVideo(), c >= 0 && a.player.seekTo(c, !0));
          }, 1));
      } else jQuery(a).YTPPlayerDestroy();
    },
    setAlign: function (a) {
    ...
    (jQuery.fn.optimizeDisplay = function (g) {
      var c = this.get(0),
        h = jQuery(c.playerEl),
        a = {};
      (c.opt.align = g || c.opt.align),
        (c.opt.align =
          "undefined " != typeof c.opt.align ? c.opt.align : "center,center");
      var e = c.opt.align.split(",");
      if (c.opt.optimizeDisplay) {
        var b = {},
          f = c.wrapper;
        (b.width = f.outerWidth()),
          (b.height = f.outerHeight()),
          (a.width = b.width),
          (a.height =
            "16/9" == c.opt.ratio
              ? Math.ceil(b.width * (9 / 16))
              : Math.ceil(0.75 * b.width)),
          (a.width = b.width),
          (a.height =
            "16/9" == c.opt.ratio
              ? Math.ceil(b.width * (9 / 16))
              : Math.ceil(0.75 * b.width)),
          (a.marginTop = -(a.height - b.height) / 2),
          (a.marginLeft = 0);
        var d = a.height < b.height;
        for (var i in (d &&
          ((a.height = b.height),
          (a.width =
            "16/9" == c.opt.ratio
              ? Math.floor(b.height * (16 / 9))
              : Math.floor(b.height * (4 / 3))),
          (a.marginTop = 0),
          (a.marginLeft = -(a.width - b.width) / 2)),
        e))
          switch (e[i].trim()) {
            case "top":
              a.marginTop = d ? -(a.height - b.height) / 2 : 0;
              break;
            case "bottom":
              a.marginTop = d ? 0 : -(a.height - b.height);
              break;
            case "left":
              a.marginLeft = 0;
              break;
            case "right":
              a.marginLeft = d ? -(a.width - b.width) : 0;
          }
      } else
        (a.width = "100%"),
          (a.height = "100%"),
    ...
    (jQuery.shuffle = function (e) {
      for (var a = e.slice(), c = a.length, b = c; b--; ) {
  ...
  (jQuery.CSS = {
    ...
    normalizeCss: function (d) {
      ...
      for (var b in (jQuery.browser.webkit || jQuery.browser.opera
      ...
      a)) {
        "transform" === b &&
          ((a[jQuery.CSS.sfx + "transform"] = a[b]), delete a[b]),
          "transform-origin" === b &&
            ((a[jQuery.CSS.sfx + "transform-origin"] = d[b]), delete a[b]),
          "filter" !== b ||
            jQuery.browser.mozilla ||
            ((a[jQuery.CSS.sfx + "filter"] = d[b]), delete a[b]),
        ...
        var c = "";
        "x" === b &&
          ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
          (a[c] += " translateX(" + setUnit(d[b], "px") + ")"),
          delete a[b]),
          "y" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " translateY(" + setUnit(d[b], "px") + ")"),
            delete a[b]),
          "z" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " translateZ(" + setUnit(d[b], "px") + ")"),
            delete a[b]),
          "rotate" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " rotate(" + setUnit(d[b], "deg") + ")"),
            delete a[b]),
          "rotateX" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " rotateX(" + setUnit(d[b], "deg") + ")"),
            delete a[b]),
          "rotateY" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " rotateY(" + setUnit(d[b], "deg") + ")"),
            delete a[b]),
          "rotateZ" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " rotateZ(" + setUnit(d[b], "deg") + ")"),
            delete a[b]),
          "scale" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " scale(" + setUnit(d[b], "") + ")"),
            delete a[b]),
          "scaleX" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " scaleX(" + setUnit(d[b], "") + ")"),
            delete a[b]),
          "scaleY" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " scaleY(" + setUnit(d[b], "") + ")"),
            delete a[b]),
          "scaleZ" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " scaleZ(" + setUnit(d[b], "") + ")"),
            delete a[b]),
          "skew" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " skew(" + setUnit(d[b], "deg") + ")"),
            delete a[b]),
          "skewX" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " skewX(" + setUnit(d[b], "deg") + ")"),
            delete a[b]),
          "skewY" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " skewY(" + setUnit(d[b], "deg") + ")"),
            delete a[b]),
          "perspective" === b &&
            ((a[(c = jQuery.CSS.sfx + "transform")] = a[c] || ""),
            (a[c] += " perspective(" + setUnit(d[b], "px") + ")"),
            delete a[b]);
      }
      return a;
    },
    getProp: function (c) {
      var a = [];
      for (var b in c) 0 > a.indexOf(b) && a.push(uncamel(b));
      return a.join(",");
    },
    animate: function (a, b, c, d, e) {
      return this.each(function () {
        function o() {
          (g.called = !0),
            (g.CSSAIsRunning = !1),
            i.off(jQuery.CSS.transitionEnd + "." + g.id),
        ...
        if (
          ...
          ((g.CSSqueue = null), (g.eventType = j.type), 0 !== i.length && a)
        ) {
          if (
          ...
          if (
            ...
            for (var f in a) {
              if (
                ("transform" === f && delete a[f],
                "filter" === f && delete a[f],
                "transform-origin" === f && delete a[f],
                "auto" === a[f] && delete a[f],
                "x" === f)
              ) {
                var k = a[f];
              ...
              "y" === f && ((k = a[f]), (a.top = k), delete a[f]),
                ("-ms-transform" === f || "-ms-filter" === f) && delete a[f];
            }
            return void i.delay(c).animate(a, b, e);
          }
          var m = {
            default: "ease",
            in: "ease-in",
          ...
          m[d] && (d = m[d]), i.off(jQuery.CSS.transitionEnd + "." + g.id);
          var n = jQuery.CSS.getProp(a),
            h = {};
          jQuery.extend(h, a),
            (h[jQuery.CSS.sfx + "transition-property"] = n),
            (h[jQuery.CSS.sfx + "transition-duration"] = b + "ms"),
            (h[jQuery.CSS.sfx + "transition-delay"] = c + "ms"),
            (h[jQuery.CSS.sfx + "transition-timing-function"] = d),
            setTimeout(function () {
              i.one(jQuery.CSS.transitionEnd + "." + g.id, o), i.css(h);
            }, 1),
...
(jQuery.browser.android = /Android/i.test(nAgt)),
    ...
    (a.simpleSlider = {
      ...
      init: function (c) {
        return this.each(function () {
          ...
          var g = "h" == d.opt.orientation ? "horizontal" : "vertical",
            f = a("<div/>").addClass("level").addClass(g);
          e.prepend(f),
            (d.level = f),
      ...
      updateSliderVal: function (c) {
        ...
        if (b.opt) {
          b.opt.initialval =
            "number" == typeof b.opt.initialval
              ? b.opt.initialval
              : b.opt.initialval(b);
          var e = a(b).outerWidth(),
            f = a(b).outerHeight();
          (b.x =
            "object" == typeof c
              ? c.clientX + document.body.scrollLeft - d.offset().left
              : "number" == typeof c
              ? (c * e) / b.opt.scale
              : (b.opt.initialval * e) / b.opt.scale),
            (b.y =
              "object" == typeof c
                ? c.clientY + document.body.scrollTop - d.offset().top
                : "number" == typeof c
                ? ((b.opt.scale - b.opt.initialval - c) * f) / b.opt.scale
                : (b.opt.initialval * f) / b.opt.scale),
            (b.y = d.outerHeight() - b.y),
            (b.scaleX = (b.x * b.opt.scale) / e),
            (b.scaleY = (b.y * b.opt.scale) / f),
            (b.outOfRangeX =
              b.scaleX > b.opt.scale
                ? b.scaleX - b.opt.scale
                : b.scaleX < 0
                ? b.scaleX
                : 0),
            (b.outOfRangeY =
              b.scaleY > b.opt.scale
                ? b.scaleY - b.opt.scale
                : b.scaleY < 0
                ? b.scaleY
                : 0),
            (b.outOfRange =
              "h" == b.opt.orientation ? b.outOfRangeX : b.outOfRangeY),
            (b.value =
              void 0 !== c
                ? "h" == b.opt.orientation
                  ? b.x >= d.outerWidth()
                ...
                : b.scaleY),
            "h" == b.opt.orientation
              ? b.level.width(g(b.x, e) + "%")
              : b.level.height(g(b.y, f)),
  ...
  (function (a) {
    (a.mbCookie = {
      set: function (f, b, c, a) {
        (b = JSON.stringify(b)), c || (c = 7), (a = a ? "; domain=" + a : "");
        var e,
          d = new Date();
        d.setTime(d.getTime() + 864e5 * c),
          (e = "; expires=" + d.toGMTString()),
          (document.cookie = f + "=" + b + e + "; path=/" + a);
      },
      get: function (e) {
        for (
          var c = e + "=", d = document.cookie.split(";"), b = 0;
          b < d.length;
          b++
        ) {
          for (var a = d[b]; " " == a.charAt(0); ) a = a.substring(1, a.length);
          if (0 == a.indexOf(c))
            return JSON.parse(a.substring(c.length, a.length));
        }
        return null;
      },
      remove: function (b) {
      ...
      (a.mbStorage = {
        set: function (b, a) {
          (a = JSON.stringify(a)), localStorage.setItem(b, a);
        },
        get: function (a) {
